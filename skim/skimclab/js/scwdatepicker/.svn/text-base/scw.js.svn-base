...
// *****************************************************************************
//
// Modifed by Rizal Almashoor on 16 November 2006
//            * Added long month names capability
//            * Moved today's date to top left
//            * Added "X" button at top right
//
// *****************************************************************************
//
...
//******************************************************************************
    ...
    // Note by Rizal 18 Nov 2006:
    // The original value of the width of table.scw is 200px. To
    // accommodate long month names I had to change it to 207px
    // for proper rendering in IE6.
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            'select.scwHead             {font-family:   Arial,Helvetica,Sans-Serif;'+
                                        'font-size:     10pt;'          +
                                        'font-weight:   normal;'        +
                                        'margin:        3px 1px;}'      +
            ...
            'span.scwFootHover,'                                        +
            'span.scwFoot:hover,'                                       +
            'span.scwFootDisabled       {font-family:   Arial,Helvetica,Sans-Serif;'+
                                        'font-size:     8pt;'           +
                                        'font-weight:   bold;}'         +
            'table.scwCells             {font-family:   Arial,Helvetica,Sans-Serif;'+
                                        'text-align:    right;'         +
                                        'font-size:     8pt;'           +
                                        'width:         96%;}'          +
            'td.scwCells,'                                              +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'span.scwFoot               {background-color:  #6666CC;'   +
                                        'color:             #FFFFFF;}'  +
            'input.scwClose             {background-color:  #CC6666;'   +
            ...
            '/* Today selector */'                                      +
            'span.scwFoot:hover,'                                       +
            'span.scwFootHover          {font-family:       Arial,Helvetica,Sans-Serif;'+
                                        'color:             #FFFF00;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'font-weight:       bold;}'     +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'   +
                                        'color:             #666666;}'  +
            'span.scwFootDisabled       {background-color:  #6666CC;'   +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
...
//  Variables required by both scwShow and scwShowMonth
    ...
    var scwVisibilityStatus = "hidden";
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
         ...
         if (scwEle.value.length==0)
             ...
             */
             // [BEGIN] hacked by Rizal 16 Nov 2006 to accommodate long month names
             if (scwArrSeedDate[1].search(/\d+/)!=0)
                {i = 0;
                 while (scwArrMonthNames[i].toUpperCase()!=scwArrSeedDate[1].toUpperCase())
                       i++;
...
// ***************************
    ...
    if ((new Date(scwBaseYear + scwDropDownYears, 11, 32)) > scwDateNow &&
       ...
       {document.write(
                    "<span class='scwFoot' id='scwFoot' title=\"Select Today's date\"></span>");
       }
    document.write(
                "</td>" +
                "<td style='text-align: right; vertical-align: top'>" +
                    "<input type='button' class='scwClose' onclick='scwHide();' title='Close' value='X' />" +
                "</td>" +
            "</tr>" +
            "<tr class='scwHead' >" +
                 "<td class='scwHead'>" +
                 ...
                 "<td class='scwHead'>" +
                    ...
                    "</select>" +
                 "</td>" +
                 "<td class='scwHead' style='vertical-align: middle'>" +
