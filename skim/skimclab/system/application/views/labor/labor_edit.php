...
<table width="100%" border="0">
 		...
 		<tr>
 			<td rowspan="8" width="15%" valign="bottom">
 				<?php echo $photoInfo;?> 			</td>
 			<td width="16%" rowspan="2" id="t_txtpassno">Passport No</td>
 			<td width="25%" colspan="2" rowspan="2"><input type="text" name="txtpassno" id="txtpassno" maxlength="" value="<?php echo $labor->wkr_passno;?>" READONLY/>
			...
			<td rowspan="2" bordercolor="#000000" bgcolor="#000000">  <span class="style12"><span class="style14">Labour Compliance Status </span></span><span class="style11">: </span></td>
		    ...
		    <td bordercolor="#00CC00" bgcolor="#FF0000">GC</td>
		    <td bordercolor="#00CC00" bgcolor="#FF0000">BIO</font></td>
			
			<!--th>SKK Status</th-->
			<td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12">
		      <input type="button" name="btnView3" value="SKK"  class="style11" onclick="window.open('<?php echo site_url();?>/contLabour/changeSKKStatus/<?php echo $labor->wkr_id;?>', 'SKK Status History', 'height=500, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
			</span></td>
			<td bordercolor="#00CC00" bgcolor="#FF0000">Reg</td>
			<td bordercolor="#00CC00" bgcolor="#FF0000">SKK</font></td>
      </tr>
 		<tr>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Status</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12"><font color="#009900">
 		    <?php if($labor->wkr_greencard != 0) echo 'A';else echo "<font color = red>N/A</font>";?>
 		  </font></span></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12"><font color="#009900">
 		    <?php if($labor->wkr_biogreencard != 0) echo 'A';else echo "<font color = red>N/A</font>";?>
 		  </font></span></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Status</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><font color="#009900"><?php if($labor->wkr_skkregstatus != 0) echo 'A ';else echo "<font color = red>N/A</font>";?></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12"><font color="#009900">
 		    <?php if($labor->wkr_skkstatus != 0) echo 'A ';else echo "<font color = red>N/A</font>";?>
 		  </font></span></td>
	  </tr>
 		<tr>
 		  <td rowspan="2" id="t_txtname2">&nbsp;</td>
 		  <td colspan="2" rowspan="2">&nbsp;</td>
 		  <td><font color="green">A</font>- <font color = black>Available</font></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12">
 		    <input type="button" name="btnView5" value="Bank AC"  class="style11" onclick="window.open('<?php echo site_url();?>/contLabour/changebankStatus/<?php echo $labor->wkr_id;?>', 'Bank AC Status History', 'height=500, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
          <font color="#009900"> &nbsp;</font></span></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Reg</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Pay</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12">
 		    <input type="button" name="btnView4" value="SOCSO"  class="style11" onclick="window.open('<?php echo site_url();?>/contLabour/changesocsoStatus/<?php echo $labor->wkr_id;?>', 'SOCSO Status History', 'height=500, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
 		  </span></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Reg</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Pay</td>
      </tr>
 		<tr>
 		  <td><font color = red>N/A</font> - <font color = black>Not Available</font></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Status</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><font color="#009900">
 		    <?php if($labor->wkr_bankregstatus != 0) echo 'A';else echo "<font color = red>N/A</font>";?>
 		  </font></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12"><font color="#009900">
 		    <?php if($labor->wkr_bankstatus != 0) echo 'A';else echo "<font color = red>N/A</font>";?>
 		  </font></span></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000">Status</td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><font color="#009900"><?php if($labor->wkr_socsoregstatus != 0) echo 'A ';else echo "<font color = red>N/A</font>";?></td>
 		  <td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12"><font color="#009900">
 		    <?php if($labor->wkr_socsostatus != 0) echo 'A';else echo "<font color = red>N/A</font>";?>
 		  </font></span></td>
	  </tr>
 		<tr>
 			...
 			<td colspan="6"><input type="button" name="btnView1" value="View Status History"  class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contLabour/viewStatusHistory/<?php echo $labor->wkr_id;?>', 'Passport Exp History', 'height=350, width=500, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
 		...
 		<tr>
 			...
 			<td>SOCSO ID</td>
 			<td colspan="6"><input type="text" name="txtsocsoid" width="12" maxlength="12" value="<?php echo $labor->wkr_socso_id ?>"/></td>
 		</tr>
 		<tr>
 			<td>Bank Draft No: </td>
 		...
 		<tr>
			...
			<td>Relationship</td>
			<td colspan="6"><input type="text" name="txtrelationship"  value="<?php echo $labor->wkr_relationship; ?>"/></td>
		</tr>
 		<tr>
 		...
 		<tr>
			...
			<td>Nationality </td>
			<td colspan="6"><input type="text" value="<?php echo $labor->nat_desc ?>" name="selnationalitydesc" /><input type="hidden" value="<?php echo $labor->wkr_nationality ?>" name="selnationality" /></td>
 		</tr>
 		<tr>
 			<td>Salary</td>
		  ...
		  <td>JTK Submission</td>
			<td colspan="6"><input type="checkbox" name="chkjtk" value="1" <?php if($labor->wkr_jtk == '1') echo "CHECKED"; ?>/>
Rerefence No. 
  <input type="text" name="txtrefjtk" width="200" value="<?php echo $labor->wkr_jtk_ref ?>"/></td>
 		...
 		<tr>
 			...
 			<td>Zipcode</td>
 			<td colspan="6"><input type="text" name="txtzipcode" maxlength="10" value="<?php echo $labor->wkr_zipcode;?>" /></td>
 		</tr>
 		<tr>
 			<td>&nbsp;</td>
 			<td colspan="6">&nbsp;</td>
 		...
 		<tr>
 			...
 			<td colspan="6"><input type="text" name="txtpcode" maxlength="5" value="<?php echo $labor->wkr_pcode;?>"/></td>
 		</tr>
 		<tr>
 			<td>State</td>
 			<td colspan="6"><SELECT name="selstate">
 					<option value=""></option>	
 	    ...
 	    <tr>
 			...
 			<td colspan="6"><input type="text" name="txtyearsinmy" size="5" READONLY/></td>
 		</tr>
 		<tr>
 			...
 			<td colspan="6"><input type="text" name="txtpassissue" value="<?php echo $labor->wkr_passissue ?>"/></td>
 		</tr>
 		<tr>
 			...
 			<td colspan="6"><input type="text" name="txtplksno" value="<?php echo $labor->wkr_plksno;?>" READONLY/></td>	
 		</tr>
		<tr>
		    <td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
 		...
 		<tr>
 			<td colspan="12" align="LEFT"><u>Skill & Employment Details</u></td>
 		</tr>
 		<tr>
            ...
            <input id="button2" name="button" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtskk'), this)" /></td>
 			<td>SCC Ref No</td>
 			<td colspan="6"><input type="text" name="txtskkref" maxlength="22" value="<?php echo $labor->wkr_skkref;?>" /></td>
		</tr>
 		<tr>
 		...
 		<tr>
 			...
 			<td colspan="11"><input type="text" name="txtInitEmp" value="<?php echo $labor->wkr_initemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td>Last Employer</td>
 			<td colspan="11"><input type="text" name="txtLastEmp" value="<?php echo $labor->wkr_lastemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td colspan="12">&nbsp;</td>
 		</tr>
 		<tr>
 			<td colspan="12" align="LEFT"><u>Employer History</u></td>
 		</tr>
 		<tr>
 			<td colspan="12">
 				<table width="100%" border="0">
