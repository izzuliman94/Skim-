					...
					<tr>
						...
						<td><?php echo $hist->hist_reason;?>
							<?php if($hist->hist_transtatus == 14 || $hist->hist_transtatus == 15){
								  ...
								  else if($hist->hist_transtatus == 8 || $hist->hist_transtatus == 10 || $hist->hist_transtatus == 11){
								  	if($hist->hist_incidentdate != '0000-00-00') echo "<br />Incident date: " . date('d-m-Y', strtotime($hist->hist_incidentdate));
								  }
								  else{
								  }
							?>
