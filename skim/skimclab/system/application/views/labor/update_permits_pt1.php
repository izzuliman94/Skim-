...
<body>
<h4><a href="dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update Permit Status</h4>
...
<h3 id="switchsection1-title" class="handcursor">Update Permit Status<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contLabour/updatePermitSearch" method="POST" name="TypicalForm" id="TypicalForm">
    <table width="100%" border="0">	
      <tr>
        ...
        <td width="72%">
        	...
        	<input type="radio" name="searchby" value="ctr_comp_name" />Company
        </td>
      </tr>
      <tr>
        <td>Keyword</td>
  ...
  <?php if(isset($searchterm)) echo "<font color=\"#990000\"><strong>" . $searchterm . "</strong></font>";?>
<?php
if(isset($wkrRecord)){
?>
	<table width="100%" border="0">
		<tr>
			...
			<th>PIC</th>
			<th>UPDATE RENEWAL STATUS</th>
		</tr>
		<?php if($wkrRecord->num_rows() == 0){
		?>
		<tr>
			<td colspan="8"><font color="red">There is no data display. Please refine your search keyword.</font></td>
		</tr>
		<?php }
		else{
		...
		<tr>
			...
			<td><?php echo $wkr->ctr_comp_name;?></td>
			<td><?php if($wkr->wkr_permitexp != "0000-00-00") echo date('d-m-Y', strtotime($wkr->wkr_permitexp));?></td>
			<td><?php echo $wkr->emp_username;?></td>
			<td align="CENTER"><a href="<?php echo site_url();?>/contLabour/updatePermitPt2/<?php echo $wkr->wkr_id;?>">Update</a></td>
		</tr>
		<?php
				}//end foreach
			} //end else
