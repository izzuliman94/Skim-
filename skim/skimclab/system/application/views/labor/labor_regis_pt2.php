...
<h4><a href="file:///C|/webserver/apache/htdocs/skimclab/system/application/views/labor/dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Registration </h4>
 ...
 <form action="<?php echo site_url();?>/contLabour/newLabourDetailsSubmit" method="POST" name="laborRegForm" id="laborRegForm" onsubmit="return v.exec();">
 	<table width="100%" border="0">
 		...
 		<tr>
 			...
 			<td colspan="5"><input type="text" name="txtname" maxlength="250" size="70" /></td>
 		</tr>
 		<tr>
 			<td width="18%" id="t_txtpassno">Passport No <font color="red">*</font></td>
 			<td colspan="5"><input type="text" name="txtpassno" maxlength="20" value="<?php if(isset($passportNo)) echo $passportNo;?>"/></td>
 		</tr>
 		<tr>
