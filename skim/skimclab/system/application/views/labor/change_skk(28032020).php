...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <table width="100%" border="0">  
      <tr>
        <th colspan="4"><div align="left">SKK Certificate</div></th>
      </tr>
        ...
        Sijil Kecekapan Kemahiran (SKK)</td>
      	<td colspan="1" align="LEFT">
      	 <table width="43%" id="area1" >
      	  	<tr>
	      		<td>&nbsp;</td><!--td width="40%">Expiry Date :</td-->
	      		<td>&nbsp;</td><!--td colspan="2">
	      			<input name="skkstatus" type="text" id="skkstatus" value="<?php if($labor->wkr_skkstatusdate != '0000-00-00') echo date('d-m-Y', strtotime($labor->wkr_skkstatusdate));?>" size="12" READONLY/>
	      			<input id="button1" name="btnDate1" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('skkstatus'), this)" />	      		</td-->
	      	</tr>
	     </table></td>
      </tr>
      <!--tr>
