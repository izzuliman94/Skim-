...
<table width="100%" border="0">
 		<tr>
 			<th colspan="5" align="RIGHT">
 				...
 				<input type="button" name="btnBack" value=" Back " onclick="location.href='<?php echo site_url();?>/contLabour/listLabour'"/>
 			</th>
 		</tr>
 		<tr>
 			...
 			<td width="20%"><input type="text" name="txtpassno" id="txtpassno" maxlength="" value="<?php echo $labor->wkr_passno;?>" READONLY/>
 							<input type="button" name="btnReplace" value="Replacement" class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contLabour/passportReplacement/<?php echo $labor->wkr_id;?>', 'Passport Number Replacement', 'height=450, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
 			</td>
 		...
 		<tr>
 			...
 			<td rowspan="2" colspan="2">
	 			...
	 			Line3: <input type="text" name="txtcuraddr3" size="50" maxlength="100" value="<?php echo $labor->wkr_address3;?>"/>
 			</td>
 		...
 		<tr>
 			...
 			<td colspan="2">
			 	...
			 	<input type="button" name="btnView2" value="View &amp; Update" class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contLabour/viewPermitExpHistory/<?php echo $labor->wkr_id;?>', 'Permit Exp History', 'height=400, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/> <font color="red">*</font>
 			</td>
 		...
 		<tr>
 			...
 			<td colspan="4"><SELECT name="selworktrade" id="selworktrade" onchange='javascript:addtotrade();'>
 							...
 							<input type="button" name="btnclear" value="Clear" onclick='javascript:cleartrade();' class="smoothbtn1"/>
 			</td>
 		</tr>
 		<tr>
