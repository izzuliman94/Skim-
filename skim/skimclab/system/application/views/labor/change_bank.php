...
<h4><a href="dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /><a href="registration_pt1.php"> Registration</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Bank Account Status </h4>
...
<h3 id="switchsection1-title" class="handcursor">Bank AC Status    <img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url('contLabour/updatebankStatus');?>" method="POST" name="changeStatusForm" id="changeStatusForm">
  ...
  <table width="100%" border="0">  
      <tr>
        <th colspan="4"><div align="left">Bank Account </div></th>
      </tr>
      
      <tr>
        <td width="15%" ALIGN="LEFT"><label>
          <input type="checkbox" name="chkbank2" value="1" <?php if($labor->wkr_bankregstatus == '1') echo "CHECKED"; ?>/>
        </label> 
          Account Registration
</td>
        <td width="16%" ALIGN="LEFT"><label>
          <input type="checkbox" name="chkbank" value="1" <?php if($labor->wkr_bankstatus == '1') echo "CHECKED"; ?>/>
        </label>
Payment Through Bank Account</td>
      	<td width="34%" colspan="1" align="LEFT">Bank : </td>
