...
<tr>
   <td>Labour</td>
   <td colspan="3">
   <input type="text" size="60" name="empname" readonly/>
...
<tr>
    ...
    <td colspan="3"><input type="text" name="txtpassissue" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
...
<tr>
    ...
    <td colspa="3"><input type="text" name="txtsalary" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
