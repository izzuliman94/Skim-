  ...
  <form action="<?php echo site_url();?>/contRenewal/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    <table width="100%" border="0">
		...
		<tr>
		  ...
		  <td>Special Pass </td>
		  <td><input type="checkbox" name="chkjtk" value="1" <?php if($woRow->wo_jtk == '1') echo "CHECKED"; ?>/>
		    <input type="hidden" name="txtrefjtk" width="200" value="<?php echo $woRow->wo_jtk_ref ?>"/></td>
	  </tr>
	   <tr>
    ...
    <br />
       <table width="80%" border="0">
		...
		<tr>
    		<td colspan="6">REF NO.: <input type="text" name="payrefno" value="<?php echo $woRow->pay_refno;?>" size="50" /><input type="button" value="..." onclick="paymentlist()"/></td>
    	</tr>
		<tr>
    	...
    	<tr>
    		...
    		<td>FOMEMA:</td>
    		<td>
    			<SELECT name="selfomema" <?php echo $fomemacontrol ?>>
      ...
      <table width="100%" border="0">
	    ...
	    <?php $i = 1;
      	 ...
      	 <tr>
            ...
            <td align="center">
            <input type="button" value="Edit / Delete" onclick="EditFCL('<?php echo $fcl->fcl_id;?>')" <?php echo $close ?>/><!--input type="button" value="Print Form" onclick="openprintform()"-->
    ...
    <table width="100%" border="0">
    	<tr>
            ...
            <th colspan="2" align="RIGHT"><input type="button" name="btnRegisNewLegal" value="Register New Legal" onclick="registerNewLegal();" <?php echo $close ?>/></th>
    	</tr>
        <tr>
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    		...
    		<td>
	    		<table width="100%">
	    			<tr><td align="center"><?php echo anchor_popup("contRenewal/printCheckLits/". $woRow->wo_id,"PrintChecklist");?></td></tr>
	    			<tr><td align="center"><a href="mailto:lonpac@clab.com.my"  target="_blank">Insurance Purchase</a></td></tr>
...
&nbsp; &nbsp; Reason:
<input type="text" name="reasonwithd" size="60" value="<?php echo $woRow->wo_withd_reason;?>"/><br /><input type="button" value="Handover Letter" onclick="handover('<?php echo $woRow->wo_clab_no;?>')"/><input type="button" value="Surat Pengesahan" onclick="pengesahan('<?php echo $woRow->wo_clab_no;?>')"/></td>
  	  </tr>
    </table>
    <br />
    <table width="100%" border="0">
