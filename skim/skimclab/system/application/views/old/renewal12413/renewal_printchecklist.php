...
<title>SKIM - Checklist Renewal Submission</title>
...
<tr>
    <td align="left" class="print" width="30%">&nbsp;<img src="<?php echo base_url();?>images/logoLetter.jpg" /></td>
	<td align="CENTER" class="print" width="30%"><h2>CORPORATE SUPPORT DEPARTMENT</h2></td>
	<td align="right" class="print" width="30%">CLAB/SOP/02/09/F01</td>
</tr>
<tr>
...
<table width="900px" border="0">
<tr>
    <td align="LEFT" class="print" width="12%">WorkOrder No. :</td>
	<td align="LEFT" class="print" width="18%" style="border:1px solid gray;"><?php echo $woRow->wo_num?></td>
	<td align="LEFT" class="print" width="12%"></td>
	<td align="LEFT" class="print" width="18%" ></td>
	<td align="LEFT" class="print" width="12%"></td>
...
<tr>
	...
	<td align="LEFT" class="print" width="12%">Contact No: </td>
	<td align="LEFT" class="print" width="18%" style="border:1px solid gray;"><?php echo $woRow->ctr_telno;?></td>
	<td align="LEFT" class="print" width="12%">Nationality:</td>
	<td align="center" class="print" width="18%" style="border:1px solid gray;"><?php echo $woRow->cty_desc;?></td>
</tr>
</table>
<br />
<table width="900px" border="0">
