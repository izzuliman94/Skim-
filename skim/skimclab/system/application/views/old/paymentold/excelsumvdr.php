...
.style12 {vertical-align: text-bottom; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 9px; height: 30px; font-weight: bold; }
</style>
...
<td rowspan="2" align="center" class="style5"><div align="center" class="style8">Service<br>
  Tax</div></td>
  <td colspan="2" align="center" class="style5"><div align="center" class="style8">Transit Center </div>    </td>
...
<td rowspan="2" align="center" class="style5"><div align="center" class="style8">Others</div></td>
...
<tr>
  <td align="center" class="style5"><div align="center" class="style8">Cost</div></td>
  <td align="center" class="style12"><div align="center" class="style8">Fees</div></td>
...
?>
<tr>
  <td class="style5"><div align="center" class="style11"><?php echo "VDR".$val?></div></td>
  ...
  <td class="style5"><div align="center" class="style11"><?php echo $sum->transit_cost ?></div></td>
  <td class="style5"><div align="center" class="style11"><?php echo $sum->transit_fees ?></div></td>
  ...
  <td align="center" class="style10">&nbsp;</td>
  <td class="style5"><span class="style11"><?php echo $sum->others_amount?></span></td>
