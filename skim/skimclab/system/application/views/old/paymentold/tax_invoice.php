...
function clearfield(){
  ...
  // document.frmpayment.txtjimcompund.checked = false;
   document.frmpayment.selamt.checked = true;  
...
function getagency(){
   ...
   if(fcl == "" || fcl == 0){ alert('Please Insert No Of FCL'); document.frmpayment.txtadmin.checked = false; return false;}
...
<tr>
    <td width="16%">Official Invoice No. :</td>
	<td colspan="5"><input type="text" value="<auto generate>" readonly/>
	  <input type="hidden" name="txtamtclab" value="0" size="20" />
	  <input type="hidden" name="txtamtfomema" value="0" size="20" />
	  <input type="hidden" name="txtamtothr" value="0" size="20" /></td>
</tr>
<tr>
  <td>Invoice Type:</td>
...
<tr>
  <td>No Of FCL:</td>
  <td colspan="3"><input type="text" name="txtfcl" value="0"  size="10" />
...
<tr>
  ...
  <td><strong>Contractor Registration</strong></td>
  <td width="13%"><strong>Fomema</strong></td>
  <td width="17%"><strong>Membesrhip</strong></td>
</tr>
<tr>
  <td rowspan="2">&nbsp;</td>
  <td width="17%"><input type="checkbox" name="txtadmfees" value="1" onclick="getclabval_adminfees()" disabled="disabled"/>
&nbsp;ADMIN FEE VDR

<input type="hidden" name="txtamtclab_only" value="0" size="20" />
<input type="hidden" name="txtamtclab_tax" value="0" size="20" /></td>
  <td width="15%" rowspan="2"><input type="checkbox" name="txtadmfeesext" value="1" onclick="getclabval_adminfeesrenewal()" disabled="disabled"/>
&nbsp;ADMIN FEE EXT</td>
  <td width="22%" rowspan="2">REGISTRATION/RENEWAL AMOUNT
    <select name="selamt" onchange="getctrrenewal(this.value)" disabled="disabled">
      <option value="0" selected="selected"></option>
      <option value="21.2">1 Year</option>
      <option value="42.4">2 Year</option>
      <option value="53">3 Year</option>
    </select></td>
  <td rowspan="2"><input type="checkbox" name="txtmale" value="1" onclick="getfomema_male()" disabled="disabled"/>
&nbsp;FOMEMA</td>
  <td rowspan="2"><input type="checkbox" name="txtothersfees2" onclick="getmship()" value="1" disabled="disabled"/>
&nbsp;MEMBERSHIP FEES

<input type="hidden" name="txtmshipfees" value="0" size="20" /></td>
</tr>
<tr>
  <td><input type="checkbox" name="txtadmin" value="1" onclick="getagency()" disabled="disabled"/>
&nbsp;AGENCY FEE</td>
</tr>
<tr>
    <td>&nbsp;</td>
...
<tr>
    <td>Date Created</td>
	<td colspan="5"><input type="text" name="txtcreateddate" value="<?php echo date("d-M-Y") ?>" readonly/></td>
</tr>

<tr>
    <td>Received From</td>
	<td colspan="5"><input type="text" name="txtrecfrom" value="" size="60" />
...
<tr>
	<td colspan="6">	  <!--TABLE  border="0" width="100%" height="40px" cellspacing="0" cellpadding="0" style="border-collapse: collapse;" bordercolor="#FFFFFF"-->	  </td>
</tr>
<tr><td colspan="6">
...
<tr>
   <td colspan="6" align="center"><input type="submit" value="Save" />&nbsp;<input type="button" onclick="clearfield()" value="Reset" /></td>
</tr>
</table>
</form>
</body>
