...
var frm = "receipt";
var url = "<?php echo site_url('contPaymentold/ctr_list');?>/" + frm
...
var frm = "receipt";
var url = "<?php echo site_url('contPaymentold/opencountrylist');?>/" + frm
window.open(url, 'Contractor List', 'height=350, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
...
var url = "<?php echo site_url('contPaymentold/printreceipt');?>/" + pmtno
window.open(url, 'Contractor List', 'height=350, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
}
...
var pmtno = document.frmpayment.txtpmtno.value;
var url = "<?php echo site_url('contPaymentold/printreceipt2');?>/" + pmtno
window.open(url, 'Contractor List', 'height=350, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
}
function printForm2(pmtno){

var pmtno = document.frmpayment.txtpmtno.value;
var url = "<?php echo site_url('contPaymentold/printinvoice');?>/" + pmtno
window.open(url, 'Contractor List', 'height=350, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
}
...
var pmtno = document.frmpayment.txtpmtno.value;
var url = "<?php echo site_url('contPaymentold/printinvoice3');?>/" + pmtno
window.open(url, 'Contractor List', 'height=350, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
}
...
<form name="frmpayment" method="post" action="<?php echo site_url();?>/contPaymentold/updatepaymentrcpt">
...
<tr>
   <td colspan="6" align="center"><input type="submit" value="Update" <?php if($payment->pmt_withdraw == '1') echo "DISABLED";?><?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/><input type="button" value="Print Receipt" onclick="printForm()"  <?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/>
     <input type="button" value="Print Invoice" <?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?> onclick="printForm2()" />
      | 
      <input type="button" value="Print Receipt A4" onclick="printForm1()" <?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?> />
     <input type="button" value="Print Invoice A4" onclick="printForm3()" <?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/></td>
</tr>
</table>
</form>
</body>
