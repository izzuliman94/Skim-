...
Tel : 03-2095 9599     Fax : 03-2095 9566&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style4"><strong>GST ID No</strong> : <strong>001341655040</strong></span><br />
                    ...
                    <tr>
                      <td align="center" height="20px"><span class="style2">TAX INVOICE</span></td>
                    </tr>
                  </table></td>
...
<table width="100%" align="center">
				...
				<tr>
				 ...
				 <tr>
				   <td height="20px">&nbsp;</td>
				   <td width="62%"><strong>:</strong> <?php echo $payment->pmt_addr; ?></td>
	               <td width="8%">&nbsp;</td>
	               <td width="16%"><strong>: </strong><?php echo $payment->pmt_type_desc; ?></td>
	               <td>&nbsp;</td>
	    </tr>
			</table>
<br/>
...
&nbsp;3 YRS - Registration /Renewal </td>
				...
				<tr>
				<td height="20"colspan="4"><div align="right"><strong>Total before GST (RM)</strong></div></td>
				<td align="center"><?php echo number_format($amtbefgst,2)?></td>
				</tr>
				<tr>
				  <td height="20"colspan="4"><div align="right"><strong>Add GST @ 6%</strong></div></td>
				  <td align ="center" height="20"><?php echo number_format($amtgst,2)?></td>
			  </tr>
				<tr>
				  <td height="20"colspan="4"><div align="right"><strong>Total (RM)</strong></div></td>
