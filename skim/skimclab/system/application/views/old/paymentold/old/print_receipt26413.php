...
<table align="center" width="51%">
	<tr>
		<td height="561">
			<table align="center" width="98%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
				<tr>
					<td width="85%" align="left" style="height: 82px" >
						<table width="100%">
							<tr>
								<td align="left"><b>CONSTRUCTION LABOUR EXCHANGE CENTRE BERHAD (CLAB)</b><br />
								  Level 2, Annexe, Menara Milenium<br />
								  No. 8, Jalan Damanlela<br />
								  Pusat Bandar Damansara<br />
								  50490 Kuala Lumpur						        </td>
							</tr>
							<tr><td align="center" height="30px"><h5><b>OFFICIAL RECEIPT</b></h5></td></tr>
						</table>
					</td>
					<td witdh="15%" style="height: 70px"><div align="center">
					  <p><img src="<?php echo base_url();?>images/logoLetter.jpg" width="50" height="50" /></p>
					  <p>OR No. :&nbsp;<?php echo $payment->pmt_receipt_no; ?></p>
			      </div></td>
				</tr>
				<tr>
			...
			<table width="100%" align="center">
			  <tr>
				 ...
				 <tr>
				   <td height="20">&nbsp;			       <b>P.A No</b></td>
				   <td>:&nbsp;<?php echo $payment->clab_pa_no; ?></td>
		      </tr>
			</table>
			<br/>
			<table align="center" width="97%" border="1" style="border-collapse: collapse;" bordercolor="#cccccc">
				<tr>
				  <td width="15%" height="20px"><div align="center">CHEQUE NO./ BANK DRAFT</div></td>
				  <td width="15%"><div align="center">PAYMENT TO</div></td>
				  <td width="48%"><div align="center">DESCRIPTION OF PAYMENT</div></td>
				  <td width="22%"><div align="center">AMOUNT (RM)</div></td>
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->pmt_chq_clab; ?>				  </div></td>
				  ...
				  <input type="checkbox" <?php if($payment->clab_reg_amount == '50'){ echo "checked" ;} ?> disabled/>&nbsp;3 YEARS  				    <div align="center"></div></td>
				  <td><div align="center">				    <?php echo $payment->clab_amount; ?>				  </div></td>
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->pmt_chq_jim; ?>				  </div></td>
				  <td><div align="center">				    JIM				  </div></td>
				  <td><input type="checkbox" <?php if($payment->chk_jim_plks == '1'){ echo "checked" ;} ?> disabled/>
			        PLKS&nbsp;
				  ...
				  <input type="checkbox" <?php if($payment->chk_jim_sp == '1'){ echo "checked" ;} ?> disabled/>SP  				    <div align="center"></div></td>
				  <td><div align="center">				    <?php echo $payment->jim_amount; ?>				  </div></td> 
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->pmt_chq_fomema; ?>				  </div></td>
				  <td><div align="center">				    FOMEMA				  </div></td>
				  <td><input type="checkbox" <?php if($payment->chk_fomema_male == '1'){ echo "checked" ;} ?> disabled/>
			        Male&nbsp;
				  <input type="checkbox" <?php if($payment->chk_fomema_female == '1'){ echo "checked" ;} ?> disabled/>Female  				    <div align="center"></div></td>
				  <td><div align="center">				    <?php echo $payment->fomema_amount; ?>				  </div></td>
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->ins_chq_no; ?>				  </div></td>
				  <td><div align="center">				    INSURANCE				  </div></td>
				  <td><input type="checkbox" <?php if($payment->chk_ins_ig == '1'){ echo "checked" ;} ?> disabled/>
			        IG&nbsp;
				  <input type="checkbox" <?php if($payment->chk_ins_fwcs == '1'){ echo "checked" ;} ?> disabled/>FWCS&nbsp;
				   <input type="checkbox" <?php if($payment->chk_ins_fwhs == '1'){ echo "checked" ;} ?> disabled/>FWHS   				    <div align="center"></div></td>
				  <td><div align="center">				    <?php echo $payment->ins_amount; ?>				  </div></td>
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->agency_chq_no; ?>				  </div></td>
				  <td><div align="center">				    TRANSIT CENTER				  </div></td>
				  <td><input type="checkbox" <?php if($payment->chk_agency_fees == '1'){ echo "checked" ;} ?> disabled/>
			        Fees&nbsp;
				  <input type="checkbox" <?php if($payment->chk_transit_cost == '1'){ echo "checked" ;} ?> disabled/>Cost  				    <div align="center"></div></td>
				  <td><div align="center">				    <?php echo $payment->agency_amount; ?>				  </div></td>
				</tr>
				<tr>
				  <td height="20px"><div align="center">				    <?php echo $payment->others_chq_no; ?>				  </div></td>
