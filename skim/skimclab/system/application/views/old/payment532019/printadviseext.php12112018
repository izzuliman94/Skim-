...
<table width="100%" style="text-align: left;border-collapse: collapse;" align="center" border="1" bordercolor="#cccccc">	
	<tr>
		...
		<td colspan="2" align="center">Bank Draft to : FOMEMA</td>
	</tr>
	<tr>
		<?php
		//if($fcl->pmt_compound<>0 && $fcl->pmt_compound<>'' && $fcl->pmt_sp<>0 && $fcl->pmt_sp<>'')  
		...
		<td colspan="2" align="center">FOMEMA</td>
	</tr>
	<tr>
		...
		<td align="center" width="45">Per FCL</td>
		<td align="center" width="45">*0% GST</td>
...
<?php
	$tfcl=0;$tlevy=0;$tplks=0;$tfees=0;$tvisa=0;$tig=0;$tfwcs=0;$tfwhs=0;$tigst=0;$tstamp=0;$tadmin=0;$tgreen=0;$tothers=0;$tcgst=0;$tfomema=0;$tfgst=0;$tcomp=0;$tsp=0;
	...
	<tr>
		...
		<td align=center colspan=2><b><?php echo number_format($sum4,2) ?></b></td>
	<tr>
</table>
<br />
...
<tr>
	<td>
		<table width="400" style="border-collapse: collapse;" border="1" bordercolor="#cccccc">
			...
			<tr><td colspan=8 height=15>All admin fees subject to 6% GST</td></tr>
