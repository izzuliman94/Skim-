...
<tr>
	...
	<td>
		...
		if($payment->chk_jim_cp == '1') {$jim6="CANCEL PERMIT/WANG CAGARAN, "; $unitJIM = $unitJIM  + $payment->fine_ref;}
...
if($payment->payment_type=='V' || $payment->payment_type=='R' || $payment->payment_type=='REH' || $payment->payment_type=='T' || $payment->payment_type=='F'){ 
?>
<tr>
