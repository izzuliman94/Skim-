...
function senddata(id,country,period,plks,fees,visa,levi,wages,fine,transfees,transcost,frm){
 ...
 opener.addfcl.txtfomema2.value = "";
 opener.addfcl.txtadmin.value = "";
 opener.addfcl.txtgreen.value = "";
 opener.addfcl.txtransit.value = "";
 ...
 opener.addfcl.txtfwcs.value = "0.00";
 opener.addfcl.txtfwhs.value = "120.00";
 opener.addfcl.txtfomema.value = "180.00";
 opener.addfcl.txtfomema2.value = "20.00";
 opener.addfcl.txtadmin.value = "300.00";
 opener.addfcl.txtgreen.value = "125.00";
 opener.addfcl.txtransit.value = "350.00";
 }
 window.close();
 opener.focus();
...
?>
id,country,period,plks,fees,visa,levi,wages,fine,frm
<?php
}else{
$i = 1;
...
<tr align="center">
	...
	<!--td><a href="#" onclick="senddata('<?php echo $country->cty_id; ?>','<?php echo $country->cty_desc; ?>','<?php echo $country->cty_period; ?>','<?php echo $country->cty_plks; ?>','<?php echo $country->cty_fees; ?>','<?php echo $country->cty_visa; ?>','<?php echo $country->cty_levi; ?>','<?php echo $country->cty_wages; ?>','<?php echo $country->cty_fine; ?>','<?php echo $frm?>')"><?php echo $country->cty_id; ?></a></td-->
