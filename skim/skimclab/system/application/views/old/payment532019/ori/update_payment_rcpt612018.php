		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtmale" value="1" <?php if($payment->chk_fomema_male == '1') echo "Checked"?> onclick="getfomema(1)" <?php echo $strfomemaM ?> />&nbsp;MALE</td>
							<td><input type="checkbox" name="txtfemale" value="1" <?php if($payment->chk_fomema_female == '1') echo "Checked"?> onclick="getfomema(2)" <?php echo $strfomemaF ?> />&nbsp;FEMALE</td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
