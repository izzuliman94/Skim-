...
<tr bgcolor=#F3F3F3>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td align=right><strong><?php echo number_format($gtotadmin + $gtotgc + $gtottc + $gtotdf + $gtotfom + $gtotig + $gtotfwcs + $gtotlevy + $gtotplks + $gtotfees + $gtotvisa + $gtotsp + $gtotcp + $gtotcom,2) ?></strong></td>
</tr>
</table>
