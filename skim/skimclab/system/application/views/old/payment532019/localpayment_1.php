...
<h4><a href="addpayment">Payment Advice</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New Local Worker Payment </h4>
<form name="frmpayment" method="post" action="<?php echo site_url();?>/contPayment/savepaymentlocal">
<table  width="100%">
<tr>
