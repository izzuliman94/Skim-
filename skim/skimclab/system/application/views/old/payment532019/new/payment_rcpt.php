...
&nbsp;LEVY (6 Month) - G1G3</td>
			...
			<tr>
				...
				<td align="center" valign=top>
					...
					<input type="text" name="txtamtins_ig" value="0" style='width:80px;text-align:center;' />
					<input type="text" name="txtamtins_fwcs" value="0" style='width:80px;text-align:center;' />
					<input type="text" name="txtamtins_fwhs" value="0" style='width:80px;text-align:center;' />	
				</td>
				<td align="center" valign=top>
			...
			<tr>
				...
				<td align="center" valign=top>
					...
					<input type="text" name="txtmshipfees" value="0" size="20" />
