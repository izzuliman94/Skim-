			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td rowspan="3"><input type="checkbox" name="txtjimvisa" value="1" <?php if($payment->chk_jim_visa == '1') echo "Checked"?> onchange="getjimval_visa()" <?php echo $strjimvisa ?> />&nbsp;VISA</td>
...
&nbsp;GUARANTEE DEPOSIT</td>							
			  ...
			  <td align="center" valign=top>
					...
					<input type="text" name="txtothfees" value="0" size="20" />
					<input type="text" name="txtdepfees" value="0" size="20" />
					</td>
				<td align="center" valign=top>
