...
<tr>
	...
	<td colspan="3"><select name="selregion">
	<option value=""></option>
		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
			...
			<tr>
				...
				<td>
					  ...
					  Registration Amount
					   ...
					   <option value="40">2 Year</option>
					   <option value="50">3 Year</option>
					   </select>			
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="txttcost" onclick="gettransitcost()" value="1" disabled/>&nbsp;COST	
			...
			<tr>
				...
				<td align="center"><input type="text" name="txtamtothr" value="0" size="20" /></td>
			</tr>
	  </table>	</td>
</tr>
<tr><td colspan="4">
