...
<script>
function senddata(passno,name,wrg,expdate,id,dtpermit,photo){
...
<tr align="center">
    <td><?php echo $i++; ?></td>
    <td><a href="#" onclick="senddata('<?php echo $labour->wkr_passno; ?>','<?php echo $labour->wkr_name; ?>','<?php echo $labour->cty_desc?>','<?php echo $labour->wkr_passexp?>','<?php echo $labour->wkr_id?>','<?php echo $labour->wkr_permitexp?>','<?php echo $labour->upload_destfilename?>')"><?php echo $labour->wkr_passno; ?></a><a href="#" onclick="senddata('<?php echo $labour->wkr_passno; ?>','<?php echo $labour->wkr_name; ?>','<?php echo $labour->cty_desc?>','<?php echo $labour->wkr_passexp?>','<?php echo $labour->wkr_id?>','<?php echo $labour->wkr_permitexp?>','<?php echo $labour->upload_destfilename?>')"></a></td>
