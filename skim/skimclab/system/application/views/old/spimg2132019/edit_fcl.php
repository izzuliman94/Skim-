...
<script type="text/javascript">
		...
		function FCLdelete(id){
			 ...
			 var uri = "<?php echo site_url();?>/contSpimG/DeleteFCL/" + workorderid + "/" + companyname + "/" + id
...
<form action="<?php echo site_url();?>/contSpimG/SaveEditFCL" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
