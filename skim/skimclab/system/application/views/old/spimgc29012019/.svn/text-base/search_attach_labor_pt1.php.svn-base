...
<h3 id="switchsection1-title" class="handcursor">Immigration - Search Labor <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 


  <form action="../immigration/search_attach_labor_pt2.php" method="get" name="TypicalForm" id="TypicalForm">
