...
<tr>
  <td id="t_txtnok2">PLKS Date Duration</td>
  <td colspan="3"><span class="print">
    From
    <input type="text" name="dtpermitexp" id="dtpermitexp" value="<?php echo date('Y-m-d')?>" readonly="READONLY"/>
    <input id="button4" name="btnDate4" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtpermitexp'), this)" />
  -
  To 
  <input type="text" name="dtpermitexp2" id="dtpermitexp2" value="<?php echo date('Y-m-d')?>" readonly="readonly"/>
  <input id="button" name="button" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtpermitexp2'), this)" />
  </span></td>
</tr>
<tr>
