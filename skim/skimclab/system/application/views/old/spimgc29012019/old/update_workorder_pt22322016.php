    ...
    <table width="100%" border="0">
    	<tr>
    		<td align="center">
				...
				<input type="submit" name="btnupdate" value=" Update Workorder " onclick="return confirm('Are you sure you want to update?');" <?php if(strpos($accessibility, 'w') == true) echo "DISABLED";  ?><?php if($woRow->wo_latest_progress == "closed") echo "DISABLED";?> <?php echo $close ?>/>
