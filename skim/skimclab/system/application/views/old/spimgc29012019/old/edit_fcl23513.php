...
<tr>
    ...
    <td colspan="3"><input type="text" name="txtpassno" value="<?php echo $fcl->fcl_passno;?>" maxlength="30" size="20"  /></tr>
<tr>
    <td id="t_txtpassissue">New Passport No <!--font color="red">*</font--></td>
    <td colspan="3"><input type="text" name="txtnewpassno" value="<?php echo $fcl->fcl_newpassno;?>" maxlength="30" size="20"  /></td>
</tr>
<tr>
    <td id="t_txtpassissue">Passport Issue <!--font color="red">*</font--></td>
    <td colspan="3"><input type="text" name="txtpassissue" maxlength="30" value="<?php echo $fcl->fcl_passissue ?>" size="20" /></td>
</tr>
</tr>
<tr>
    <td id="t_txtpassexp">Passport Expired</td>
    <td colspan="3">
