  ...
  <form action="<?php echo site_url();?>/contRenewal/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <br />
       <table width="80%" border="0">
		...
		<tr>
    		<td colspan="6">REF NO.: <input type="text" name="payrefno" value="<?php echo $woRow->pay_refno;?>" size="50" /></td>
    	</tr>
		<tr>
...
&nbsp; &nbsp; Reason:
<input type="text" name="reasonwithd" size="60" value="<?php echo $woRow->wo_withd_reason;?>"/><br /><input type="button" value="Handover Letter" onclick="handover('<?php echo $woRow->wo_clab_no;?>')"/><input type="button" value="Surat Pengesahan" /></td>
  	  </tr>
    </table>
    <br />
    <table width="100%" border="0">
