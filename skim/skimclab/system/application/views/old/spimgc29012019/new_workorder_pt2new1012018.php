  ...
  <form action="<?php echo site_url();?>/contgc/newWorkOrderPt2Submit" method="POST" name="newWorkorderForm" id="newWorkorderForm"  onsubmit="return v.exec();">
    <table width="100%" border="0">
		...
		<tr>
			...
			<td colspan="3">
				<input name="txtfcltotal" type="text" value="1" size="4" /> 
				Country: 
		...
		<tr>
		   <td>Sender Name</td>
		   <td><input type="text" size="50" name="txtsendername" value="ali bin ahmad" /></td>
		   <td>Sender IC No.</td>
		   <td><input type="text" name="txtsenderic" value="872872038898" /></td>
		</tr>
		<tr>
		  <td>Sender Contact No.</td>
		  <td><input type="text" name="txtsenderctc" size="20" value="012776673" /></td>
		  <td>Attending Officer </td>
		  <td><input type="text" name="txtattnoff" value="sayala" size="40"/></td>
	  </tr>
		<tr>
		  <td>Email</td>
		  <td><input type="text" name="txtemail" size="20" value="test@clab.com.my" /></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
	  </tr>
		<tr>
		...
		<tr>
		  <td>GC Application Type</td>
		  <td><select name="selgctype">
		    <option value=""></option>
     ...
     <table width="80%" border="0">
		...
		<tr>
    		<td colspan="6" id="t_payref">OFFICIAL RECEIPT NO<font color="red">*</font>.: 
    		  <input type="text" name="payrefno" value="1" size="50" />
