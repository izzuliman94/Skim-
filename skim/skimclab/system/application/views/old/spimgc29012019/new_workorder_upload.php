...
<body>
<h4><a href="dashboard.php">SPIM New Green Card Application</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New Workorder <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Attach Files </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contgc/uploadDoc" method="POST" name="uploadForm" id="uploadForm" enctype="multipart/form-data">
	...
	<?php if(isset($error)) echo $error;?>
  	<table width="100%" border="0">
      	<tr>
      		<td>File Type:</td>
    		<td><input type="radio" name="filetype" value="reqform" CHECKED/>
    		Documents Related</td>
      	</tr>
      	<tr>
      		<td>Location :</td>
