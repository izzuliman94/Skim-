...
<tr>
	<td width="200" colspan="2" align="center" style="height: 40px"><img src="<?php echo base_url();?>images/clab_logo.png" /></td>
...
<tr>
      ...
      <table style="border-collapse: collapse;" bordercolor="#000000" width="757" align="center" cellpadding="5" cellspacing="5" border="1">
        ...
        <tr>
          ...
          <td><p class="style2">Construction Labour Exchange Centre Berhad :
            <input type="text" name="txtmajikan3" style="width:300px; text-align:left;border:thin" value="<?php echo $woRow->pay_clab_detail?>" readonly="readonly" />
          </p></td>
        </tr>
        <tr>
          <td height="30px" ><div align="center"><span class="print">
          ...
          <td><span class="style2">Lonpac Insurance Berhad (<em>Insurance Guarantee</em> ) : 
            <input type="text" name="txtmajikan4" style="width:300px; text-align:left;border:thin" value="<?php echo $woRow->pay_fwcs_detail?>" readonly="readonly" />
          </span></td>
        </tr>
        <tr>
          ...
          <td><span class="style2">Lonpac Insurance Berhad</span><span class="style5"> (<em>FWHS</em>) : <span class="style2">
            <input type="text" name="txtmajikan5" style="width:300px; text-align:left;border:thin" value="<?php echo $woRow->pay_fwhs_detail?>" readonly="readonly" />
          </span></span></td>
        </tr>
        <tr>
...
<tr>
  <td style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;color: #B09090;"><p>http://www.clab.com.my/</p>
    ...
    <p>instagram : clabmalaysia</p>
	<p> CLAB adalah Anak Syarikat CIDB </td></p></td></div>
</tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
