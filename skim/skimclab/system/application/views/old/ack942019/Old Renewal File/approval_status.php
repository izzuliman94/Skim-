...
<h4><a href="dashboard.php">Immigration</a> <img src="../images/right_arrow.gif" width="13" height="14" /> Approval Status </h4>
...
<h3 id="switchsection1-title" class="handcursor">Approval   <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="" method="get" name="typicalform1" id="typicalform1">
    <table width="100%" border="0">
      ...
      <tr>
        <td><div align="center"><a href="approval_internal_workorder_pt1.php">Internal</a></div></td>
        <td><div align="center"><a href="approval_immigration_workorder_pt1.php">Immigration</a></div></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
