...
<script type="text/javascript">
	...
	function Inspchs(){
	 ...
	 //var emp = document.emailform.what2.value
...
<!--input name="what2" type="text" id="what2" value="<?php echo $emps->emp_email?>" /-->
<br>
...
<tr align="center">
    ...
    <th width="49" style="height: 14px">Address</th>
</tr>
<?php 
...
<tr align="center">
  ...
  <td><?php echo $lampfcl->fcl_next_of_kin;?></td>
    ...
    <td>12 MONTH</td>
    <td><?php echo wordwrap($lampfcl->fcl_add,25,"<br>\n",true); ?></td>
