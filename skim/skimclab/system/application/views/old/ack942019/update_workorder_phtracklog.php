...
<body>
<h4><a href="<?php echo site_url();?>/contAck/spimDashbrd">Acknowledgement</a><a href="dashboard.php"></a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update <a href="<?php echo site_url();?>/contAck/spimDashbrd">Acknowledgement</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New  Tracking Log </h4>
...
<h3 id="switchsection1-title" class="handcursor">Phone Tracking Log<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
  <form action="<?php echo site_url();?>/contRenewal/newPhoneTrackLogSubmit" method="POST" name="uploadForm" id="uploadForm">
    <strong>Current Acknowledgement ID : <?php echo $workorderid;?><br />
    Contractor ID: <?php echo $companyname;?> <br />
    </strong>
