...
<body>
<h4>Acknowledgement <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> List of Acknowledgement</h4>
...
<h3 id="switchsection1-title" class="handcursor">List of Acknowledgement Process</h3>
...
<table width="100%" border="0">
	...
	<tr>
		<td><?php echo $i++ ?></td>
		<td><a href="<?php echo site_url();?>/contAck/updateWorkOrderPt2/<?php echo $ctr->wo_id?>"><?php echo $ctr->wo_num?></a></td>
