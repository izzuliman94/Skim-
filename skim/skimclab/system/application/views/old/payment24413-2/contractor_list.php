...
<tr align="center">
    <td><?php echo $i++; ?></td>
    <td><a href="#" onclick="senddata('<?php echo $contractor->ctr_clab_no; ?>','<?php echo $contractor->ctr_comp_name; ?>','<?php echo str_replace("'", "", trim($contractor->ctr_addr1)); ?>','<?php echo str_replace("'", "", trim($contractor->ctr_addr2)); ?>','<?php echo str_replace("'", "", trim($contractor->ctr_addr3)); ?>','<?php echo $contractor->ctr_pcode ?>','<?php echo $contractor->state_name ?>','<?php echo $contractor->ctr_telno ?>','<?php echo $contractor->ctr_fax ?>','<?php echo $frm ?>')"><?php echo $contractor->ctr_comp_regno; ?></a></td>
