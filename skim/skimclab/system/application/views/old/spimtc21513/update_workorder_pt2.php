...
window.open(url, 'Payment list', 'height=350,width=700, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes') 
	...
	function Inspchs(){
	 ...
	 var workorderid = document.updateWorkorderForm.workorderno.value
	 var url = "<?php echo site_url('contSpimtc/Insurance_purchase');?>/" + workorderid 
	...
	if(isset($woRow->wo_isreplacement) == '1'){
		 ...
		 $isrepdis = "disabled=disabled";
	      ...
	      if(isset($woRow->doc_rqform) == '1' 
				...
				if(isset($woRow->wo_iswithdrawal) == '1' && isset($woRow->wo_withd_date) != '0000-00-00'){
   ...
   <br />
     <table width="100%" border="0">
      ...
      <table width="100%" border="0">
      	...
      	<tr>
      		<td colspan="9"><font color="red"><strong>No FCL lists has been insert for this workorder.</strong></font></td>
      	</tr>
      	<?php }
      	else{
	    ?>
	    ...
	    <?php $i = 1;
      	 ...
      	 <tr>
            ...
            <td align="center">
            <input type="button" value="Edit / Delete" onclick="EditFCL('<?php echo $fcl->fcl_id;?>')" <?php echo $close ?>/><input type="button" value="Print IM12 Form" onclick="openprintform('<?php echo $fcl->fcl_id?>')" /></td>
      	 </tr>
      	 <?php }
  	 	 }
  	 	 ?>
         <tr>
            ...
            <input name="button" type="button" onclick="OpenAddendum('<?php echo $woRow->wo_id; ?>')" value="Addendum" <?php if($allFCLFiles->num_rows() == 0){ echo "disabled"; }?> />
    ...
    <table width="100%" border="0">
    	...
    	<?php }else{ ?>
      	 ...
      	 <tr>
            ...
            <td align="center">
            <input type="button" value="Edit / Delete" onclick="EditLegal('<?php echo $legal->wo_agg_id ?>')" <?php echo $close ?>/>
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    		...
    		<td align="center"><?php echo anchor_popup("contSpimtc/printCheckLits/". $woRow->wo_id,"PrintChecklist");?><br /><input type="button" value="Insurance Purchase" onclick="Inspchs()" /></td>
		...
		<tr>
			...
			<input type="text" name="txtvercorp" id="txtvercorp"  value="<?php echo $woRow->ver_corp_by;?>" READONLY/>
			</td>
		...
		<tr>
			...
			<input type="text" name="txtverfin" id="txtverfin"  value="<?php echo $woRow->ver_fin_by;?>" READONLY/>
			</td>
		...
		<tr>
			...
			<input type="text" name="txtappceo" id="txtappceo"  value="<?php echo $woRow->app_ceo_by;?>" READONLY/>
			</td>
    	...
    	<tr>
    	  ...
    	  <td align="left"><?php echo anchor_popup("contSpimtc/printHandoverList/". $woRow->wo_id,"Print Handover Letter");?>
   	      ...
   	      <p><?php echo anchor_popup("contSpimtc/printCOMList/". $woRow->wo_id,"Print COM Application Letter");?></p></td>
    	  <td>&nbsp;</td>
  	  </tr>
    	<tr>
