...
<tr>
	...
	<td width="23%"><input type="text" name="txtjim" value="0.00" size="20"/></td>
...
<tr>
    ...
    <td>Transit Fees</td>
	<td><input type="text" name="txttransitfees" value="0.00" size="20" readonly/></td>
</tr>
<tr>
    <td>Transit Cost</td>
	<td colspan="3"><input type="text" name="txttransitcost" value="0.00" size="20" readonly/></td>
</tr>
<tr>
