...
<form action="<?php echo site_url();?>/contSpim/AddNewLegal" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
<input type="hidden" name="txtcompname" value="<?php echo $companyname; ?>" />
<input type="hidden" name="txtwoid" value="<?php echo $workorderid; ?>" />
<input type="hidden" name="txtcurrentuser" value="<?php echo $currentuser; ?>" />
<input type="hidden" name="txtwono" value="<?php echo $wono; ?>" />
