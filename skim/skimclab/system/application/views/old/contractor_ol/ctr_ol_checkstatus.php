...
<body>
<h4><a href="dashboard.php">Contractor Online</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Check registration status </h4>
...
<h3 id="switchsection1-title" class="handcursor"> Check Registration Status<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
...
<form action="<?php echo site_url('contLogin/editPasswordSubmit');?>" method="POST" name="login_info" id="login_info" onsubmit="return v.exec()">
	<table width="50%" border="0">
		<tr>
			<th colspan="3">Check CLAB Registration Status</td>
		</tr>
		<tr>
