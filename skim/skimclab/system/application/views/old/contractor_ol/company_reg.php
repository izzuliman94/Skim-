...
<h4><a href="dashboard.php">Contractor Online</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Company Registration </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contContractorOl/registrationFormSubmit" method="POST" name="newCtrForm" id="newCtrForm" onsubmit="return v.exec()">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td colspan="3"><input type="text" name="companyregno" maxlength="20" value="<?php echo $companyROC;?>" READONLY/> <font color="red">*</font></td>
      </tr>
	  <tr>
      ...
      <tr>
      	<td>Email Address</td>
      	<td colspan="3"><input type="text" name="email" size="50" maxlength="50" /></tr>
      </tr>
	  <tr>
        <td>Grade</td>
      ...
      <tr>
        ...
        <td colspan="3"><select name="category" id="selcategory" onchange='javascript:addtocategory();'>
                        ...
                        <input type="text" name="allcategory" id="txtcategory" size="30" value="" disabled/><input type="button" name="clear" value="Clear" onclick='javacript:clearcategory();'/>
        </td>
      </tr>
      <tr>
        ...
        <td colspan="3"><select name="specialization" id="selspec" onchange='javascript:addtospec();'>
                        ...
                        <input type="text" name="allspec" id="txtspec" size="30" value="" disabled/><input type="button" name="clear2" value="Clear" onclick='javascript:clearspec();'/>
        </td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      ...
      <tr>
      	<td>Period of Reg.</td>
      	<td colspan="3">
      		<input type="radio" name="periodreg" value="1" />1 year
      		<input type="radio" name="periodreg" value="2" />2 years
      		<input type="radio" name="periodreg" value="3" />3 years
      	</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      ...
      <tr>
      	...
      	<td colspan="3"><input type="checkbox" name="others" value="1" />Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" />
      	</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="directorMobile" maxlength="20" /></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="contactMobile" maxlength="20" /></td>
      </tr>
      <tr>
      	<td>Designation</td>
      	<td colspan="3"><input type="text" name="contactDesig" size="100" maxlength="250" /></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
        <td colspan="3">&nbsp;</td>
      ...
      <tr>
      	...
      	<td><input type="text" name="enteredby" size="30" maxlength="120" /> <font color="red">*</font></td>
      	<td>Entered date</td>
      ...
      <tr>
        <td colspan="4" align="center"><input type="submit" name="btnRegister" value="Register" onclick="return confirm('Are you sure you want to save?');"/>
