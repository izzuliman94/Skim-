...
<form method="POST" action="<?php echo site_url();?>/contSpim/searchWorkorders" name="frmSearch" value="frmSearch">
	<table width="100%" border="0">
		<tr>
			...
			<td>
			    ...
			    <input type="radio" name="rdsearchby" value="fcl_passno" />Passport No 
			    <input type="radio" name="rdsearchby" value="pay_refno" />Receipt No 
				<input type="radio" name="rdsearchby" value="wo_jimack_refno" />FWCMS App ID</td>
		</tr>
		<tr>
			<td>Keyword:</td>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="btnSearch" value=" Search " />
				<input type="button" name="btnReset" value="Reset" onclick="location.href='<?php echo site_url();?>/contSpim/listAllWorkorders'" />
			</td>
		</tr>
	</table>
</form>
