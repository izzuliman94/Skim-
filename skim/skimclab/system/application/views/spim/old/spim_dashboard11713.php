  ...
  <form action="" method="get" name="typicalform1" id="typicalform1">
    <table width="100%" border="0">
      ...
      <tr>
      	...
      	<td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/overall"><?php echo $overall;?></a></td>
      </tr>
      <tr>
      	<td>Total workorders (received calling visa)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/closed"><?php echo $receiveVisa;?></a></td>
      </tr>
      <tr>
      	<td>Total workorders (open)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/open"><?php echo $open;?></a></td>
      </tr>
      <tr>
      	<td> -- Total received (Corporate Support)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/totalreceived"><?php echo $received;?></a></td>
      </tr>
      <tr>
      	<td> -- Total processed (Corporate Support)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/totalprocessed"><?php echo $processed;?></a></td>
      </tr>
      <tr>
        <td> -- Submit to Corporate Services</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/submithr"><?php echo $submithr;?></a></td>
      </tr>
      <tr>
        <td> -- Received by Corporate Services</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/receivehr"><?php echo $receivehr;?></a></td>
      </tr>
	  <tr>
        <td> -- JIM (outstanding)</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/JIM"><?php echo $jim;?></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td> <14 days </td>
        <td><div align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/lessFourteen"><?php echo $lt14days;?></a></div></td>
        </tr>
      <tr>
        <td>>14 days</td>
        <td><div align="center"><a href="<?php echo site_url();?>/contSpim/dashboardList/overFourteen"><?php echo $mt14days;?></a></div></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
...
<h3 id="switchsection2-title" class="handcursor">Work orders pending under current user<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
