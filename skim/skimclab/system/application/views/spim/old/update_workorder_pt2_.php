...
<script type="text/javascript">
	...
	function Inspchs(){
	 ...
	 var url = "<?php echo site_url('contSpim/Insurance_purchase');?>/" + workorderid 
	...
	function openprintform(){
	   window.open('<?php echo site_url('contSpim/openprintform');?>','Print Form','height=500, width=800, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes');
	}
   ...
   function paymentlist(){
	  var frm = "update";
	  var url = "<?php echo site_url('contSpim/openreceipt');?>/" + frm;
  ...
  <form action="<?php echo site_url();?>/contSpim/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <table width="80%" border="0">
    	...
    	<tr>
    		...
    		<td><input type="checkbox" name="chkempletter" value="1" <?php if($woRow->doc_empletter == '1') echo "CHECKED ";?> <?php echo $doc ?>/>Employment Letter   &nbsp; &nbsp; &nbsp; &nbsp; 
    	...
    	<tr>
    		<td><input type="checkbox" name="chkawardletter" value="1" <?php if($woRow->doc_awardletter == '1') echo "CHECKED ";?> <?php echo $doc ?>/>Letter of Award  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;&nbsp;
    		...
    		<td><input type="checkbox" name="chksupagree" value="1" <?php if($woRow->doc_supplieragree == '1') echo "CHECKED ";?> <?php echo $doc ?>/>Supplier Agreement  &nbsp; &nbsp; &nbsp;
    	...
    	<tr>
    		<td><input type="checkbox" name="chkaccopic" value="1" <?php if($woRow->doc_acco == '1') echo "CHECKED ";?> <?php echo $doc ?>/>Accomodation Pic/Add 
   ...
   <br />
     <table width="80%" border="0">
    	...
    	<tr>
    		<td colspan="6">REF NO.: <input type="text" name="payrefno" size="50" value="<?php echo $woRow->pay_refno;?>" /><input type="button" value="..." onclick="paymentlist()"/></td>
    	</tr>
    	<tr>
    		<td>Admin Fee:</td>
    		<td>
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    	  ...
    	  <td align="left"><?php echo anchor_popup("contSpim/printHandoverList/". $woRow->wo_id,"Print Handover Letter");?>
   	      ...
   	      <p><?php echo anchor_popup("contSpim/printCOMList/". $woRow->wo_id,"Print COM Application Letter");?></p></td>
    	  <td>&nbsp;</td>
  	  </tr>
    	<tr>
  ...
  <table width="100%" border="0">
  	<tr>
  		...
  		<th colspan="1" align="RIGHT"><input type="button" name="btnNewLog" value=" New Log " onclick="newphtracklog();"  <?php if($woRow->wo_latest_progress == "closed") echo "DISABLED";?> <?php echo $close ?>/>
  			<input type="button" name="btnRefresh" value=" Refresh Log " onclick="location.href='<?php echo site_url();?>/contSpim/updateWorkOrderPt2/<?php echo $woRow->wo_id;?>/updatephonetrack'"  <?php if($woRow->wo_latest_progress == "closed") echo "DISABLED";?> <?php echo $close ?>/>
  		</th>
  	</tr>
  	<tr>
  	    <th>No.</th>
