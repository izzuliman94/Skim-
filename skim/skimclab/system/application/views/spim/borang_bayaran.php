...
if($lampfcl->fcl_pass == '1'){ 
  ...
  $lampfcl->cty_fees = "0.00";
  }else{
 $pass = "0.00";
 } 

//$total = $lampfcl->cty_levi + $lampfcl->cty_plks + $lampfcl->cty_visa + $lampfcl->cty_fees;	
//$totalall = $totalall + $total;
//$total_levi = $total_levi + $lampfcl->cty_levi;
//$total_plks = $total_plks + $lampfcl->cty_plks;
//$total_visa = $total_visa + $lampfcl->cty_visa;
//$total_process = $total_process + $lampfcl->cty_fees;

$total = $lampfcl->cty_levi + $lampfcl->cty_plks + $lampfcl->cty_visa + $lampfcl->cty_fees + $pass;	
$totalall = $totalall + $total;
$total_levi = $total_levi + $lampfcl->cty_levi;
$total_plks = $total_plks + $lampfcl->cty_plks;
$total_visa = $total_visa + $lampfcl->cty_visa;
...
<tr align="Center">
  ...
  <td><?php echo $lampfcl->cty_fees; ?></td>
  <td><?php echo $pass; ?></td>
...
<tr>
   <td>&nbsp;</td>
   <td>&nbsp;</td>
   <td>No.Resit Wang: <input type="text" style="width:150px; text-align:left;border:thin;font-size:10px" value="" /></td>
   <td>&nbsp;</td>
</tr>
<tr>
   <td>&nbsp;</td>
   <td>&nbsp;</td>
   <td>No.Resit Levi : <input type="text" style="width:150px; text-align:left;border:thin;font-size:10px" value="" /></td>
   <td>&nbsp;</td>
</tr>
<tr>
...
<table width="100%">
  <tr>
    <td colspan="2">&nbsp;</td>
    <td width="69%">&nbsp;</td>
    <td width="15%">Nama Company : <?php echo $lampiran->ctr_comp_name?></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
