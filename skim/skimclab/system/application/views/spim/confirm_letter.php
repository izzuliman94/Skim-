...
<tr>
    <td colspan="2" align='left'>No. Rujukan &nbsp;  :  &nbsp;    CLAB\VDR\SP\<?php echo date('y',strtotime($woRow->wo_date)); ?>\<?php echo $woRow->wo_id ?></td>	
</tr>
<tr>
    <td colspan="2" align='left'>&nbsp;</td>	
</tr>
...
<tr>
    <td colspan="2"><p align="justify" >Dimaklumkan bahawa pada 
     <!--input type="text" name="txtfield1" style="border-color:#C0C0C0;border-left:none; border-right:none; border-top: none; border-bottom: 1px inherit; width:160px; text-align:center;" value="&lt;type here&gt;" /-->
      <span class="print" style="border:none;">
      <input align="centre" type="text" name="txtfield2" style="border-color: #C0C0C0; border-left: none; border-right: none; border-top: none; border-bottom: 1px inherit; width: 150px; text-align: center;" value="" />
      </span>,<strong> </strong>pihak  kami telah menyerahkan Pekerja Binaan Asing di bawah pengurusan dan penyeliaan  pihak tuan. Berikut adalah senarai maklumat pekerja:</td>	
</tr>
<tr>
    <td colspan="2" align='left'>&nbsp;</td>	
</tr>
