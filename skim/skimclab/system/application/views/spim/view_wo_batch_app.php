...
<script type="text/javascript">
	...
	location.href= "<?php echo site_url();?>/contSpim/batchlistwo/" + clabno + "/" + companyname
	}
...
?>
<h4><a href="<?php echo site_url();?>/contSpim/spimDashbrd">SPIM</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />Batch Application <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />View Workorders</h4>
      ...
      <table width="80%" border="0">
	    ...
	    <?php $i = 1;
      	 ...
      	 <tr>
            ...
            <td align="center">
            <input type="button" value="Edit / Delete" onclick="EditFCL('<?php echo $fcl->fcl_id;?>')"/ disabled>
    ...
    <table width="100%" border="0">
    	<tr>
    		<td align="center">
			  ...
			  <input type="button" name="btnCancel" value=" Back " onclick="goback()" />    		
    		</td>
    	</tr>
    </table>
</form>
