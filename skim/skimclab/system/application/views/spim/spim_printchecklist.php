  ...
  <td align="CENTER" class="print">
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<td class="print">______________________</td>
			<td class="print"><!--input type="checkbox" name="chkfwcs" value="1"  <?php if($woRow->pay_fwcs == 'YES') echo "CHECKED";?> DISABLED/--></td>
			<td class="print"></td>
		</tr>
		<tr>
...
Agency Fee</td>
	...
	<table width="100%" border="1">
		<tr>
			...
			<td width="41%" class="print"><strong>Approved by</strong></td>
		</tr>
		<tr>
			<td width="31%" class="print"><p><br />
		      <br />
			  <br />
			  </p>
			  <p><br />
