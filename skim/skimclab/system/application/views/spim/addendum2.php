...
<tr>
  <td align='left' >&nbsp;</td>
  <td width="149" rowspan="9" align='left' ><img src="<?php echo base_url();?>images/logoLetter.jpg" alt="" /> <br />
    <br />
...
<tr>
  <td width="476" align='left' >Our Ref : <?php echo $woRow->wo_agg_no ?></td>
  </tr>
<tr>
...
<tr>
    <td colspan="2" align='left'><p class="style2">NOTIFICATION  OF NAME LIST OF FCL </p></td>
</tr>
<tr>
...
<tr>
  <td height="20" colspan="2"><p>This  is a Notification for <strong><?php echo $woRow->ctr_comp_name;?></strong> (Employer) which had applied for <strong><?php echo $woRow->wo_fcl_total;?></strong> foreign workers from <span class="print style4">
    <?php  echo $woRow->cty_desc;?>
    </span>. </p></td>
</tr>
<tr>
  <td height="20" colspan="2"><p>This  Notification shall be and is incorporated and shall read together with the  Agreement for the Supply of Foreign Construction Labour between&nbsp; Construction Labour Exchange Centre Berhad and  <strong><?php echo $woRow->ctr_comp_name;?></strong> (Employer). </p></td>
</tr>
<tr>
  <td colspan="2" style="height: 20px">Below is the additional list of name of the  Foreign workers:- .</td>
</tr>
</table>
<br />
