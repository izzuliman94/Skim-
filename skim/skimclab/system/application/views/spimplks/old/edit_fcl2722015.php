...
<label for="chkSel">Confirm Selection</label>
...
<tr>
  <td>Entry Date</td>
  <td><input type="text" id="txtentrydate" name="txtentrydate"  value="<?php echo date('d-m-Y', strtotime($fcl->fcl_entrydate));?>" maxlength="250" size="20"/>
...
<tr>
	...
	<td><input name="datepermitexp" type="text" id="datepermitexp"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_plksdate)) ?>" size="20" maxlength="250"/>
...
<tr> 	
    <td id="t_txtpassno">Passport No. <!--font color="red">*</font--></td>
 	<td colspan="3"><?php echo $fcl->fcl_passno;?><input type="hidden" name="txtpassno" value="<?php echo $fcl->fcl_passno;?>" maxlength="30" size="20" ></td>
</tr>
<tr>
