...
<tr>
    <td colspan="2" align='left'>No. Rujukan &nbsp;  :  &nbsp;    CLAB\FY\SP\<?php echo date('y',strtotime($woRow->wo_date)); ?>\<?php echo $woRow->wo_id ?></td>	
</tr>
<tr>
    <td colspan="2" align='left'>&nbsp;</td>	
</tr>
...
<tr>
    ...
    <!--input type="text" name="txtfield1" style="border-color:#C0C0C0;border-left:none; border-right:none; border-top: none; border-bottom: 1px inherit; width:160px; text-align:center;" value="&lt;type here&gt;" /--><?php echo date('d-m-Y',strtotime($dentry->fcl_entrydate)) ?>, pihak  kami telah menyerahkan Pekerja Binaan Asing di bawah pengurusan dan penyeliaan  pihak tuan. Berikut adalah senarai maklumat pekerja:</td>	
</tr>
<tr>
    <td colspan="2" align='left'>&nbsp;</td>	
</tr>
...
<tr>
	...
	<?php }else{
		...
		<td align="center"><?php echo date('d/m/Y', strtotime($fcl->fcl_plksdate1)); ?> - <?php echo date('d/m/Y', strtotime($fcl->fcl_plksdate2)); ?></td>
		</tr>
	 <?php } }?>
	</table>	</td>	
</tr>
...
<tr>
    <td colspan="2" align='left'><i><?php echo $woRow->wo_clab_no;?>/FY/<?php echo $this->session->userdata('username');?>-<?php echo $woRow->wo_personincharge?></i></td>	
</tr>
</table>
</body>
</html>