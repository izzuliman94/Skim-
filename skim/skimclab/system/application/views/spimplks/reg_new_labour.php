...
<script type="text/javascript">
		...
		var url = "<?php echo site_url('contSpimFirst/empfcl_list');?>/" + clabno
		...
		document.forms[0].txtyren.value = 1;
		}
...
<body>
<h4><a href="dashboard.php">SPIM (1st Year Renewal)</a>&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Update Workorder&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Register New FCL</h4>


<?php if(isset($successMsg)) echo "<font color=\"red\"><strong> $successMsg</strong></font>";?> <br />
<form action="<?php echo site_url();?>/contSpimFirst/AddNewFCL" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
...
<tr>
   ...
   <input type="hidden" size="100" name="selemp"/><input type="button" value="..." onclick="openemp()"/>
   <input type="hidden" name="txtdob" maxlength="30" size="20"  readonly="readonly"/>
   <input name="txtgender" type="hidden" size="20" maxlength="30"  readonly="readonly"/>
   <input type="hidden" name="txtcountry" maxlength="30" size="20"  readonly="readonly" id="txtcountry"/></td>
</tr>
<tr>
...
<tr>
  <td id="t_txtpassissue2">Entry Date</td>
  <td colspan="3"><input type="text" id="txtentrydate" name="txtentrydate" maxlength="250" size="20"/>
...
<tr>
   ...
   <td colspan="3"><input name="txtyren" type="text" value="1" size="20" maxlength="30" readonly/>
   <input type="hidden" name="txtyrendate" maxlength="30" size="20" /><input type="hidden" name="txtcdate" value="<?php echo date("Y-m-j")?>" maxlength="30" size="20" /></td>
</tr>
...
<tr>
  <td id="t_txtsalary3">Workorder Type</td>
  <td colspa="3"><select name="selwotype">
    <option value=""></option>
...
<tr>
  <td colspan="4" align="center"><input type="hidden" name="txtpermitno" maxlength="30" size="20" readonly/>
    <input type="hidden" name="txtsalary" maxlength="30" size="20" />
    <input type="hidden" name="txtworktrade" size="40" readonly />
