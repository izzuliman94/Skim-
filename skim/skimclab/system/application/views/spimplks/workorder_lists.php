...
<h4><a href="dashboard.php">Spim Renewal 1st Year PLKS</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Dashboard <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />  Lists</h4>
...
<form method="POST" action="<?php echo site_url();?>/contSpimFirst/searchWorkorders" name="frmSearch" value="frmSearch">
	<table width="100%" border="0">
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="btnSearch" value=" Search " />
				<input type="button" name="btnReset" value="Reset" onclick="location.href='<?php echo site_url();?>/contSpimFirst/listAllWorkorders'" />
			</td>
		</tr>
	</table>
</form>
