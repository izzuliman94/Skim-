...
<h4><a href="dashboard.php">Create New WO</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update Workorder </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contSpimFirst/updateWorkOrderSearch" method="POST" name="updateWorkorderForm" id="updateWorkorderForm">
    <table width="100%" border="0">
		
      <tr>
        <td width="20%">Search By</td>
        <td width="80%"><input type="radio" name="searchby" value="wo_num" CHECKED/>Workorder Number 
        	<input type="radio" name="searchby" value="ctr_comp_name" />Company Name</td>
      </tr>
      <tr>
        <td>Keyword</td>
...
?>
	<table width="100%" border="0">
		...
		?>
		<tr>
			<td colspan="6"><font color="red">There is no data to display. Please refine your search keyword.</font></td>
		</tr>
		<?php }
		else {
		...
		?>
		<tr>
			<td><!--a href="<?php echo site_url();?>/contSpimfirst/updateWorkOrderPt2/<?php echo $ctr->wo_id;?>">Create New WO</a--><a href="<?php echo site_url();?>/contSpimfirst/newWorkOrderPt2/<?php echo $ctr->wo_id;?>/<?php echo $ctr->wo_clab_no;?>">Create New WO</a></td>
		    <td><!--a href="<?php echo site_url();?><?php echo $ctr->wo_id;?>"--><?php if(strlen($ctr->wo_num) > 0) echo $ctr->wo_num; else echo $ctr->wo_id;?>
		    </a></td>
