 ...
 <link href="<?php echo base_url();?>js/scwdatepicker/scw.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript">
		...
		function Logdelete(id){
			 ...
			 var uri = "<?php echo site_url();?>/contAvailablepm/DeleteLog/" + workorderid + "/" + companyname + "/" + id
...
<body>
<h4><a href="dashboard.php">SPIM</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update Pertukaran Majikan <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update  Tracking Log </h4>
...
<h3 id="switchsection1-title" class="handcursor">Phone Tracking Log<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
  <form action="<?php echo site_url();?>/contAvailablepm/SaveEditLog" method="POST" name="uploadForm" id="uploadForm">
    <strong>Current Pertukaran Majikan ID : <?php echo $refid;?> <br />
    ...
    <?php if(isset($successMsg)) echo "<strong><font color=\"red\">$successMsg</font></strong>";?>
   	...
   	<input type="hidden" name="txtrefid" value="<?php echo $refid; ?>"/>
    <input type="hidden" name="txtcompname" value="<?php echo $companyname1; ?>" />
    <input type="hidden" name="txtcompname2" value="<?php echo $companyname2; ?>" />
