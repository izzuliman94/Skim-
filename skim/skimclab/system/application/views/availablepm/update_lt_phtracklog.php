...
<body>
<h4><a href="dashboard.php">SPIM</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update Pertukaran Majikan<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New  Tracking Log </h4>

<h3 id="switchsection1-title" class="handcursor">Pertukaran Majikan Tracking Log<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
  <form action="<?php echo site_url();?>/contAvailablepm/newPhoneTrackLogSubmit" method="POST" name="uploadForm" id="uploadForm">
    <strong>Current Pertukaran Majikan Ref ID : <?php echo $refid;?><br />
    From Contractor ID: <?php echo $companyname1;?>  To Contractor ID <?php echo $companyname2;?><br />
    </strong>
  ...
  <table width="100%" border="0">
      	...
      	<tr>
      		<td colspan="2" align="center">
      			...
      			<input type="hidden" name="companyname1" value="<?php echo $companyname1;?>" />
                <input type="hidden" name="companyname2" value="<?php echo $companyname2;?>" />
