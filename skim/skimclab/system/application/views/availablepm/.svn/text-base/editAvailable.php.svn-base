...
<form action="<?php echo site_url();?>/contAvailable/editAvailableSubmit" method="POST" name="editAvailableForm" id="editAvailableForm">
    <table width="100%" border="0">
		...
		<tr>
      	...
      	<tr>
      		<td>Qty Cancelled</td>
      		<td colspan="3"><input type="text" name="txtqtycancelled" value="<?php echo $avlabDetails->avlab_qty_cancel;?>" size="5" /> &nbsp; &nbsp;
		...
		<tr>
			...
			<td>Entered Date</td>
			<td><input type="text" name="entereddate" id="txtentereddate" value="<?php echo date('d-m-Y', strtotime($avlabDetails->avlab_entered_date));?>" READONLY/>
			</td>
		</tr>
		<tr>
			<td>Verified by</td>
			<td>
				...
				<input type="text" name="txtverifiedby" value="<?php echo $avlabDetails->avlab_ver_by;?>" READONLY/>
			</td>
			<td>Verified Date</td>
			<td><input type="text" name="verifieddate" id="txtverifieddate" value="<?php if($avlabDetails->avlab_ver_date != "0000-00-00") echo date('d-m-Y', strtotime($avlabDetails->avlab_ver_date));?>" READONLY/>
				<input id="button2" name="btnDate2" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('txtverifieddate'), this)" />
			</td>
		</tr>
		<tr>
      		<td>&nbsp;</td>
		...
		<tr>
			...
			<td><input type="checkbox" name="isapproved" <?php if($avlabDetails->avlab_isappv == '1') echo "CHECKED DISABLED";?> onclick="checktrigger(this, txtapprovedby, approveddate);"/>
				<input type="text" name="txtapprovedby" value="<?php echo $avlabDetails->avlab_appv_by;?>" READONLY/>
			</td>
			<td>Approved Date</td>
			<td><input type="text" name="approveddate" id="approveddate" value="<?php if($avlabDetails->avlab_appv_date != "0000-00-00") echo date('d-m-Y', strtotime($avlabDetails->avlab_appv_date));?>" READONLY/>
				<input id="button3" name="btnDate3" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('approveddate'), this)" />
			</td>
		</tr>
		<tr>
			<td>Rejected by</td>
			<td><input type="checkbox" name="isrejected" <?php if($avlabDetails->avlab_isrej == '1') echo "CHECKED DISABLED";?> onclick="checktrigger(this, txtrejectedby, rejecteddate);"/>
				<input type="text" name="txtrejectedby" value="<?php echo $avlabDetails->avlab_rej_by;?>" READONLY/>
			</td>
			<td>Rejected Date</td>
			<td><input type="text" name="rejecteddate"  id="rejecteddate" value="<?php if($avlabDetails->avlab_rej_date != "0000-00-00") echo date('d-m-Y', strtotime($avlabDetails->avlab_rej_date));?>" READONLY/>
				<input id="button4" name="btnDate4" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('rejecteddate'), this)" />
			</td>
		</tr>
		<tr>
	...
	<table width="100%" border="0">
		...
		<tr align="RIGHT">
			<td colspan="6">
				...
				<input type="button" name="btnPrintOPR2A" value="Print OPR2A" />
			</td>
		</tr>
		<tr align="RIGHT">
			<td colspan="6">
				<input type="button" name="btnPrintNAA" value="Print NAA" />
				<input type="button" name="btnPrintNAR" value=" Print NAR " />
			</td>
		</tr>
		<tr>
