...
<script type="text/javascript">
	...
	function registerNewLabor(){
		...
		window.open('<?php echo site_url();?>/contavailablepm/regisNewLabourPt1/' + avlabrefno, 'Register new labour', 'height=500, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes');
	}
	...
	function newphtracklog(){
		...
		var url = "<?php echo site_url('contAvailablepm/newPhoneTrackLog');?>/" + refid  + "/" + compfrom + "/" + compto
	...
	function EditTrackLog(id){
		...
		var url = "<?php echo site_url('contAvailablepm/editPhoneTrackLog');?>/" + refid + "/" + id + "/" + compfrom + "/" + compto
...
<h4><a href="dashboard.php">Pertukaran Majikan</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Edit </h4>
...
<h3 id="switchsection1-title" class="handcursor">PERTUKARAN MAJIKAN DETAILS<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
...
<form action="<?php echo site_url();?>/contAvailablepm/editAvailableSubmit" method="POST" name="editAvailableForm" id="editAvailableForm">
<table width="100%" border="0">
		...
		<tr>
	      ...
	      <input type="button" value="..." onclick="paymentlist('')"/></td>
		  <td >&nbsp;</td>
		  <td >&nbsp;</td>
    </tr>
		<tr>
		...
		<tr>
			<td colspan="4" align="center">
				...
				<input type="button" name="Back" value=" Back " onclick="location.href='<?php echo site_url();?>/contAvailablepm/availableDashbrd';" />			</td>
		</tr>
  </table>
...
<h3 id="calldashbrd2-title" class="handcursor">List of Labours (<?php echo $ctrData1->ctr_comp_name;?>)<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
	<table width="100%" border="0">
		...
		<tr align="RIGHT">
			<td colspan="6"><input type="button" name="Checklist" value="Print Checklist"   onclick="window.open('<?php echo site_url();?>/contAvailablepm/printCheckLits/<?php echo $avlabDetails->avlab_ref_no ."/". $ctrData1->ctr_clab_no;?>', 'PrintChecklist', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist4" value="Surat Pengesahan LT (Old Contractor)"   onclick="window.open('<?php echo site_url();?>/contAvailablepm/printTransferValidate/<?php echo $ctrData1->ctr_clab_no;?>/<?php echo $refno;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist3" value="Handover Letter &amp; Passport (New Contractor)"   onclick="window.open('<?php echo site_url();?>/contAvailablepm/printTransferValidate/<?php echo $ctrData2->ctr_clab_no;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist2" value="Surat Pengesahan LT (New Contractor)"   onclick="window.open('<?php echo site_url();?>/contAvailablepm/printTransferValidateNew/<?php echo $ctrData2->ctr_clab_no;?>/<?php echo $refno;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input name="btnRegisNewLabour" type="button" onclick="registerNewLabor();" value="Register New Labour" <?php echo $btnRegisNewLabour ?><?php echo $btnclosed ?>/>
				<input type="button" name="btnRefresh" value="Refresh Labour List" onclick="location.href='<?php echo site_url();?>/contAvailablepm/editAvailable/<?php echo $refno;?>'" />
	...
	<table width="100%" border="0">
	  <tr>
        ...
        <input type="button" name="btnRefresh2" value=" Refresh Log " onclick="location.href='<?php echo site_url();?>/contAvailablepm/editAvailable/<?php echo $refno;?>'"  /></th>
	  </tr>
	  <tr>
	    <th width="5%">No.</th>
