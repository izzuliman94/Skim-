...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contAvailablepm/availableForm" method="POST" name="newCtr" id="entity_searchby">
    <table width="100%" border="0">
    	...
    	<tr>
      	...
      	<tr>
      		...
      		<td>Company(TO)</td>
      		<td colspan="3">
      			<SELECT name="comp_name" id="selCompName">
      				<option value="" SELECTED></option>
      			<?php foreach($allContractors->result() as $ctr){
	      		?>
	      			<option value="<?php echo $ctr->ctr_clab_no;?>"><?php echo $ctr->ctr_comp_name;?></option>
      	...
      	<tr>
			<td colspan="4" align="center">
			    ...
			    <input type="button" name="Back" value="Back" onclick="location.href='<?php echo site_url();?>/contAvailablepm/availableDashbrd'"/>
			</td>
		</tr>
    </table>
  </form>
