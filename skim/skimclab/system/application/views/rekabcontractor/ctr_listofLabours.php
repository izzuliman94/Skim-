 ...
 <tr>
   <td class="print" align="center">
	<table width="70%" border="0">
		<tr>
			<td colspan="17" align="CENTER" class="print"><h2>LIST OF LABOURS (<?php echo $companyname;?>)</h2></td>
		</tr>
		<tr>
		  <td colspan="17" align="RIGHT" class="print">Date: <?php echo date('j F Y');?></td>
	    </tr>
		<tr>
			...
			<td align="RIGHT" class="print">&nbsp;</td>
			<td align="RIGHT" class="print">&nbsp;</td>
			<td align="RIGHT" class="print">* Note : Arrived at CLAB for registration</td>
			<td align="RIGHT" class="print">&nbsp;</td>
		...
		<tr>
			...
			<th rowspan="2">Confirm Status</th>
		...
		?>
		<tr>
			<td colspan="17"><font color="red"><strong>There is no labour assigned to this company.</strong></font></td>
		...
		<tr>
			<td><?php echo $i++;?>.</td>
			<td><a href="<?php echo site_url();?>/contrekabLabour/labourDetails/<?php echo $labor->wkr_id;?>" target="_blank"><?php echo $labor->wkr_passno;?></a></td>
			...
			<td><?php if($labor->confirm != 0) echo 'Confirm';else echo "<font color = red>Not Confirm</font>";?></td>
