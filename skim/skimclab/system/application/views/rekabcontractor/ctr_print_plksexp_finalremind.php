...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: left; width: 616px;">
  <tbody>
    ...
    <tr>
      ...
      <td>FOMEMA result (Renewal in the year 2,3,5,7 & 9 only)<strong></strong></td>
    </tr>
    <tr>
	...
	<tr>
      <td colspan="1"><input type="checkbox" name="checkbox3" value="checkbox"></td>
      <td>Latest SOCSO Statement for 3 months.<td></td></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><strong>Construction  Labour Exchange Centre Berhad</strong><br />
          <em>(Admin Fees)</em></td>
    </tr>
    <tr>
      <td colspan="1"><input type="checkbox" name="checkbox44" value="checkbox"></td>
      <td><strong>Insurance </strong><br />
	  	  <em>(Insurance Guarantee  <strong> </strong>/ Stamp Duty)</em></td>
    </tr>
    <tr>
      <td colspan="1"><input type="checkbox" name="checkbox45" value="checkbox"></td>
      <td><strong>Insurance</strong><br />
          <em>(Foreign Worker Hospitalization and Surgical Insurance Scheme <strong> </strong>/ Stamp Duty)</em></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4">The guidelines by the Immigration Department stipulate that employers must take appropriate steps to renew the work permit of their workers 3 months before their expiry.  </td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
