...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td colspan="2" rowspan="1"><br /><br /><br />Ref: CLAB/LTV/<?php echo date('y');?>/<?php echo substr($ctr->ctr_clab_no, -6);?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2" rowspan="1"><br /><br />Date:<?php echo date('j F Y');?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="4"><p align="justify">Dengan segala hormatnya perkara diatas adalah dirujuk. 
		<br />
		<br />
    ...
    <tr>
      <td colspan="4"><p align="justify">Dengan ini <i><?php echo $avlabRow->comp_to_name;?></i> akan bertanggungjawab sepenuhnya ke atas pekerja-pekerja tersebut. </p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
