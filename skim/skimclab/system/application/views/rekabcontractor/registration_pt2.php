...
<script type="text/javascript">
	...
	var process
	var url = "<?php echo site_url('contrekabContractor/agent_list');?>/" + process
...
<body>
<h4><a href="dashboard.php">Rekalibrasi Contractor</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Company Registration </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contrekabContractor/registrationFormSubmit" method="POST" name="newCtrForm" id="newCtrForm" onsubmit="return v.exec()">
    <table width="100%" border="0">
      <tr>
        ...
        <td width="33%" colspan="2"><SELECT name="comp_reg_status" DISABLED>
	  ...
	  <tr>
        ...
        <td colspan="4"><input type="text" name="companyname" size="80" maxlength="250"/><font color="red">*</font></td>
      </tr>
      <tr>
        ...
        <td>GST No</td>
        <td><input type="text" name="companygstno" maxlength="13"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
        <td>SOCSO ID</td>
        <td><input type="text" name="companysocsono" maxlength="13"/></td>
      </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="telephone1" maxlength="20" /> <font color="red">*</font> <input type="text" name="telephone2" maxlength="20"/> </td>
      	<td>Fax No</td>
      	<td colspan="2"><input type="text" name="fax" maxlength="20" /> </td>
        </tr>
		<tr>
		    <td>Agent</td>
			<td colspan="4"><input type="text" name="txtagname" size="80" readonly/>
			<input type="hidden" name="txtagid" readonly/>
			<input type="button" name="btnagn" onclick="getagent('N')" value="..."/>			</td>			
		</tr>
		<tr>
		    <td>Address 1</td>
			<td colspan="4"><input type="text" name="txtagadd1" size="80" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 2</td>
			<td colspan="4"><input type="text" name="txtagadd2" size="80" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 3</td>
			<td colspan="4"><input type="text" name="txtagadd3" size="80" readonly/></td>			
		</tr>
	  <tr>
        <td id="t_cidbreg">CIDB Reg. No</td>
        <td><input type="text" name="cidbreg" /> <font color="red">*</font></td>
        <td id="t_cidbexpire">CIDB Exp. Date</td>
      	<td colspan="2"><input type="text" name="cidbexpire" id="cidbexpire" maxlength="20" READONLY/>
      ...
      <tr>
      	...
      	<td>Amount (RM)</td>
      	<td colspan="2"><input type="text" name="amount" size="20" READONLY/></td>
      </tr>
      <tr>
      	<td>Payment Mode</td>
      	...
      	<td>Cheque No</td>
      	<td colspan="2"><input type="text" name="chequeno" size="20" /></td>
      </tr>
      <tr>
      	<td>Payment Date</td>
      	<td colspan="4">
      ...
      <tr>
      	<td>Attachments</td>
      	<td colspan="4"><input type="checkbox" name="form24" value="1" />Form24
...
<input type="checkbox" name="cidb_certcopy" value="1" />Copy of CIDB Certificate 
      ...
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="4"><input type="checkbox" name="others" value="1" />Others &nbsp; &nbsp; &nbsp;
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="2"><input type="text" name="directorMobile" id="directorMobile" size="35" maxlength="50"  onchange="javascript:addkod(1,this.value);" /></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="2"><input type="text" name="contactMobile" id="contactMobile" size="35" maxlength="50"  onchange='javascript:addkod(2,this.value);' /></td>
      </tr>
      <tr>
      	<td>Designation</td>
      	<td colspan="4"><input type="text" name="contactDesig" size="80" maxlength="250" /></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
        <td colspan="4">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Entered date</td>
      	<td colspan="2"><input type="text" name="entereddate" id="entereddate" value="<?php echo date('d-m-Y');?>" READONLY />
      ...
      <tr>
        <td colspan="5" align="center"><input type="submit" name="btnRegister" value="Register" onclick="return confirm('Are you sure you want to register this contractor?');"/>
