...
function printAppRejLetter(){	
	...
	if(approve_reject == "1")
			window.open('<?php echo site_url();?>/contrekabContractor/printApproveRejLetter/approve/' + clabno);
	else if (approve_reject == "2")
			window.open('<?php echo site_url();?>/contrekabContractor/printApproveRejLetter/reject/' + clabno);
	else {
	}
}
...
function printLetterMain(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/printLetterMain/' + clabno);
}

function printRenewal(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/printRenewal/' + clabno);
}

function printOPR1(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/printOPR1/' + clabno);
}

function printCert(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/printCert/' + clabno);
}

	function printCert2(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/printCert2/' + clabno);
}
	
function attachdoc(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/regisAttachDoc/' + clabno);
}
...
function addpayment(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contrekabContractor/paymentForm/' + clabno, 'Add Payment Form', 'height=400, width=550, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes');	
}
...
?>
<form action="<?php echo site_url();?>/contrekabContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
        <th colspan="5" align="RIGHT">
        	...
        	<input type="button" name="btnBack" value="Back" onclick="location.href='<?php echo site_url();?>/contrekabContractor/ctrList';"/>        </th>
      </tr>
      <tr>
      	<td colspan="5" align="RIGHT"><?php echo anchor_popup("contrekabContractor/viewListOfLabours/" . $ctr->ctr_clab_no, "View List of Labours");?>      	</td>
      </tr>
      <tr>
        ...
        <td colspan="2">
        			    ...
        			    &nbsp;<input type="button" name="btnView1" value="View Status History"  class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contrekabContractor/ctrStatusHistory/<?php echo $ctr->ctr_clab_no;?>', 'Change Status History', 'height=350, width=510, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>        </td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
...
Supplier Agreement</td>
      ...
      <tr>
        <td colspan="5" align="RIGHT">
        	...
        	<input type="button" name="btnPrintRenewal" value="Print Renewal" onclick="printRenewal()"/>
        	<input type="submit" name="btnUpdate" value="Update" onclick="return confirm('Are you sure you want to update?');" <?php if(strpos($accessibility, 'm') == false) echo "DISABLED";  ?> />
        	<input type="button" name="btnBack" value="Back" onclick="location.href='<?php echo site_url();?>/contrekabContractor/ctrList';"/>        </td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
