...
<title>SKIM - Agreement Letter (Ext)</title>
<style type="text/css">
th {
...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="22%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
      <td colspan="1" rowspan="10" valign="top" width="18%"><img src="<?php echo base_url();?>images/logoLetter.jpg">
      	<br /><br />
    ...
    <tr>
      <td colspan="2" rowspan="1">
        <br /></br /><br />
      	Ref: CLAB/REKAB/VER/<?php echo date('y');?>/<?php echo substr($ctr->ctr_clab_no, -6);?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td style="font-weight: bold;" colspan="2" rowspan="1">&nbsp;</td>
      <td style="text-align: right;" colspan="2" rowspan="1">
      	Fax:<?php echo $ctr->ctr_fax;?>
      </td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
	...
	<tr>
      <td colspan="4"><strong><u>PENGESAHAN PENERIMAAN PERMOHONAN MENYERTAI PROGRAM REKALIBRASI TENAGA KERJA (RTK)R </u></strong></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p>Dengan segala  hormatnya kami merujuk perkara di atas:</p><p align="justify">&nbsp;</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
      <td colspan="4"><p>2.  Dengan ini disahkan bahawa penama seperti dibawah ini telah menyertai Program  Rekalibrasi Tenaga Kerja melalui Construction Labour Exchange Centre Berhad. Berikut  adalah maklumat lengkap pemohon dan majikan :</p><p align="justify">&nbsp;</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">Kindly acknowledge receipt of this letter and return to us the enclosed duplicate copy.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
