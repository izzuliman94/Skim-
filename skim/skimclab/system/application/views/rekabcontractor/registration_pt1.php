...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contrekabContractor/checkCompanyNumber" method="POST" name="registrationForm1" id="registrationForm2">
  ...
  <table width="100%" border="0">
  	...
  	<tr>
  		<td><a href="<?php echo site_url();?>/contrekabContractor/editContractor/<?php echo $company->ctr_clab_no;?>"><?php echo $company->ctr_clab_no;?></a></td>
