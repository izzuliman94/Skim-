    	...
    	<tr>
    			...
    			<table width="90%" align="center" cellpaddig="0" cellspacing="0">
    				<tr>
    				  <td valign="top">
                        ...
                        <input type="checkbox" name="accessibility" value="T" <?php if(strpos($emp->emp_accessibility, 'T') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> SPIM (Transit Centre)<br />
                        ...
                        <input type="checkbox" name="accessibility" value="F" <?php if(strpos($emp->emp_accessibility, 'F') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> 
                        SPIM (First Year Renewal)<br />
                        ...
                        <input type="checkbox" name="accessibility" value="L" <?php if(strpos($emp->emp_accessibility, 'L') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> Legal<br />
                        <input type="checkbox" name="accessibility" value="H" <?php if(strpos($emp->emp_accessibility, 'H') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> Local Labour<br />
                        ...
                        <input type="checkbox" name="accessibility" value="M" <?php if(strpos($emp->emp_accessibility, 'M') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> ICT Report<br />
                        ...
                        <input type="checkbox" name="accessibility" value="P" <?php if(strpos($emp->emp_accessibility, 'P') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/> ICT Passport Management<br />
    		...
    		<td colspan="2">
    			<table width = "90%" align="center" border="1">
    				...
    				<tr>
                      <td><input type="checkbox" name="accessibility10" value="l" <?php if(strpos($emp->emp_accessibility, 'l') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				...
    				<tr>
                      <td><input type="checkbox" name="accessibility4" value="7" <?php if(strpos($emp->emp_accessibility, '7') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				  <td>Verification ( New Contractor Verification)</td>
  				  </tr>
    				<tr>
                      <td><input type="checkbox" name="accessibility4" value="8" <?php if(strpos($emp->emp_accessibility, '8') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				...
    				<tr>
                      <td><input type="checkbox" name="accessibility2" value="p" <?php if(strpos($emp->emp_accessibility, 'p') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				...
    				<tr>
                      <td><input type="checkbox" name="accessibility2" value="v" <?php if(strpos($emp->emp_accessibility, 'v') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				...
    				<tr>
                      <td><input type="checkbox" name="accessibility2" value="f" <?php if(strpos($emp->emp_accessibility, 'f') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
