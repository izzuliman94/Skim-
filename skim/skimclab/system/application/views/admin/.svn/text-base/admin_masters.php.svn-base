...
<table width="100%" border="1px">
	...
	<tr>
		<td class="print" width="40%" valign="top">
			<br /><br />
			<form method="POST" action="<?php echo site_url();?>/contAdmin/newMasterValueSubmit" name="addValueForm">
			<table width="100%" border="0">
				<tr>
					<td colspan="2" align="LEFT" class="print"><strong>Add New Value for <?php echo $tableValue;?></strong></td>
				</tr>
				<tr>
					<td class="print" width="30%">Code</td>
					<td class="print" width="70%"><input type="text" name="txtCode" /></td>
				</tr>
				<tr>
					<td class="print">Description</td>
					<td class="print"><input type="text" name="txtDesc" size="30"/></td>
				</tr>
				<tr>
					<td colspan="2" align="CENTER" class="print">
						<input type="hidden" name="txtTableName" value="<?php echo $tableName;?>" />
						<input type="submit" name="btnSubmit" value="Save" onclick="return confirm('Are you sure you want to save?');"/>
		...
		<td class="print" width="60%"> <br />
			...
			<table width="80%" align="LEFT" border="0">
				...
				?>
				<tr>
					<td align="CENTER"><a href="<?php echo site_url();?>/contAdmin/editMasterValue/<?php echo $tableName . "/" . $data->codevalue;?>"><u><?php echo $data->codevalue;?></u></a></td>
