    		...
    		<td colspan="2">
    			<table width = "90%" align="center" border="1">
				  ...
				  <tr>
    				  <td>&nbsp;</td>
    				  <td>&nbsp;</td>
				  <td><span class="style1">Acknowledgement</span></td>
  				  </tr>
				  <tr>
                      <td><div align="center">b</div></td>
    				  <td><input type="checkbox" name="accessibility" value="b" <?php if(strpos($emp->emp_accessibility, 'b') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				  <td>New Workorder Acknowledgement</td>
  				   </tr>
    				<tr>
    				  <td>&nbsp;</td>
    				  <td>&nbsp;</td>
    				...
    				<tr>
    				  ...
    				  <td>Create New Workorder (VDR, RENEWAL, GREEN CARD)</td>
  				  </tr>
    				<tr>
    				...
    				<tr>
    				  ...
    				  <td>Register New Labour (VDR, RENEWAL, GREEN CARD)</td>
  				  </tr>
    				<tr>
    				  <td><div align="center"></div></td>
    				  <td>&nbsp;</td>
