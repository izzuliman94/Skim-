...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
      ...
      <tr>
      	<td>Email Address</td>
      	<td colspan="3"><input type="text" name="email" size="50" maxlength="50" value="<?php echo $ctr->ctr_email;?>"/></tr>
      </tr>
	  <tr>
        <td>Grade</td>
      ...
      <tr>
      	...
      	<td colspan="3"><input type="checkbox" name="others" value="1" <?php if($ctr->ctr_attach_others == '1') echo "CHECKED";?>/>Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" value="<?php echo $ctr->ctr_attach_specify;?>" /> &nbsp; &nbsp; &nbsp <input type="button" name="btnAttach" value="Attach Doc" class="smoothbtn1" onclick="attachdoc();" />
      	</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="directorMobile" size="35" maxlength="50" value="<?php echo $ctr->ctr_dir_mobileno;?>"  onKeypress="if (event.keyCode < 44 || event.keyCode > 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"/></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="contactMobile" size="35" maxlength="50"  value="<?php echo $ctr->ctr_contact_mobileno;?>"/></td>
      </tr>
      <tr>
      	<td>Designation</td>
