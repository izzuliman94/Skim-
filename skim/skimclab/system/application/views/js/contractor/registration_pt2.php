...
<script type="text/javascript">
	...
	function fillDefaultPayment(){
	 if(document.newCtrForm.periodreg[0].checked)	document.newCtrForm.amount.value="21.20";
	 else if(document.newCtrForm.periodreg[1].checked)	document.newCtrForm.amount.value="42.40";
	 else if(document.newCtrForm.periodreg[2].checked)	document.newCtrForm.amount.value="53.00";
