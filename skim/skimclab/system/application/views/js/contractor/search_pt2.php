...
<h4><a href="dashboard.php">Contractor</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="search_pt1.php">Search</a></h4>
...
<h3 id="switchsection1-title" class="handcursor">Contractor - Search <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
    ...
    <table width="100%" border="0">
      ...
      <tr>
        <td><select name="select">
          ...
          <option value="2">CLAB Registration No</option>
          </select>
        </td>
...
<table width="100%" border="0">
  <tr>
    <th colspan="7">List Of Companies </th>
  </tr>
  <tr>
    <td>1</td>
    <td>AAAAaaaa</td>
    ...
    <td>Labor List </td>
    <td><a href="assign_labor_pt2.php">Assign Labor </a></td>
  </tr>
  <tr>
    <td>2</td>
    <td>BBBBbbbbb</td>
