...
<h4><a href="dashboard.php">Contractor</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="approval_pt1.php">Approval</a></h4>
...
<h3 id="switchsection1-title" class="handcursor">Contractor - Approval <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
  ...
  <form action="" method="get" name="TypicalForm" id="TypicalForm" onSubmit="return OnSubmitForm();">
    <table width="100%" border="0">
      <tr>
        ...
        <td width="70%">&lt;Contractor_Name&gt;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="5%"><div align="center">:</div></td>
        <td width="70%"><textarea name="textarea"></textarea></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
