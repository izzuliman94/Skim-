...
<tr>
   <td colspan="4" align="center"><input type="submit" value="Save" <?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/>&nbsp;<input type="button" onclick="clearfield()" value="Reset" /></td>
</tr>
</table>
</form>
</body>
