				...
				<tr>
				  ...
				  <td height="20px">
				    <!--div align="left">
				      ...
				      Registration :
			      Director's Fee</div-->
				    <input type="checkbox" <?php if($payment->clab_reg_amount == '21.2'){ echo "checked" ;} ?> disabled="disabled"/>
&nbsp;1 YRS
<input type="checkbox" <?php if($payment->clab_reg_amount == '42.4'){ echo "checked" ;} ?> disabled="disabled"/>
&nbsp;2 YRS
<input type="checkbox" <?php if($payment->clab_reg_amount == '53'){ echo "checked" ;} ?> disabled="disabled"/>
