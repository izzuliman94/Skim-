...
<script>
function senddata(passno,name,wrg,expdate,id){
...
<tr align="center">
    <td><?php echo $i++; ?></td>
    <td><a href="#" onclick="senddata('<?php echo $labour->wkr_passno; ?>','<?php echo $labour->wkr_name; ?>','<?php echo $labour->cty_desc?>','<?php echo $labour->wkr_passexp?>','<?php echo $labour->wkr_id?>')"><?php echo $labour->wkr_passno; ?></a></td>
