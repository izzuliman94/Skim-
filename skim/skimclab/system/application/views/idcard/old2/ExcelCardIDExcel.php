...
<tr>
<td width="5%" align="center" class="style5" ><div align="center" class="style8">No</div></td>
...
<td width="10%"align="center" class="style5"><div align="center" class="style8">Country</div></td>
<td width="10%"align="center" class="style5"><div align="center" class="style8">Permit Date</div></td>
...
<tr>
  ...
  <td class="style5"><div align="center" class="style11"><?php echo $sum->upload_destfilename?></div></td>
    <td class="style5"><div align="center" class="style11"><?php echo $sum->ctr_comp_name?></div></td>
  </tr>
<?php }} ?>
</table>
<p>&nbsp;</p>
