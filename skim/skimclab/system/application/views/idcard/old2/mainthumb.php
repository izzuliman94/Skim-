...
<tr>
  ...
  <td align="center">
  	<input type="button" value="..." onclick="openemp()"/>
	<input type="hidden" size="100" name="selemp"/>
   	<input type="hidden" name="wkrid" />  </td>
</tr>
<tr>
...
<tr>
    <td>Nama Syarikat</td>
	<td><input type="text" name="txtcomp" size="48"/></td>
    </tr>
<tr>
...
<table width="50%" align="center">
<tr>
    <td align="center"><!--input type="button" value="Print ID Card" onclick="printme()"/-->
    <input type="button" value="Thumbprint" onclick="thumbprint()"/></td>
