    	...
    	<tr>
    		...
    		<td>
	    		<table width="100%">
	    			...
	    			<tr><td align="center"><!--a href="mailto:lonpac@clab.com.my"  target="_blank">Insurance Purchase</a--><input type="button" value="Insurance Purchase" onclick="Inspchs()" /></td></tr>
