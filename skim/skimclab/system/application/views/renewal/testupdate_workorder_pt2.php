...
?>
<h4><a href="<?php echo site_url();?>/contRenewal/spimDashbrd">SPIM</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />Update Work Order </h4>
  ...
  <form action="<?php echo site_url();?>/contRenewal/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    	  ...
    	  <td align="center"><?php echo anchor_popup("contRenewal/printHandoverList/". $woRow->wo_id,"Print Handover Letter");?></td>
    	  <td>&nbsp;</td>
  	  </tr>
    	<tr>
    	  <td>Rejection</td>
