  ...
  <form action="<?php echo site_url();?>/contRenewal/newWorkOrderPt2Submit" method="POST" name="newWorkorderForm" id="newWorkorderForm"  onsubmit="return v.exec();">
    <table width="100%" border="0">
		<tr>
			...
			<td width="17%">Ack No</td>
			<td width="33%"><select name="selack">
				<option value=""></option>
    ...
    <br />
     <table width="80%" border="0">
		...
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkins_guarante" value="1"/>	        
		      Insurance -  <i>(Insurance Guarantee  / Stamp Duty/*6% Service Tax)</i></td>
		</tr>
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkins_hospital" value="1"/>	         Insurance -  <i>(Foreign Worker Hospitalisation and Surgical Insurance Scheme / Stamp duty)</i></td>
		</tr>    
