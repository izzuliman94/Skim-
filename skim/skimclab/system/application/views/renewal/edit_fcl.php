...
<script type="text/javascript">
	...
	function checktrigger(chkbox, datebox){
...
<tr>
  ...
  <td colspan="3"><input type="text" id="datepermitexp" name="datepermitexp"  value="<?php if($fcl->fcl_plksdate1 != "0000-00-00") echo date('d-m-Y',strtotime($fcl->fcl_plksdate1)) ?>" maxlength="250" size="20" readonly/>
    ...
    to 
    <input name="datepermitexp2" type="text" id="datepermitexp2"  value="<?php if($fcl->fcl_plksdate2 != "0000-00-00") echo date('d-m-Y',strtotime($fcl->fcl_plksdate2)) ?>" size="20" maxlength="250" readonly="readonly"/> <input id="btnpermitexpdate2" name="btnpermitexpdate2" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('datepermitexp2'), this)" /></td>
</tr>
<tr>
  <td id="t_txtpassexp4">Passport Received</td>
  <td colspan="3"><!--input type="checkbox" name="chkrecppt" value="1" <?php if($fcl->fcl_recppt == '1') echo "CHECKED" ; ?>/-->
	  <input type="checkbox" name="chkrecppt" value="1" onclick="checktrigger(this, daterecppt);" <?php if($fcl->fcl_recppt == '1') echo "CHECKED";?>/>
	  
    <!--input type="text" id="daterecppt" name="daterecppt"  value="<?php if($fcl->fcl_recpptdate != "0000-00-00") echo date('d-m-Y',strtotime($fcl->fcl_recpptdate)) ?>" maxlength="250" size="20" readonly="readonly"/-->
	  <input type="text" name="daterecppt" size="12" id="daterecppt" value="<?php if(strlen($fcl->fcl_recpptdate) > 0 && $fcl->fcl_recpptdate != '0000-00-00') echo date('d-m-Y', strtotime($fcl->fcl_recpptdate));?>" READONLY/>
	  
    <input id="btngcdate" name="btnrecpptdate" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('daterecppt'), this)" /></td>
</tr>
<tr>
...
<tr>
   ...
   <td colspan="3"><input type="text" name="txtyren" value="<?php echo $fcl->fcl_year_renewal;?>" maxlength="2" size="20"  /><input type="hidden" name="txtyrendate" maxlength="30" size="20" /><input type="hidden" name="txtcdate" value="<?php echo date("Y-m-j")?>" maxlength="30" size="20" /></td>
</tr>
<tr>
