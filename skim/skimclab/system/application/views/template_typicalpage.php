...
<h3 id="switchsection1-title" class="handcursor">SwitchSection   <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 


  <form action="" method="get" name="TypicalForm" id="TypicalForm">
    <table width="100%" border="0">
	
      <tr>
        <td width="25%">Typical Form Field </td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="submit" name="TypicalButton" value="Typical Button" /></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
