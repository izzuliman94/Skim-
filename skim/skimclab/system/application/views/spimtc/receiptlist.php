...
function senddata(paymentno,frm){
 ...
 if(opener.updateWorkorderForm.payrefno.value == ""){
    opener.updateWorkorderForm.payrefno.value = paymentno;
 }else{
    opener.updateWorkorderForm.payrefno.value = opener.updateWorkorderForm.payrefno.value + " , " + paymentno;
 }
   
   
 }else{
 
    if(opener.newWorkorderForm.payrefno.value == ""){
    opener.newWorkorderForm.payrefno.value = paymentno;
 }else{
    opener.newWorkorderForm.payrefno.value = opener.newWorkorderForm.payrefno.value + " , " + paymentno;
 }
