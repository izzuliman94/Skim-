...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <td colspan="4"><p align="justify">Kami, dari  Construction Labour Exchange Centre Berhad (CLAB), ingin menyerahkan sementara  dokumen yang tersebut diatas bagi &nbsp;<?php echo $woRow->wo_receivevisa_approve;?>&nbsp;orang pekerja <span class="print"><?php  echo $woRow->cty_desc;?></span> bagi proses kemasukan pekerja ke  Malaysia.</p>      </td>
    ...
    <tr>
      <td colspan="4"><p align="justify">Surat Permohonan Visa dan Rujukan dan resit  bayaran asal hendaklah diserahkan kembali kepada pihak kami semasa ketibaan  pekerja bagi urusan di Jabatan Imigresen Malaysia.</p>      </td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">Sila pastikan pekerja-pekerja di atas <strong><u>menjalankan pemeriksaan FOMEMA&nbsp; sebaik sahaja tiba di Malaysia</u></strong> dan paspot  pekerja-pekerja tersebut hendaklah diserahkan kepada CLAB setelah pemeriksaan dibuat.  Ini adalah untuk mengelakkan pihak tuan dari membayar <strong>compound RM1,000 dan denda SP (RM100/pekerja)</strong> jika pekerja-pekerja  di atas tidak mendapatkan PLKS dalam tempoh pas khas sebulan yang diberikan  oleh pihak Imigresen dari tarikh kemasukan pekerja. </p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">Kerjasama  daripada pihak tuan amatlah kami hargai.<br>
    ...
    <tr bordercolor="#000000">
      <td colspan="4"><p align="justify"><strong>Akuan Penerimaan</strong><br>
