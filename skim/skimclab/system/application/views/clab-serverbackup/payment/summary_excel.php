...
header("Content-Disposition: attachment; filename=payment_summary_rpt_".date('dmy').".xls"); 
...
<table width="200%" border="0" style="border-collapse: collapse;" bordercolor="#CCC">
	<tr><td colspan=50 height=50 align="center" valign=middle class="style8">Summary of Payment</td></tr>
</table>
<table width="200%" border="1" style="border-collapse: collapse;" bordercolor="#CCC" cellpadding=2>
	<tr>
		...
		<td colspan="4" align="center" class="style5"><div align="center" class="style8">Others</div></td>
		...
		<td rowspan="2" align="center" class="style5"><div align="center" class="style8">CHQ NO OTHERS</div></td>
	</tr>
	<tr>
	...
	<?php if($summary->num_rows() == 0){ ?>
		<tr><td valign=middle align=center colspan=50 height=100 class="style8"><b>No data to display</b></td></tr>
	<?php }else{ 
		$i = 1;
	...
	<tr>
		...
		<td align="center" class="style10"><?php echo $sum->remarks_others ?></td>
		...
		<td class="style5"><span class="style11"><?php echo $sum->others_chq_no?></span></td>
	</tr>
<?php }} ?>
</table>
