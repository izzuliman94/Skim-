...
<tr>
    ...
    <td><input name="chkcancel" type="checkbox" id="chkcancel" onclick="cancelreceipt();" value="1" <?php if($payment->pmt_withdraw == '1') echo "checked , disabled" ;?> />
      Cancel Receipt&nbsp; &nbsp;&nbsp;
      <input name="dtcancel" type="text" id="dtcancel" value="<?php echo $payment->pmt_wd_date ?>" size="11"/>
      <input id="button5" name="btnDate5" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtcancel'), this)" /></td>
</tr>
<tr>
    <td>Payment Type:</td>
...
<tr>
   <td colspan="4" align="center"><input type="submit" value="Update" /><input type="button" value="Print Receipt" onclick="printForm()" />
     <input type="button" value="Print Invoice" onclick="printForm2()" />
     <!--input type="button" value="Preview Invoice" onclick="printForm3()" /--></td>
</tr>
</table>
</form>
</body>
