...
Legal</td>
    			  ...
    			  <tr>
    			    ...
    			    <td><input type="checkbox" name="accessibility23" value="H" <?php if(strpos($emp->emp_accessibility, 'H') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/>
Local Labour</td>
  			    </tr>
    			  <tr>
    		...
    		<td colspan="2">
    			<table width = "90%" align="center" border="1">
    				...
    				<tr>
    				  ...
    				  <td><input type="checkbox" name="accessibility34" value="v" <?php if(strpos($emp->emp_accessibility, 'v') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
    				  <td>Edit</td>
  				  </tr>
    				<tr>
    				  <td><div align="center"></div></td>
    				...
    				<tr>
    				  <td><div align="center">a</div></td>
    				  <td><input type="checkbox" name="accessibility2" value="a" <?php if(strpos($emp->emp_accessibility, 'a') !== false) echo "CHECKED"; ?> onclick="checkMe(this)"/></td>
