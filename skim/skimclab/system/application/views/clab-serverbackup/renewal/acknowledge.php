    ...
    <td colspan="2">
	    ...
	    <table width="100%">
	    	<tr>
			    ...
			    <td width="45%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">:&nbsp;<?php echo date('d-m-Y G:i:s') ?></td>
			    <td width="19%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">Bil Pekerja </td>
			    <td width="6%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">: <?php echo $woRow->wo_fcl_total;?> </td>
			</tr>
			<tr>
...
<tr>
  <td style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;color: #B09090;"><p>http://www.clab.com.my</p>    <p>facebook: https://www.facebook.com/clabmalaysia</p><p>instagram : clabmalaysia</p></td>
</tr>
