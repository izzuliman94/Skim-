  ...
  <form action="<?php echo site_url();?>/contRenewal/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <br />
       <table width="100%" border="0">
		...
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkimigration" value="1" <?php if($woRow->pay_imigration == '1') echo "checked";?>/> 
		   CLAB - <i>(Processing Fees/Visa/Levi)</i></td>
		</tr>
		<tr>
		...
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkins_guarante" value="1" <?php if($woRow->pay_ins_guarante == '1') echo "checked";?>/>	         Insurance -  <i>(Insurance Guarantee  / Stamp Duty/*6% Service Tax)</i></td>
		</tr>
		<tr>
      ...
      <table width="100%" border="0">
      	<tr>
      		...
      		<th align="RIGHT" colspan="8"><input type="button" name="btnRegisNewLabour" value="Register New Labour" onclick="registerNewLabor();" <?php echo $close ?>/><!--input type="button" name="btnUploadFCL" value="Upload FCL list" class="smoothbtn1" onclick="openuploadwindow();" /--></th>
      	</tr>
