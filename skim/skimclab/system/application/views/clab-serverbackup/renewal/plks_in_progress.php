...
<tr>
	...
	<td width="89%">:CLAB\EXT\PLKS\<?php echo date('y',strtotime($woRow->wo_date)); ?>\<?php echo $woRow->wo_id ?></td>
</tr> 
<tr>
    <td colspan="2">&nbsp;</td>
</tr> 
...
<tr>
  <td colspan="2"><p align="justify">Merujuk perkara di atas,  pihak kami memaklumkan bahawa passport  pekerja  di bawah penyeliaan  pihak tuan, masih dalam proses lanjutan di Jabatan Imigresen Malaysia bagi tujuan penampalan PLKS. Berikut adalah senarai  nama pekerja:-</p></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
...
<tr>
  <td colspan="2"><strong>Pengurus Jabatan Operasi</strong></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
