...
?>
<h4><a href="dashboard.php">Acknowledgement</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New Acknowledgement</h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contAck/newAckSearchCtr" method="POST" name="frmNewWorkOrder" id="frmNewWorkOrder">
  ...
  ?>
				  <table width="100%" border="0">
				  	...
				  	<?php
					if(strpos($accessibility, 'b') == false) echo "USER NOT ALLOWED";
					...
					?>
				  	<tr>
                        ...
                        <?php if(strpos($accessibility, 'b') == true) {?>
                        	
							<?php /* if($ctr->ctr_status == 1){ */?>
                            
                        	<a href="<?php echo site_url('');?>/contAck/newAckPt2/<?php echo $ctr->ctr_clab_no;?>">New Acknowledgement</a>
                        	<?php   }
							else {
							 ?>
    					...
    					<a href="#" onclick="showAlert2();">New Acknowledgement</a>
                        <?php }?>
