...
?>
  <form action="<?php echo site_url();?>/contAck/updateAcknowledgementPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    <table width="100%" border="0">
	  ...
	  <td width="8%"> Type</td>
	  <td width="9%"><input type="text" name="txtacktype" size="15" value="<?php echo $woRow->pmt_type_desc;?>" readonly="readonly" /></td>
...
<br />
       <table width="100%" border="0">
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkimigration" value="1" <?php if($woRow->pay_imigration == '1') echo "checked";?>/> 
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkclab" value="1" <?php if($woRow->pay_clab == '1') echo "checked";?>/>	         CLAB -  <i>(Admin Fees/*6% Service Tax)
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkins_guarante" value="1" <?php if($woRow->pay_ins_guarante == '1') echo "checked";?>/>	         Insurance -  <i>(Insurance Guarantee  / Stamp Duty/*6% Service Tax)
