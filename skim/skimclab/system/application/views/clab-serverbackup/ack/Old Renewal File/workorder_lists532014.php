...
<h4><a href="dashboard.php">Spim (Renewal)</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Dashboard <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />  Lists</h4>
...
<form method="POST" action="<?php echo site_url();?>/contRenewal/searchWorkorders" name="frmSearch" value="frmSearch">
	<table width="100%" border="0">
		<tr>
		    ...
		    <input type="radio" name="rdsearchby" value="fcl_newpassno" />Passport No</td>
		</tr>
		<tr>
			<td>Keyword:</td>
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="btnSearch" value=" Search " />
				<input type="button" name="btnReset" value="Reset" onclick="location.href='<?php echo site_url();?>/contRenewal/listAllWorkorders'" />
			</td>
		</tr>
	</table>
</form>
