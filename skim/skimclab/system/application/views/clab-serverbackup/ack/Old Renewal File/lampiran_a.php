...
<tr>
    <td width="30%" align="center"><?php echo $lampiran->wo_personincharge ?></td>
    <td width="30%" align="center">ROHAIDAH BT SAPUAN</td>
    <td width="30%" align="center">ABDUL RAFIK B ABD RAJIS</td>
</tr>
<tr>
    <!--td width="30%" align="center"><?php echo $woRow->emp_position ?></td-->
    <td width="30%" align="center">Corporate Service Specialist</td>
    <td width="30%" align="center">Snr. Corp. Service Executive</td>
...
<tr>
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td><span class="style2">Nama Company : <?php echo $lampiran->ctr_comp_name?></span></td>
</tr>
<tr>
  <td >&nbsp;</td>
  <td>&nbsp;</td>
