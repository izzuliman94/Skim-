...
<h4><a href="dashboard.php">Acknowledgement</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update <a href="dashboard.php">Acknowledgement</a> </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contAck/updateAcknowledgementSearch" method="POST" name="updateWorkorderForm" id="updateWorkorderForm">
    <table width="100%" border="0">
		
      <tr>
        <td width="20%">Search By</td>
        <td width="80%"><input type="radio" name="searchby" value="wo_num" CHECKED/>Acknowledgement Number 
...
?>
	<table width="100%" border="0">
		<tr>
			<th width="15%">Acknowledgement ID</th>
		...
		?>
		<tr>
			<td><a href="<?php echo site_url();?>/contAck/updateWorkOrderPt2/<?php echo $ctr->wo_id;?>"><?php if(strlen($ctr->wo_num) > 0) echo $ctr->wo_num; else echo $ctr->wo_id;?></a></td>
