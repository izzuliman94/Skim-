  ...
  <form action="<?php echo site_url();?>/contContractor/registrationFormSubmit" method="POST" name="newCtrForm" id="newCtrForm" onsubmit="return v.exec()">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="companyregno" maxlength="20" value="<?php echo $companyno;?>"/> <font color="red">*</font></td>
        <td>GST No</td>
      ...
      <tr>
      	...
      	<td>
      		...
      		<input type="radio" name="periodreg" value="3" onclick="yment();"/>3 years      	</td>
      	<td>Amount (RM)</td>fillDefaultPa
