...
<script type="text/javascript">
	function showAlert(){
		alert("You are not allowed to open blacklisted company. Please contact your Administrator!!");	
	}
...
?>
	<table width="100%" border="0">
		...
		<tr>
			...
			<td><?php if($ctr->ctr_status == 4){ ?>
				<?php if(strpos($accessibility, 'o') == true) {?>	
                       <a href="<?php echo site_url();?>/contContractor/changeCtrStatusPt2/<?php echo $ctr->ctr_clab_no;?>">Change Status</a>
				<?php }
                	  else {
                ?>
