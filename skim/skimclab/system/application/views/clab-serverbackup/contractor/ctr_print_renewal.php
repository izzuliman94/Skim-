...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="22%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
      <td colspan="1" rowspan="10" valign="top" width="18%"><br />
          <br /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="4"><h3><u>CLAB REGISTRATION RENEWAL</u></h3></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">With reference to the above, we are pleased to inform that your registration has been renewed with Construction Labour Exchange Centre Berhad (CLAB). Details of your registration are as follows :</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="4"><strong>p.p        CHIEF EXECUTIVE OFFICER </strong></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
