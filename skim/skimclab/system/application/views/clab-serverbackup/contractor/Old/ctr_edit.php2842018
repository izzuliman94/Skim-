...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="companyregno" maxlength="20" value="<?php echo $ctr->ctr_comp_regno;?>"/> <font color="red">*</font></td>
        <td>GST No</td>
        <td><input name="companygstno" type="text" value="<?php echo $ctr->ctr_gst_no;?>" maxlength="13"/></td>
      </tr>
      <tr>
