...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
        <th colspan="4" align="RIGHT">
        	...
        	<input type="button" name="btnBack" value="Back" onclick="location.href='<?php echo site_url();?>/contContractor/ctrList';"/>                
        </th>
      </tr>
      <tr>
      	<td colspan="4" align="RIGHT"><?php echo anchor_popup("contContractor/viewListOfLabours/" . $ctr->ctr_clab_no, "View List of Labours");?>
      	</td>
      </tr>
      <tr>
        <td width="20%">CLAB No</td>
        <td width="30%"><input type="text" name="clabno" value="<?php echo $ctr->ctr_clab_no;?>" READONLY /></td>
        ...
        <td width="30%">
        			    ...
        			    &nbsp;<input type="button" name="btnView1" value="View Status History"  class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contContractor/ctrStatusHistory/<?php echo $ctr->ctr_clab_no;?>', 'Change Status History', 'height=350, width=510, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
        </td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
      	<td>Reg. Status</td>
      	<td><font color="#990000"><?php echo $ctr->appstatus_desc;?></font></td>
      </tr>
	  <tr>
        <td id="t_companyname">Company Name</td>
        <td colspan="3"><input type="text" name="companyname" size="100" maxlength="250" value="<?php echo $ctr->ctr_comp_name;?>"/><font color="red">*</font></td>
      </tr>
      <tr>
        <td>Company Reg. No.</td>
        <td colspan="3"><input type="text" name="companyregno" maxlength="20" value="<?php echo $ctr->ctr_comp_regno;?>"/> <font color="red">*</font></td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Address 2</td>
        <td colspan="3">
        	<input type="TEXT" name="address2" size="80" maxlength="100"  value="<?php echo $ctr->ctr_addr2;?>"/>
        </td>
      </tr>
      <tr>
        <td>Address 3</td>
        <td colspan="3">
        	<input type="TEXT" name="address3" size="80" maxlength="100"  value="<?php echo $ctr->ctr_addr3;?>"/>
        </td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="telephone1" maxlength="20" value="<?php echo $ctr->ctr_telno;?>"/> <font color="red">*</font> <input type="text" name="telephone2" maxlength="20" value="<?php echo $ctr->ctr_telno1;?>"/> </td>
      	<td>Fax No</td>
      	<td><input type="text" name="fax" maxlength="20" value="<?php echo $ctr->ctr_fax;?>"/> </td>
        </tr>
		<tr>
		    <td>Agent</td>
			<td colspan="3"><input type="text" name="txtagname" value="<?php echo $ctr->agency_name;?>" size="80" readonly/>
			<input type="hidden" name="txtagid" value="<?php echo $ctr->agent_id;?>" readonly/>
			<input type="button" name="btnagn" onclick="getagent('E')" value="..."/> 
			</td>			
		</tr>
		<tr>
		    <td>Address 1</td>
			<td colspan="3"><input type="text" name="txtagadd1" size="80" value="<?php echo $ctr->agency_addr1;?>" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 2</td>
			<td colspan="3"><input type="text" name="txtagadd2" size="80" value="<?php echo $ctr->agency_addr2;?>" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 3</td>
			<td colspan="3"><input type="text" name="txtagadd3" size="80" value="<?php echo $ctr->agency_addr3;?>" readonly/></td>			
		</tr>
	  <tr>
        ...
        <td id="t_cidbexpire">CIDB Exp. Date</td>
      	<td><input type="text" name="cidbexpire" id="cidbexpire" maxlength="20" value="<?php if($ctr->ctr_cidbexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_cidbexp_date));?>" READONLY/>
      		<input id="button1" name="btnDate1" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('cidbexpire'), this)" />    
      	</td>
      </tr>
      <tr>
      	<td>Email Address</td>
      	<td colspan="3"><input type="text" name="email" size="50" maxlength="50" value="<?php echo $ctr->ctr_email;?>"/></td>
      </tr>
	  <tr>
        <td>Grade</td>
      ...
      <tr>
        ...
        <td colspan="3"><select name="category" id="selcategory" onchange='javascript:addtocategory();'>
                        ...
                        <input type="text" name="txtcategory" id="txtcategory" size="30" value="<?php echo $ctr->ctr_category;?>" READONLY/><input type="button" name="clear" class="smoothbtn1" value="Clear" onclick='javacript:clearcategory();'/>
        </td>
      </tr>
      <tr>
        ...
        <td colspan="3"><select name="specialization" id="selspec" onchange='javascript:addtospec();'>
                        ...
                        <input type="text" name="txtspec" id="txtspec" size="30"  value="<?php echo $ctr->ctr_spec;?>" READONLY/><input type="button" name="clear2" value="Clear" class="smoothbtn1" onclick='javascript:clearspec();' />
        </td>
      </tr>
      <tr>
      	<td>CLAB Exp. Date</td>
      	<td colspan="3"><input type="text" name="clab_expdate" value="<?php if($ctr->ctr_clabexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_clabexp_date));?>" READONLY/> <input type="button" name="btnPayment" class="smoothbtn1" value="Payment" onclick="addpayment();" /></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="3">&nbsp;</td>
      ...
      <tr>
      	<td>Attachments</td>
      	<td colspan="3"><input type="checkbox" name="form24" value="1" <?php if($ctr->ctr_attach_form24 == '1') echo "CHECKED";?> />Form24
      	                ...
      	                <input type="checkbox" name="iccopy" value="1" <?php if($ctr->ctr_attach_iccopy == '1') echo "CHECKED";?>/>IC Copy
      	</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="3"><input type="checkbox" name="others" value="1" <?php if($ctr->ctr_attach_others == '1') echo "CHECKED";?>/>Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" value="<?php echo $ctr->ctr_attach_specify;?>" /> &nbsp; &nbsp; &nbsp; <input type="button" name="btnAttach" value="Attach Doc" class="smoothbtn1" onclick="attachdoc();" />
      	</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="directorMobile" id="directorMobile" size="35" maxlength="50" value="<?php echo $ctr->ctr_dir_mobileno;?>"  onchange="javascript:addkod(1,this.value);" onKeypress="if (event.keyCode < 44 || event.keyCode > 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"/></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td><input type="text" name="contactMobile" id="contactMobile" size="35" maxlength="50"  value="<?php echo $ctr->ctr_contact_mobileno;?>" onchange="javascript:addkod(2,this.value);" /></td>
      </tr>
      <tr>
      	<td>Designation</td>
      	<td colspan="3"><input type="text" name="contactDesig" size="80" maxlength="250"  value="<?php echo $ctr->ctr_contact_desg;?>"/></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
        <td colspan="3">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Entered date</td>
      	<td><input type="text" name="entereddate" id="entereddate" value="<?php echo date('d-m-Y', strtotime($ctr->ctr_procdate))?>" READONLY/>
      	    <input id="button2" name="btnDate2" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('entereddate'), this)" />    
      	</td>
      </tr>
      <tr>
      	<td>Verified by</td>
      	...
      	<td>Verified date</td>
      	<td><input type="text" name="verdate" id="verdate" value="<?php if($ctr->ctr_verifieddate != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_verifieddate))?>" READONLY/>
			<input id="button3" name="btnDate3" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('verdate'), this)" />    
      	</td>
     </tr>
      <tr>
      	<th>OPR1</th>
      ...
      <tr>
      	...
      	<td>Approved Date</td>
      	<td><input type="text" name="appdate" id="appdate" value="<?php if(strlen($ctr->ctr_app_date) > 0 && $ctr->ctr_app_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_app_date))?>" READONLY/>
      	    <input id="button4" name="btnDate4" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('appdate'), this)" />
      	</td>
      </tr>
      <tr>
      	<td>Rejected by</td>
      	...
      	<td>Rejected Date</td>
      	<td><input type="text" name="rejdate" id="rejdate" value="<?php if(strlen($ctr->ctr_rej_date) > 0 && $ctr->ctr_rej_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_rej_date))?>" READONLY/>
      	    <input id="button5" name="btnDate5" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('rejdate'), this)" />    
      	</td>
      </tr>
      <tr>
      	<td>Reason for rejection</td>
      	<td colspan="3"><input type="text" name="txtrejectreason" size="80" value="<?php echo $ctr->ctr_reject_reason;?>" /></td>
      </tr>
      <tr>
      	<td>Withdrawal by</td>
      	...
      	<td><input type="text" name="withddate" id="withddate" value="<?php if(strlen($ctr->ctr_withd_date) > 0 && $ctr->ctr_withd_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_withd_date))?>" READONLY/>
      	    <input id="button6" name="btnDate6" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('withddate'), this)" />    
      	</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
