...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
	  ...
	  <tr>
		...
		<tr>
		    <td>Agent</td>
			<td colspan="3"><input type="text" name="txtagname" value="<?php echo $ctr->agent_desc;?>" size="80" readonly/>
		...
		<tr>
		    <td>Address 1</td>
			<td colspan="3"><input type="text" name="txtagadd1" size="80" value="<?php echo $ctr->agent_addr1;?>" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 2</td>
			<td colspan="3"><input type="text" name="txtagadd2" size="80" value="<?php echo $ctr->agent_addr2;?>" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 3</td>
			<td colspan="3"><input type="text" name="txtagadd3" size="80" value="<?php echo $ctr->agent_addr3;?>" readonly/></td>			
		</tr>
	  <tr>
