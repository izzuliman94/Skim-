...
Website: www.clab.com.my<br>
	...
	<tr>
      <td colspan="4"><h3><u>FINAL REMINDER FOR <?php echo $titleWord;?> EXPIRY</u></h3></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="4">
      	...
      	<tr>
      		<th class="print" align="CENTER" height=20>No.</th>
		...
		$gsumjim_bd=0;$gsumins_bd=0;$gsumcla_bd=0;$gsumfom_bd=0;
		$gsumjim_cb=0;$gsumins_cb=0;$gsumcla_cb=0;$gsumfom_cb=0;
		$gsumjim_in=0;$gsumins_in=0;$gsumcla_in=0;$gsumfom_in=0;
		$gsumjim_id=0;$gsumins_id=0;$gsumcla_id=0;$gsumfom_id=0;
		$gsumjim_kz=0;$gsumins_kz=0;$gsumcla_kz=0;$gsumfom_kz=0;
		$gsumjim_kg=0;$gsumins_kg=0;$gsumcla_kg=0;$gsumfom_kg=0;
		$gsumjim_la=0;$gsumins_la=0;$gsumcla_la=0;$gsumfom_la=0;
		$gsumjim_bm=0;$gsumins_bm=0;$gsumcla_bm=0;$gsumfom_bm=0;
		$gsumjim_np=0;$gsumins_np=0;$gsumcla_np=0;$gsumfom_np=0;
		$gsumjim_pk=0;$gsumins_pk=0;$gsumcla_pk=0;$gsumfom_pk=0;
		$gsumjim_rp=0;$gsumins_rp=0;$gsumcla_rp=0;$gsumfom_rp=0;
		$gsumjim_th=0;$gsumins_th=0;$gsumcla_th=0;$gsumfom_th=0;
		$gsumjim_uz=0;$gsumins_uz=0;$gsumcla_uz=0;$gsumfom_uz=0;
		$gsumjim_vm=0;$gsumins_vm=0;$gsumcla_vm=0;$gsumfom_vm=0;
		$gsumjim_sl=0;$gsumins_sl=0;$gsumcla_sl=0;$gsumfom_sl=0;
	...
	function kpim($negara,$sumjim,$fcl){
		$nation=$negara.' ('.$fcl.')'; 
		echo '<tr><td colspan=2><b>'.$nation.'</b></td></tr>';				
		echo '<tr>';
		echo '<td width=500 height=20><b>Bank Draft to :</b></td>';
		echo '<td align=center><b>Total(RM)</b></td>';
		echo '</tr>';
		echo '<tr>';
		echo '<td height=20>Ketua Pengarah Imigresen Malaysia</td>';
	...
	function lonpac($fcl,$fine){ 
		...
		echo '<tr>';
		echo '<td height=20>Lonpac Insurance Berhad</td>';
	...
	function fomema($fcl){ 
		$fomema=200;$amtfom=0;$sumfom=0;
		$amtfom=$fomema * $fcl;
		$sumfom=($amtfom * 0.06) + $amtfom;

		echo '<tr>';
			echo '<td height=20>Construction Labour Exchange Centre Berhad (Fomema Online)</td>';
	...
	$gkpim=0;$glonpac=0;$gclab=0;$gfom=0;
	...
	$gsumcla_np + $gsumcla_pk + $gsumcla_rp + $gsumcla_th + $gsumcla_uz + $gsumcla_vm + $gsumcla_sl + $gsumfom_bd + $gsumfom_cb + $gsumfom_in + $gsumfom_id + $gsumfom_kz + $gsumfom_kg + $gsumfom_la + $gsumfom_bm + $gsumfom_np + $gsumfom_pk + $gsumfom_rp + $gsumfom_th + $gsumfom_uz + $gsumfom_vm + $gsumfom_sl;
	...
	<tr>
		<td colspan="4">
			<table width=100% border="1" cellpadding="3" style="border-collapse: collapse"bordercolor="#ccc" >
				<tr><td colspan=4 height=25 align=center><b>Grand Total (RM)</b></td></tr>
				<tr>
					<td height=25 align=center>Ketua Pengarah Imigresen Malaysia</td>
					<td align=center>Lonpac Insurance Berhad</td>
					<td align=center>Construction Labour Exchange Centre Berhad</td>
	...
	<tr><td colspan="4">&nbsp;</td></tr>
    <tr>
      <td colspan="4"><p align="justify">In regards to the above, if there is no news from your goodselves upon expiry of the permit of the workers, 
      					we would consider that you are not interested in renewing the permit for the above-said workers and we are not entertaining to any renewal request from your goodselves. 
      					We also have the right to terminate/blacklist the permit of the workers and a police report would be lodge on regard the above-said workers.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="text-align: left; width: 616px;">
  <tbody>
	...
	<tr>
      ...
      <td>Payment separate by nationality<br /></td>
    </tr>
    <tr>
      <td colspan="3"><input type="checkbox" name="checkbox42" value="checkbox"></td>
