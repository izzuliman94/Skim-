  	...
  	function fillDefaultPayment(x)
{
	...
	if(x==10) {document.getElementById("amount").value="180.20";} 
	if(x==11) {document.getElementById("amount").value="201.40";}
	if(x==12) {document.getElementById("amount").value="212.00";} 
}
  </script>
  <style type="text/css">
<!--
