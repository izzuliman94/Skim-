...
<h4><a href="dashboard.php">Spim</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> List of Approval</h4>
...
<table width="100%" border="0">
	...
	<tr>
		<td><?php echo $i++ ?></td>
		<td><a href="<?php echo site_url();?>/contSpim/updateWorkOrderPt2/<?php echo $ctr->wo_id?>"><?php echo $ctr->wo_num?></a></td>
