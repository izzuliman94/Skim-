...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      ...
      <td width="17%">&nbsp;</td>
      <td width="18%">&nbsp;</td>
      <td colspan="1" rowspan="9" valign="top" width="18%"><p><img src="<?php echo base_url();?>images/logoLetter.jpg">
        <br /><br />
...
Website: www.clab.com.my <br>
        </span><span style="font-size: 6pt; font-family: &quot;Arial&quot;; color: navy;"><br>
      </span></p></td>
    </tr>
    <tr>
      <td colspan="2" rowspan="1">
        <br /></br /><br />
      	Rujukan Kami: CLAB/VDR/PPK/<?php if($woRow->wo_num == '') echo $woRow->wo_id; else echo $woRow->wo_num;?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<tr>
      <td colspan="4"><strong><u>PERMOHONAN PAS KHAS</u></strong></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
  ...
  <td colspan="4"><p>Pihak kami ingin memohon kerjasama pihak tuan untuk mendapatkan Pas Khas bagi  pekerja berkenaan. Bersama ini kami sertakan borang Permohonan Pas Khas dan senarai nama pekerja beserta nombor passport pekerja sebagai rujukan pihak tuan.</p>      </td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
