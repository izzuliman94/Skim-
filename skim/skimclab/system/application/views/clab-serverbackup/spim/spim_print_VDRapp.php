...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
	...
	<tr>
      <td colspan="4"><p><strong><u>PERMOHONAN VISA DENGAN RUJUKAN (VDR) &nbsp;</u></strong></p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
  ...
  <td colspan="4"><p>Di sini kami  memohon jasa baik pihak tuan untuk mendapatkan pas visa dengan rujukan bagi <?php echo $woRow->wo_fcl_total;?> pekerja warga <span class="print">
    ...
    <tr>
      <td colspan="4"><p>Bersama dengan  permohonan ini kami kepilkan bersama dokumen-dokumen berikut untuk pertimbangan  pihak tuan :</p>      
        <ol>
        <ul>
          <li>Salinan surat kebenaran  KDN </li>
          <li>Bank Draf </li>
          <li>Insurance Guarantee</li>
          <li>Salinan Passport</li>
          <li>Laporan Kesihatan</li>
          <li>Borang IM 12</li>
          <li>Gambar Pekerja</li>
          <li>Borang Bayaran</li>
        </ul>
      </td>
    </tr>
    <tr>
