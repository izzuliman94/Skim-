 ...
 <tr>
  <td align="CENTER" class="print">
	...
	<table width="100%" border="0">
		...
		<tr>
			<td class="print"><input type="checkbox" name="" value="1" /> Payment Schedule, IG, FWHS & FWCS</td>
			<td class="print">______________________</td>
...
Agency Fee</td>
	...
	<table width="100%" border="1">
		...
		<tr>
			<td class="print">Nazatul Akmar Bt. Abdul Halim</td>
		  <td class="print">Amiruddin Abdul Rahim</td>
