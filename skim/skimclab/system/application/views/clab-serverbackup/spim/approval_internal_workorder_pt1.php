...
<h4><a href="dashboard.php">Immigration</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="approval.php">Approval Status</a> <img src="../images/right_arrow.gif" width="13" height="14" /> Internal</h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="../immigration/approval_internal_workorder_pt2.php" method="get" name="TypicalForm" id="TypicalForm">
    <table width="100%" border="0">
	
      <tr>
        <td width="25%">Workorder ID </td>
        <td width="5%"><div align="center">:</div></td>
        <td width="70%"><input type="text" name="txtTypicalForm" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
