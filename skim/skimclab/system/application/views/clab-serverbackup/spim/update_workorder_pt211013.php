   ...
   <br />
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    		...
    		<td align="center"><?php echo anchor_popup("contSpim/printCheckLits/". $woRow->wo_id,"PrintChecklist");?><br /><input type="button" value="Insurance Purchase" onclick="Inspchs()" /></td>
