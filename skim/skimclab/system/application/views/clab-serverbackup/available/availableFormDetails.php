...
<h4><a href="dashboard.php">Local Transfer</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contAvailable/availableFormSubmit" method="POST" name="newLocalTransfer" id="entity_searchby" onsubmit="return v.exec()">
      		...
      		<td colspan="4">
		      	...
		      	<table width="90%" border="0" align="center">
			      	...
			      	<tr>
			      		...
			      		<td colspan="3"><textarea name="address" cols="70" class="disabled" DISABLED><?php echo $ctrData1->ctr_addr1;?> <?php echo $ctrData1->ctr_addr3;?> <?php echo $ctrData1->ctr_addr2;?></textarea></td>
			      	</tr>
			      	<tr>
			      		<td>Telephone No.</td>
		...
		<tr>
      	...
      	<tr>
      		<td colspan="4">
		      	...
		      	<table width="90%" border="0" align="center">
			      	...
			      	<tr>
			      		<td>Current Address</td>
			      		<td colspan="3"><textarea name="address" cols="70" class="disabled" DISABLED><?php echo $ctrData2->ctr_addr1;?> <?php echo $ctrData2->ctr_addr2;?> <?php echo $ctrData2->ctr_addr3;?></textarea></td>
			      	</tr>
			      	<tr>
			      		<td>Telephone No.</td>
      	...
      	<tr>
			<td colspan="4" align="center">
				<input type="hidden" name="selCompFrom" value="<?php echo $compFrom;?>" />
				<input type="hidden" name="selCompTo" value="<?php echo $compTo;?>" />
