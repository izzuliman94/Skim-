...
<body>
<h4><a href="dashboard.php">SPIM</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Update Local Transfer<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New  Tracking Log </h4>

<h3 id="switchsection1-title" class="handcursor">Local Transfer Tracking Log<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
  <form action="<?php echo site_url();?>/contAvailable/newPhoneTrackLogSubmit" method="POST" name="uploadForm" id="uploadForm">
    <strong>Current Local Transfer Ref ID : <?php echo $refid;?><br />
