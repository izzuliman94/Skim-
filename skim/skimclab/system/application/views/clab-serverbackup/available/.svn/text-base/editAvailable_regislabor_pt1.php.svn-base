...
Compnay (TO) : <?php echo $avlabRecord->comp_to;?>
  ...
  <form action="<?php echo site_url();?>/contAvailable/regisNewLabourPt2" method="POST" name="TypicalForm" id="TypicalForm">
  ...
  <?php if(isset($existingLabour)){?>
  	<div class="info" style="width:600px;">Labor exists. Click "Register this labour" to add this worker for local transfer.</div>
  <form method="POST" name="addAvailableForm" action="<?php echo site_url();?>/contAvailable/regisExistingLabour">
