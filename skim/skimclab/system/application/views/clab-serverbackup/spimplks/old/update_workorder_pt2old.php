...
?>
<h4><a href="<?php echo site_url();?>/contSpim/spimDashbrd">SPIM (1St Year Renewal )</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />Update Work Order </h4>
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    	  ...
    	  <td><input type="hidden" name="currentuser" value="<?php echo $this->session->userdata('username');?>" />
              ...
              <input type="text" name="txtreceiveby" id="txtreceiveby" value="<?php echo $woRow->wo_receiveby;?>" readonly="READONLY"/>
          </td>
