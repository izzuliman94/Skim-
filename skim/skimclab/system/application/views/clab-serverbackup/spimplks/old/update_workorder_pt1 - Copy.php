...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contSpim/updateWorkOrderSearch" method="POST" name="updateWorkorderForm" id="updateWorkorderForm">
...
?>
	<table width="100%" border="0">
		...
		?>
		<tr>
			<td><a href="<?php echo site_url();?>/contSpim/updateWorkOrderPt2/<?php echo $ctr->wo_id;?>"><?php if(strlen($ctr->wo_num) > 0) echo $ctr->wo_num; else echo $ctr->wo_id;?></a></td>
