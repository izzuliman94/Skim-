   ...
   <br />
    ...
    <table width="100%" border="0">
    	...
    	<tr>
          ...
          <p><?php echo anchor_popup("contSpim/printPLKS1year/". $woRow->wo_id,"Print PLKS First Year Reminder");?> <span class="style1">New!</span></p></td>
    	  <td><?php echo anchor_popup("contSpim/printVDRApp/". $woRow->wo_id,"Print VDR Application");?><span class="style1">New!</span>
    	  <p><?php echo anchor_popup("contSpim/printWPList/". $woRow->wo_id,"Print Surat Wakil ");?><span class="style1">New!</span></p></td>
  	  </tr>
    	<tr>
    	  <td>&nbsp;</td>
