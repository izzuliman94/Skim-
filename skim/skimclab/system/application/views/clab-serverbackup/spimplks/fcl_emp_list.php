...
function senddata(passno,name,rdate,permitno,passexp,nok,relationship,salary,wt,nat,dob,gender,country){
 ...
 opener.AddNewFCL.txtentrydate.value="";
 ...
 opener.AddNewFCL.txtentrydate.value = rdate;
...
<body>
<form method="post" action="<?php echo site_url();?>/contSpimFirst/empfcl_list/<?php echo $clabno ?>">
<table width="70%">
<tr>
    <td>Passport No</td>
