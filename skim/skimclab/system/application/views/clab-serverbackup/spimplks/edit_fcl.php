...
<script type="text/javascript">
		...
		function FCLdelete(id){
			 ...
			 var uri = "<?php echo site_url();?>/ContSpimFirst/DeleteFCL/" + workorderid + "/" + companyname + "/" + id
...
<form action="<?php echo site_url();?>/contSpimFirst/SaveEditFCL" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
...
<tr>
  <td id="t_txtpassexp3">Entry Date</td>
  <td colspan="3"><input name="txtentrydate" type="text" id="txtentrydate" value="<?php echo date('d-m-Y',strtotime($fcl->fcl_entrydate)) ?>" size="20" maxlength="250"/>
...
<tr>
  <td id="t_txtsalary2">Workorder Type</td>
...
<tr>
    ...
    <input type="hidden" name="txtsalary" value="<?php echo $fcl->fcl_salary;?>" maxlength="30" size="20" />
