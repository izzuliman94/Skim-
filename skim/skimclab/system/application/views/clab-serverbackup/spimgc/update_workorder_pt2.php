    ...
    <br />
      ...
      <table width="100%" border="0">
      	<tr>
      		...
      		<th align="RIGHT" colspan="10"><input type="button" name="btnRegisNewLabour" value="Register New Labour" onclick="registerNewLabor();" <?php if(strpos($accessibility, 'h') == false) echo "DISABLED";  ?><?php echo $close ?>/><!--input type="button" name="btnUploadFCL" value="Upload FCL list" class="smoothbtn1" onclick="openuploadwindow();" /--></th>
      	</tr>
      	<?php if($allFCLFiles->num_rows() == 0){ ?>
      	<tr>
      		<td colspan="15"><font color="red"><strong>No FCL lists has been insert for this workorder.</strong></font></td>
      	</tr>
      	<?php }
      	else{
	    ?>
	    ...
	    <?php $i = 1;
      	 ...
      	 <tr>
			...
			<td align="center">  <input name="chkgc" type="checkbox" disabled="disabled" value="1" <?php if($fcl->fcl_greencard == '1') echo "CHECKED"; ?>/></td>
			<td align="center"><?php echo $fcl->fcl_gcdate;?></td>
            <td align="center">
    ...
    <table width="100%" border="0">
		...
		<tr>
			...
			<td><input type="text" name="dtvercorp" size="12" id="dtvercorp" value="<?php if(strlen($woRow->ver_corp_date) > 0 && $woRow->ver_corp_date != '0000-00-00') echo date('d-m-Y', strtotime($woRow->ver_corp_date));?>" READONLY/>
    			<input id="button14" name="btnDate14" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtvercorp'), this)" <?php echo $strver1 ?>/> </td>
			<td>&nbsp;</td>
			<td>Invoice No:
