...
?>
<h4><a href="dashboard.php">SPIM New Green Card Application</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New Work Order </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contgc/newWOSearchCtr" method="POST" name="frmNewWorkOrder" id="frmNewWorkOrder">
					...
					?>
				  	<tr>
                        ...
                        <?php if(strpos($accessibility, 'n') == true) {?>
                        	...
                        	<a href="<?php echo site_url('');?>/contgc/newWorkOrderPt2new/<?php echo $ctr->ctr_clab_no;?>">New Workorder</a>
                        	<?php   }
							else {
							 ?>
