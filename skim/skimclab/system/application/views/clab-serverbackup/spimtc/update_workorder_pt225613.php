  ...
  <form action="<?php echo site_url();?>/contSpimtc/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
   ...
   <br />
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    		<td rowspan="2">Process by Corporate Services:</td>
    		<td rowspan="2"><input type="checkbox" name="chkisprocess" value="1" onclick="checktrigger(this, txtprocessby, dtprocess);" <?php if($woRow->wo_isprocess == '1') echo "CHECKED DISABLED";?>/>
    		...
    		<td rowspan="2"><input type="text" name="txtprocesscomment" value="<?php echo $woRow->wo_process_comment;?>"/></td>
    	</tr>
    	<tr>
