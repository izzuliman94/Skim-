...
<h4><a href="dashboard.php">Immigration</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="approval_status.php">Approval Status</a> <img src="../images/right_arrow.gif" width="13" height="14" /> Internal</h4>
...
<h3 id="switchsection1-title" class="handcursor">Approval - Internal       <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 


  <form action="" method="get" name="TypicalForm" id="TypicalForm" onSubmit="return OnSubmitForm();">
    <table width="100%" border="0">
      ...
      <tr>
        <th><div align="left">List Of Completed Items </div></th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th>&nbsp;</th>
        <th><div align="left">Date Completed </div></th>
      </tr>
      <tr>
        <td>&lt;Item 1 &gt; </td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="submit" name="Operation" onclick="document.pressed=this.value" value="Approved" />
          <input type="submit" name="Operation" onclick="document.pressed=this.value" value="Rejected" /></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
