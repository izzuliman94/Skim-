...
<script type="text/javascript">
		...
		function FCLdelete(id){
			 ...
			 var uri = "<?php echo site_url();?>/contSpimtc/DeleteFCL/" + workorderid + "/" + companyname + "/" + id
...
<form action="<?php echo site_url();?>/contSPIMtc/SaveEditFCL" method="POST" name="EditFCL" id="EditFCL" onsubmit="return validate();">
...
<tr>
    <td>Workorder ID</td>
    <td colspan="3"><input type="text" name="txtwoid" value="<?php echo $workorderid; ?>" maxlength="250" size="20" readonly/>
      <input name="txtadd1" type="hidden" id="txtadd1" value="<?php echo $lampiran->ctr_addr1;?>" size="20" maxlength="30" />
      <input name="txtadd2" type="hidden" id="txtadd2" value="<?php echo $lampiran->ctr_addr2;?>" size="20" maxlength="30" />
      <input name="txtadd3" type="hidden" id="txtadd3" value="<?php echo $lampiran->ctr_addr3;?>" size="20" maxlength="30" />
      <input name="txtpcode" type="hidden" id="txtadd4" value="<?php echo $lampiran->ctr_pcode;?>" size="20" maxlength="30" />
      <input name="txtstate" type="hidden" id="txtadd5" value="<?php echo $lampiran->ctr_state;?>" size="20" maxlength="30" /></td>
</tr>
<tr>
    <td>PLKS No.</td>
...
<tr>
  <td id="t_txtpassno3">Entry Date</td>
  <td colspan="3"><input type="text" id="txtentrydate" name="txtentrydate"  value="<?php echo date('d-m-Y', strtotime($fcl->fcl_entrydate));?>" maxlength="250" size="20"/>
    <input name="btnedate" type="button" class="scwdatepicker" id="btnedate" onclick="scwShow(document.getElementById('txtentrydate'), this)" /></td>
</tr>
<tr>
  <td id="t_txtpassno2">Permit Expiry Date</td>
  <td colspan="3"><input name="datepermitexp" type="text" id="datepermitexp"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_plksdate)) ?>" size="20" maxlength="250"/>
    <input name="btnpermitexpdate2" type="button" class="scwdatepicker" id="btnpermitexpdate2" onclick="scwShow(document.getElementById('datepermitexp'), this)" /></td>
</tr>
<tr> 	
    <td id="t_txtpassno">Passport No. <!--font color="red">*</font--></td>
 	<td colspan="3"><?php echo $fcl->fcl_passno;?>
 	  <input type="hidden" name="txtpassno" value="<?php echo $fcl->fcl_passno;?>" maxlength="30" size="20" /></td>
</tr>
<tr>
