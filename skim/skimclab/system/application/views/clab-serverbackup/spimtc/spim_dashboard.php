...
<h4><a href="dashboard.php">Spim</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Dashboard </h4>
  ...
  <form action="" method="get" name="typicalform1" id="typicalform1">
    <table width="100%" border="0">
      ...
      <tr>
      	...
      	<td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/overall"><?php echo $overall;?></a></td>
      </tr>
      <tr>
      	<td>Total workorders (received calling visa)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/closed"><?php echo $receiveVisa;?></a></td>
      </tr>
      <tr>
      	<td>Total workorders (open)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/open"><?php echo $open;?></a></td>
      </tr>
      <tr>
      	<td> -- Total received (Corporate Support)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/totalreceived"><?php echo $received;?></a></td>
      </tr>
      <tr>
      	<td> -- Total processed (Corporate Support)</td>
      	<td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/totalprocessed"><?php echo $processed;?></a></td>
      </tr>
      <tr>
        <td> -- Submit to Corporate Services</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/submithr"><?php echo $submithr;?></a></td>
      </tr>
      <tr>
        <td> -- Received by Corporate Services</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/receivehr"><?php echo $receivehr;?></a></td>
      </tr>
	  <tr>
        <td> -- JIM (outstanding)</td>
        <td align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/JIM"><?php echo $jim;?></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td> <14 days </td>
        <td><div align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/lessFourteen"><?php echo $lt14days;?></a></div></td>
        </tr>
      <tr>
        <td>>14 days</td>
        <td><div align="center"><a href="<?php echo site_url();?>/contSpimtc/dashboardList/overFourteen"><?php echo $mt14days;?></a></div></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
...
<h3 id="switchsection2-title" class="handcursor">Work orders pending for Transit Centre<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
...
?>
	<tr>
		<td><?php echo $i++;?>.</td>
		<td><a href="<?php echo site_url();?>/contSpimtc/updateWorkOrderPt2/<?php echo $wo->wo_id;?>"><?php echo $wo->wo_id;?></a></td>
