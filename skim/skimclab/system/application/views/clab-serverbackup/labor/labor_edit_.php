...
<table width="100%" border="0">
		...
		<tr>
			...
			<td><input type="checkbox" name="chkjtk" value="1" <?php if($labor->wkr_jtk == '1') echo "CHECKED"; ?>/> Rerefence No. </td>
			<td><input type="text" name="txtrefjtk" width="200" value="<?php echo $labor->wkr_jtk_ref ?>"/></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
