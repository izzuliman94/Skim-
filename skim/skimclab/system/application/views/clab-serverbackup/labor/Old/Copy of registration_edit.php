...
<h4><a href="dashboard.php">Labor</a> <img src="../images/right_arrow.gif" width="13" height="14" /> Labor Registration Update </h4>
  ...
  <form action="../labor/registration_edit_success.php" method="get" name="TypicalForm" id="TypicalForm">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td>First Arrived </td>
        <td><div align="center">:</div></td>
        <td><input type="text" name="dtFirstArrived" /> <img src="../images/cal.gif" id="dtFirstArrived_trigger" style="cursor: pointer;" title="Date selector" onmouseover="this.style.background='red';" onmouseout="this.style.background=''" /></td>
      </tr>
      <tr>
        <td>Address</td>
        <td><div align="center">:</div></td>
