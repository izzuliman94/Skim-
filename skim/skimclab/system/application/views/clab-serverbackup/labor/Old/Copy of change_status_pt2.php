      	...
      	<td colspan="3">
      	 <table id="area1">
      	  	<tr>
	      		...
	      		<td colspan="2">
	      			<input type="text" name="dtincident" id="dtincident" READONLY/>
