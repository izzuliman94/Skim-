...
<body>
<h4><a href="dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />Upload Photo</h4>

<h3 id="switchsection1-title" class="handcursor">Upload Photo<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 

  <form method="POST" action="<?php echo site_url();?>/contLabour/uploadPhoto" name="uploadForm" id="uploadForm" enctype="multipart/form-data">
  ...
  <?php
  	if(isset($file_name)) {
	  	...
	  	echo "<ul><li>Destination Filename: " . $file_name . "</li>";
  	}
  	if(isset($orig_name)) echo "<li>Original Filename: " . $orig_name . "</li>";
  	if(isset($file_size)) echo "<li>File Size: " . $file_size . "KB</li>";
  	if(isset($filepath)) echo "<li>File Path on Server: " . $filepath . "</li></ul>";
  ?>
</div>
<p>
