...
<!--new calendar-->
 ...
 <script type="text/javascript">
	...
	function attachDoc(){
		var wkrid = document.editLaborForm.wkr_id.value;
		window.open('<?php echo site_url();?>/contrekablabour/attachDoc/' + wkrid);
	}
	
	function printLetterMain(){
	var wkrid = document.editLaborForm.wkr_id.value;
	var clabid = document.editLaborForm.clab_id.value;
	window.open('<?php echo site_url();?>/contrekablabour/printLetterMain/' + wkrid + '/' + clabid);
}
...
<h4><a href="dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Registration for Recalibration</h4>

<h3 id="switchsection1-title" class="handcursor">Recalibration Labour Details<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
<strong><font color="red"><?php if(isset($successMsg)) echo $successMsg;?></font> </strong>
<form method="POST" action="<?php echo site_url();?>/contrekabLabour/updateLabourDetailsSubmit" name="editLaborForm" id="editLaborForm" onsubmit="return v.exec()">
<table width="100%" border="0">
 		<tr>
 			<th colspan="13" align="RIGHT">
 				...
 				<input type="button" name="btnRefresh" value=" Refresh " onclick="location.href='<?php echo site_url();?>/contrekabLabour/labourDetails/<?php echo $labor->wkr_id;?>'"/>
 				<input type="button" name="btnBack" value=" Back " onclick="location.href='<?php echo site_url();?>/contLabour/listLabour'"/> 			</th>
 		</tr>
 		<tr>
 			<td rowspan="9" width="15%" valign="bottom">
 				<?php echo $photoInfo;?> 			</td>
 			<td width="16%" colspan="2" rowspan="2" id="t_txtpassno">Passport No</td>
 			<td width="25%" colspan="13" rowspan="2"><input type="text" name="txtpassno" id="txtpassno" maxlength="" value="<?php echo $labor->wkr_passno;?>" READONLY/>
 		...
 		<tr>
 		  <td id="t_txtname2">Sector</td>
 		  <td id="t_txtname2"><input type="text" name="txtsector" id="txtsector" maxlength="" value="<?php echo $labor->sec_description;?>" readonly="readonly"/></td>
 		  <td>Officer Incharge</td>
 		  <td colspan="13"><input name="officerinc" type="text" value="<?php echo $labor->officerincharge;?>" /></td>
 		  
 		   
 		  
      </tr>
 		<tr>
 		  <td id="t_txtname2">Worker Type</td>
 		  <td id="t_txtname2"><input type="text" name="txtpassno3" id="txtpassno3" maxlength="" value="<?php echo $labor->type_description;?>" readonly="readonly"/></td>
 		  <td>Telephone</td>
 		  <td colspan="13"><input name="jimtel" type="text" value="<?php echo $labor->jimtel;?>" /></td>
 		  
	  </tr>
 		<tr>
 		  <td id="t_txtname3">Confirm Worker</td>
 		  <td id="t_txtname3"><input type="checkbox" name="confirm" value="1" <?php if($labor->confirm == '1') echo "CHECKED";?>/>
	      </td>
 		  <td>Registered Imigration Office</td>
 		  <td colspan="13"><input name="jimreg" type="text" value="<?php echo $labor->regjim;?>" /></td>
      </tr>
 		<tr>
 			<td colspan="2" id="t_txtname">Name <font color="red">*</font></td>
 		...
 		<tr>
 			<td colspan="2">Old Passport No.</td>
 			<td colspan="13"><input type="text" name="txtoldpassno" maxlength="100" value="<?php echo $labor->wkr_oldpassno;?>" READONLY/></td>
 			
 			
 		</tr>
 		<tr>
 			<td colspan="2">Bank Draft No: </td>
 		...
 		<tr>
 			<td>Salary</td>
 			<td colspan="2"><input type="text" name="txtsalary" value="<?php echo $labor->wkr_salary?>"/> </td>
 			<td colspan="13">&nbsp;</td>
		  
 		</tr>
 		<tr>
 			<td rowspan="2">Place Of Birth</td>
 			<td rowspan="2" colspan="4"><textarea name="txthomeaddr" cols="50" rows="2"><?php echo $labor->wkr_homeaddr;?></textarea></td>
 			<td>Zipcode</td>
		...
		<tr>
 		...
 		<tr>
 			<td colspan="13" align="LEFT"><u>Skill & Employment Details</u></td>
 		</tr>
 		<tr>
 			<td id="t_txtworktrade">Work Trade<font color="red">*</font></td>
 			<td colspan="13"><SELECT name="selworktrade" id="selworktrade" onchange='javascript:addtotrade();'>
 		...
 		<tr>
 			...
 			<td colspan="12"><input type="text" name="txtInitEmp" value="<?php echo $labor->wkr_initemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td>Last Employer</td>
 			<td colspan="12"><input type="text" name="txtLastEmp" value="<?php echo $labor->wkr_lastemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td colspan="13">&nbsp;</td>
 		</tr>
 		<tr>
 			<td colspan="13" align="LEFT"><u>Employer History</u></td>
 		</tr>
 		<tr>
 			<td colspan="13">
 				<table width="100%" border="0">
 		...
 		<tr>
 			<td colspan="13" align="Right">
 				<input type="hidden" name="clab_id" value="<?php echo $labor->wkr_currentemp;?>" />
 				...
 				<input type="button" name="btnPrintletter2" value="Print Letter" onclick="printLetterMain();"/>
 				<input type="button" name="btnPrintDoc" value="Print Doc" onclick="printPage();"/>
 				<input type="button" name="btnAttachContract" value="Attach Contract" onclick="attachContract();"/>
 				<input type="button" name="btnAttachDoc" value="Attach Doc" onclick="attachDoc();"/>
 				<input type="submit" name="btnSave" value=" Update " <?php if(strpos($accessibility, 'r') == false) echo "DISABLED";  ?>/>
