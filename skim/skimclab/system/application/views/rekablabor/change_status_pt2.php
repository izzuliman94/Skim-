  ...
  <table width="100%" border="0">  
      ...
      <tr>
        ...
        <td colspan="2"><select name="selActiveStatus" DISABLED>
          ...
          <option value="21">Rehiring</option>
        </select>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="4" align="CENTER">
        	...
        	<input type="submit" name="btnChangeStatus" value=" Update " <?php if(strpos($accessibility, 'q') == false) echo "DISABLED";  ?> onclick="return confirm('Are you sure you want to update the status?');"/>
