...
<table width="100%" border="0">
  ...
  <tr>
    <td width="40%"><div align="center"><a href="search_pt1.php">Edit More Labour </a></div></td>
    <td width="20%"><div align="center"></div></td>
    <td width="40%"><div align="center"><a href="dashboard.php">Return to Labour Dashboard </a><a href="../main.php"></a></div></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
