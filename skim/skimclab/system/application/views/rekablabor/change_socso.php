...
<h4><a href="dashboard.php">Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /><a href="registration_pt1.php"> Registration</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> SOCSO Status </h4>
...
<h3 id="switchsection1-title" class="handcursor">SOCSO Status    <img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url('contLabour/updatesocsoStatus');?>" method="POST" name="changeStatusForm" id="changeStatusForm">
  ...
  <table width="100%" border="0">  
      <tr>
        <th colspan="4"><div align="left">SOCSO</div></th>
      </tr>
      
      <tr>
        <td width="29%" ALIGN="LEFT"><label>
          <input type="checkbox" name="chksocso2" value="1" <?php if($labor->wkr_socsoregstatus == '1') echo "CHECKED"; ?>/>
        </label>
        SOCSO Registration </td>
      	<td width="71%" colspan="1" align="LEFT"><input type="checkbox" name="chksocso" value="1" <?php if($labor->wkr_socsostatus == '1') echo "CHECKED"; ?>/>
      	  SOCSO Payment( Latest Month) : 
   	    
   	    
   	    <input type="text" name="datesocso" id="datesocso" maxlength="" value="<?php if($labor->wkr_socsostatusmonth != '0000-00-00') echo date('d-m-Y', strtotime($labor->wkr_socsostatusmonth));?>" readonly="readonly"/>
        <input id="button1" name="btnDate1" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('datesocso'), this)" /></td>
      </tr>
      <!--tr>
      	<td><label>
