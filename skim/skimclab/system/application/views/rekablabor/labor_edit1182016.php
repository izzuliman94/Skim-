...
<table width="100%" border="0">
 		...
 		<tr>
 			<td rowspan="5" width="9%" valign="bottom">
 				<?php echo $photoInfo;?> 			</td>
 			<td width="15%" height="48" id="t_txtpassno">Passport No</td>
<td width="26%"><input type="text" name="txtpassno" id="txtpassno" maxlength="" value="<?php echo $labor->wkr_passno;?>" READONLY/>
 			...
 			<td width="14%" bgcolor="#006600"><span class="style13">CIDB Green Card </span></td>
		    <td width="6%"><input type="checkbox" name="chkgc" value="1" <?php if($labor->wkr_greencard == '1') echo "CHECKED"; ?>/></td>
          <td width="16%"><!--input type="text" name="txtgreen" maxlength="30" value="<?php echo $labor->wkr_green;?>"/></td--> 		          
            <span class="style12"><strong>Expiry Date</strong></span>
	      <td width="14%"><span class="style12">
        <input type="text" name="dategc" id="dategc" maxlength="5" value="<?php echo date('d-m-Y', strtotime($labor->wkr_gcdate));?>"/>
	      <input id="button2" name="button" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dategc'), this)" />
      </span> 		</tr>
 		<tr>
 			...
 			<td colspan="2">Movement Status</td>
 			<td colspan="2"><font color="#990000"><?php echo $labor->avlab_desc;?></font> 
 				&nbsp;<input type="button" name="btnView1" value="View Status History"  class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contLabour/viewStatusHistory/<?php echo $labor->wkr_id;?>', 'Passport Exp History', 'height=350, width=500, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/> 			</td>
 		</tr>
 		<tr>
 			<td>Old Passport No.</td>
 			<td><input type="text" name="txtoldpassno" maxlength="100" value="<?php echo $labor->wkr_oldpassno;?>" READONLY/></td>
 			<td colspan="2"><!--Amnesty Ref. No--></td>
 			<td colspan="2"><input type="hidden" name="txtamnestyref" maxlength="30" value="" /></td>
 		</tr>
 		<tr>
 			<td>Bank Draft No: </td>
 			<td><input type="text" name="txtorgReceipt" value="<?php echo $labor->wkr_orgreceipt;?>" maxlength="100" /></td>
 			<td colspan="2">Person in Charge: <font color="red">*</font></td>
 			<td colspan="2">
 				<SELECT name="selEmp">
 		...
 		<tr>
		    <td>Next Of Kin</td>
			<td><input type="text" name="txtnok" value="<?php echo $labor->wkr_next_of_kin; ?>" size="35"/></td>
			<td colspan="2">Relationship</td>
			<td colspan="2"><input type="text" name="txtrelationship"  value="<?php echo $labor->wkr_relationship; ?>"/></td>
		</tr>
 		<tr>
 			...
 			<td colspan="2" id="t_selgender">Gender <font color="red">*</font></td>
 			<td colspan="2">
 		...
 		<tr>
			...
			<td colspan="2"><input type="text" value="<?php echo $labor->nat_desc ?>" name="selnationalitydesc" /><input type="hidden" value="<?php echo $labor->wkr_nationality ?>" name="selnationality" /></td>
 		</tr>
 		<tr>
 			<td>Salary</td>
			...
			<td colspan="2"><input type="checkbox" name="chkjtk" value="1" <?php if($labor->wkr_jtk == '1') echo "CHECKED"; ?>/>
Rerefence No. 
  <input type="text" name="txtrefjtk" width="200" value="<?php echo $labor->wkr_jtk_ref ?>"/></td>
 		...
 		<tr>
 			...
 			<td colspan="2"><input type="text" name="txtzipcode" maxlength="10" value="<?php echo $labor->wkr_zipcode;?>" /></td>
 		</tr>
 		<tr>
 			<td colspan="2">&nbsp;</td>
 			<td colspan="2">&nbsp;</td>
 		...
 		<tr>
 			...
 			<td colspan="2" id="t_txtpcode">Postcode</td>
 			<td colspan="2"><input type="text" name="txtpcode" maxlength="5" value="<?php echo $labor->wkr_pcode;?>"/></td>
 		</tr>
 		<tr>
 	    ...
 	    <tr>
 			...
 			<td colspan="2">No. of year in M'sia</td>
 			<td colspan="2"><input type="text" name="txtyearsinmy" size="5" READONLY/></td>
 		</tr>
 		<tr>
 			...
 			<td colspan="2">Passport Issue </td>
 			<td colspan="2"><input type="text" name="txtpassissue" value="<?php echo $labor->wkr_passissue ?>"/></td>
 		</tr>
 		<tr>
 			...
 			<td colspan="2">Current PLKS No.</td>
 			<td colspan="2"><input type="text" name="txtplksno" value="<?php echo $labor->wkr_plksno;?>" READONLY/></td>	
 		</tr>
		<tr>
		    <td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
 		...
 		<tr>
 			<td colspan="7" align="LEFT"><u>Skill & Employment Details</u></td>
 		</tr>
 		<tr>
 			<td id="t_txtworktrade">Work Trade<font color="red">*</font></td>
 			<td colspan="6"><SELECT name="selworktrade" id="selworktrade" onchange='javascript:addtotrade();'>
 		...
 		<tr>
 			...
 			<td colspan="6"><input type="text" name="txtInitEmp" value="<?php echo $labor->wkr_initemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td>Last Employer</td>
 			<td colspan="6"><input type="text" name="txtLastEmp" value="<?php echo $labor->wkr_lastemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td colspan="7">&nbsp;</td>
 		</tr>
 		<tr>
 			<td colspan="7" align="LEFT"><u>Employer History</u></td>
 		</tr>
 		<tr>
 			<td colspan="7">
 				<table width="100%" border="0">
