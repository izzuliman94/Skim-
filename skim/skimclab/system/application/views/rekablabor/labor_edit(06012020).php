...
<table width="100%" border="0">
 		...
 		<tr>
 			...
 			<td width="25%"><input type="text" name="txtpassno" id="txtpassno" maxlength="" value="<?php echo $labor->wkr_passno;?>" READONLY/>
		    ...
		    <td colspan="2" bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12">
  ...
  <input type="text" name="txtrefjtk" width="200" value="<?php echo $labor->wkr_jtk_ref ?>"/></td>
		...
		<tr>
 		...
 		<tr>
 			...
 			<td colspan="5"><SELECT name="selworktrade" id="selworktrade" onchange='javascript:addtotrade();'>
