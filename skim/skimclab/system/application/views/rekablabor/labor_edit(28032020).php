...
<table width="100%" border="0">
 		...
 		<tr>
			...
			<!--th>SKK Status</th-->
			<td bordercolor="#00CC00" bgcolor="#FF0000"><span class="style12">
		      <input type="button" name="btnView3" value="SKK Status"  class="style11" onclick="window.open('<?php echo site_url();?>/contLabour/changeSKKStatus/<?php echo $labor->wkr_id;?>', 'SKK Status History', 'height=500, width=600, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
		      <font color="#009900">
		      &nbsp;<?php if($labor->wkr_skkstatus != 0) echo 'Available !';?>
	        </font>		    </span></td>
      </tr>
 		<tr>
 			...
 			<td colspan="2"><input type="button" name="btnView1" value="View Status History"  class="smoothbtn1" onclick="window.open('<?php echo site_url();?>/contLabour/viewStatusHistory/<?php echo $labor->wkr_id;?>', 'Passport Exp History', 'height=350, width=500, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')"/>
 		...
 		<tr>
 			...
 			<td>SOCSO ID</td>
 			<td colspan="2"><input type="text" name="txtsocsoid" width="12" maxlength="12" value="<?php echo $labor->wkr_socso_id ?>"/></td>
 		</tr>
 		<tr>
 			<td>Bank Draft No: </td>
...
Rerefence No. 
  <input type="text" name="txtrefjtk" width="200" value="<?php echo $labor->wkr_jtk_ref ?>"/></td>
		...
		<tr>
 		...
 		<tr>
 			<td colspan="8" align="LEFT"><u>Skill & Employment Details</u></td>
 		</tr>
 		<tr>
            ...
            <input id="button2" name="button" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtskk'), this)" /></td>
 			<td>SCC Ref No</td>
 			<td colspan="2"><input type="text" name="txtskkref" maxlength="22" value="<?php echo $labor->wkr_skkref;?>" /></td>
		</tr>
 		<tr>
 		...
 		<tr>
 			...
 			<td colspan="7"><input type="text" name="txtInitEmp" value="<?php echo $labor->wkr_initemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td>Last Employer</td>
 			<td colspan="7"><input type="text" name="txtLastEmp" value="<?php echo $labor->wkr_lastemp;?>" size="60"/></td>
 		</tr>
 		<tr>
 			<td colspan="8">&nbsp;</td>
 		</tr>
 		<tr>
 			<td colspan="8" align="LEFT"><u>Employer History</u></td>
 		</tr>
 		<tr>
 			<td colspan="8">
 				<table width="100%" border="0">
