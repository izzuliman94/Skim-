...
<body>
<h4><a href="<?php echo site_url();?>/contrekabLabour/labourDashbrd">Rekab Labour</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Registration </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contrekabLabour/newLabourDetails" method="POST" name="TypicalForm" id="TypicalForm">
  ...
  <table width="100%" border="0">
  	...
  	<tr>
  		<td><a href="<?php echo site_url();?>/contrekabLabour/labourDetails/<?php echo $existingLabour->wkr_passno;?>"><?php echo $existingLabour->wkr_passno;?></a></td>
