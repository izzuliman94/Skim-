...
<table width="100%" border="1" cellpadding="0" cellspacing="0" align="CENTER">
	<tr>
		...
		<th>Trans Status</th>
		<th>Years In M'sia</th>
	</tr>
	<?php if($wkrData->num_rows() == 0){
	?>
	<tr>
		<td colspan="8" class="print">There is no data to display. Please refine your search.</td>
	</tr>
	<?php }
	else{
		$i = 1;
	...
	?>
	<tr>
		<td class="print" width="3%"><?php echo $i++;?>.</td>
		<td class="print" width="10%" align="CENTER"><?php echo $wkr->wkr_passno;?></td>
		<td class="print" width="23%"><?php echo $wkr->wkr_name;?></td>
		...
		<td class="print" width="7%" align="CENTER"><?php if(strlen($wkr->wkr_entrydate) == 0 || $wkr->wkr_entrydate == '0000-00-00') echo "-can't be determined-"; else echo getYears($wkr->wkr_entrydate) + 1; ?></td>
	</tr>
	<?php }
	}
	?>
