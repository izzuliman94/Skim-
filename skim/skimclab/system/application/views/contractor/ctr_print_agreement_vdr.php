...
<title>SKIM - Agreement Letter (VDR)</title>
<style type="text/css">
th {
...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td colspan="2" rowspan="1"><br /><br /><br />Ref: CLAB/CORR/CONST/OP/<?php echo date('y');?>/<?php echo substr($ctr->ctr_clab_no, -6);?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<tr>
      <td colspan="4"><h3><u>Perjanjian Pembekalan Pekerja Binaan Asing </u></h3></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">We attach herewith a copy of the "Perjanjian Pembekalan Pekerja Binaan Asing" which has been duly stamped for your safe keeping.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="4">ROHAIDAH SAPUAN<br />
    ...
    <tr>
		<td colspan="4"><p><strong>Acknowledgement Receipt</strong></p>
		<p>I acknowledge receiving the document above.</p>      
        Name:<br />
