...
{
	if(x==1) {document.getElementById("amount").value="20.00";} 
	if(x==2) {document.getElementById("amount").value="40.00";}
	if(x==3) {document.getElementById("amount").value="50.00";}  
	if(x==4) {document.getElementById("amount").value="70.00";} 
	if(x==5) {document.getElementById("amount").value="90.00";}
	if(x==6) {document.getElementById("amount").value="100.00";} 
	if(x==7) {document.getElementById("amount").value="120.00";} 
	if(x==8) {document.getElementById("amount").value="140.00";}
	if(x==9) {document.getElementById("amount").value="150.00";} 
	if(x==10) {document.getElementById("amount").value="170.00";} 
	if(x==11) {document.getElementById("amount").value="190.00";}
	if(x==12) {document.getElementById("amount").value="200.00";} 
}
  </script>
  <style type="text/css">
<!--
