    ...
    <table width="100%" border="0">
      ...
      <tr>
	   ...
	   <tr>
        ...
        <td width="11%"><div align="center"><?php echo anchor_popup("contContractor/listByExpiryAndCompany3/wkr_permitexp/0.5", $plks2wks);?></div></td>
        ...
        <td width="12%">&nbsp;</td>
        <td width="8%"><div align="center"><?php echo anchor_popup("contContractor/listByExpiryAndCompanyOld/wkr_permitexp/-1", $plksexp1mth);?></div></td>
        <td width="7%"><div align="center"><?php echo anchor_popup("contContractor/listByExpiryAndCompanyOld/wkr_permitexp/-2", $plksexp2mth);?></div></td>
        <td width="7%"><div align="center"><?php echo anchor_popup("contContractor/listByExpiryAndCompanyOld/wkr_permitexp/-3", $plksexp3mth);?></div></td>
      </tr>
      <tr>
