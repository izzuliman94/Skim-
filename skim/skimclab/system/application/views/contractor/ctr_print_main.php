...
<table width="50%" border="1" align="CENTER">
  <tr>
	...
	<table width="100%" border="0">
		...
		<tr>
			<td align="CENTER">
				<font color="red">**</font><?php echo anchor_popup('contContractor/printRegisRenewal2/' . $clabno, "Print Registration Renewal Letter + Renewal Form (RN01)");?>			</td>
		</tr>
		...
		<tr>
			<td align="CENTER"><?php echo anchor_popup('contContractor/printcard/' . $clabno, "Surat I-KAD Jabatan Imigresen Malaysia ");?></td>
		</tr>
		<tr>
		  <td align="CENTER"><?php echo anchor_popup('contContractor/printsalary/' . $clabno, "Surat Laporan Gaji & Lokasi ");?></td>
	    </tr>
		<tr>
		  <td align="CENTER"><?php echo anchor_popup('contContractor/printArrivalWorkers/' . $clabno, "Surat Serahan Ketibaan Pekerja ");?></td>
	    </tr>
		<tr>
			<td align="CENTER"><?php echo anchor_popup('contContractor/printCancelPermit/' . $clabno, "Surat Pembatalan Permit ");?></td>
		</tr>
		<tr>
			<td align="CENTER"><?php echo anchor_popup('contContractor/printPeringatanLaporan/' . $clabno, "Peringatan Laporan ");?></td>
		</tr>
		<tr>
			<td align="CENTER"><?php echo anchor_popup('contContractor/printPeringatanTerakhir/' . $clabno, "Peringatan Terakhir ");?></td>
		</tr>
		</tr>
		<tr>
