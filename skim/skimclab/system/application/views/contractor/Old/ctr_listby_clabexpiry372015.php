...
<table width="100%" border="0">
	...
	<tr>
		...
		<td><?php if($titleType == "CLAB"){?>
		     <input type="button" name="btnPrintRenewal" value="Print Renewal" onclick="window.open('<?php echo site_url();?>/contContractor/printRegisRenewal/<?php echo $ctr->ctr_clab_no . "/" . $noOfMonths?>');"/>
		     <?php }
		     ?>
		</td>
	</tr>
