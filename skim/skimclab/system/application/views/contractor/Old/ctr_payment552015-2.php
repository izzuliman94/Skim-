...
<!--end of calendar-->
  <script type="text/javascript">
	 ...
	 if(document.paymentForm.periodreg[0].checked)	document.paymentForm.amount.value="21.20";
	 else if(document.paymentForm.periodreg[1].checked)	document.paymentForm.amount.value="42.40";
	 else if(document.paymentForm.periodreg[2].checked)	document.paymentForm.amount.value="53.00";
...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contcontractor/paymentSubmit" method="POST" name="paymentForm" id="paymentForm">
    ...
    <table width="500" border="0">
	    ...
	    ?>
	    <tr>
	    	<td colspan="5"><font color="red">There is no payment history.</font></td>
	    </tr>
	    <?php }
	    else{
		...
		<tr>
		    ...
		    <td><?php echo $pay->pay_cert_date;?></td>
		</tr>
		<?php }
		}
		?>
