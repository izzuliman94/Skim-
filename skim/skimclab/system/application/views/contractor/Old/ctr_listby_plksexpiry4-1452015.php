  ...
  <td class="print" align="center">
	<table width="70%" border="0">
		...
		<tr>
			...
			<td><a href="<?php if(strlen($ctr->wkr_currentemp) == 0) echo ""; else echo site_url() . "/contContractor/viewExpiryLetter4/$fieldName/$noOfMonths/$ctr->wkr_currentemp";?>" target="_blank"><u>View</u></a> | <a href="<?php if(strlen($ctr->wkr_currentemp) == 0) echo ""; else echo site_url() . "/contContractor/printExpiryLetter4/$fieldName/$noOfMonths/$ctr->wkr_currentemp";?>" target="_blank"><u>Print Letter</u></a></td>
		</tr>
		<?php
				}	
			}
