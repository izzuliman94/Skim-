...
<script type="text/javascript">
	...
	function fillDefaultPayment(){
	 if(document.newCtrForm.periodreg[0].checked)	document.newCtrForm.amount.value="20.00";
	 else if(document.newCtrForm.periodreg[1].checked)	document.newCtrForm.amount.value="40.00";
	 else if(document.newCtrForm.periodreg[2].checked)	document.newCtrForm.amount.value="50.00";
  ...
  <form action="<?php echo site_url();?>/contContractor/registrationFormSubmit" method="POST" name="newCtrForm" id="newCtrForm" onsubmit="return v.exec()">
    <table width="100%" border="0">
      <tr>
        ...
        <td width="17%"><SELECT name="comp_reg_status" DISABLED>
        					<option value="1">ACTIVE</option>
        					<option value="2">IN-ACTIVE</option>
        					<option value="3">SUSPENDED</option>
        				</SELECT>        </td>
        <td width="8%">Reg. Type</td>
        <td width="8%" id="t_comptype"><select name="comp_reg_type">
          <option value="1" selected="selected">NORMAL</option>
          <option value="2">REKALIBRASI</option>
        </select></td>
      </tr>
	  <tr>
        <td id="t_companyname">Company Name</td>
        <td colspan="5"><input type="text" name="companyname" size="80" maxlength="250"/><font color="red">*</font></td>
      </tr>
      <tr>
        <td>Company Reg. No.</td>
        <td colspan="2"><input type="text" name="companyregno" maxlength="20" value="<?php echo $companyno;?>"/>
        <font color="red">*</font></td>
        <td>GST No</td>
        <td colspan="2"><input type="text" name="companygstno" maxlength="13"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
        <td>SOCSO ID</td>
        <td colspan="2"><input type="text" name="companysocsono" maxlength="13"/></td>
      </tr>
	  <tr>
      ...
      <tr>
        <td>Address 2</td>
        <td colspan="5">
        	<input type="TEXT" name="address2" size="80" maxlength="100" />        </td>
      </tr>
      <tr>
        <td>Address 3</td>
        <td colspan="5">
        	<input type="TEXT" name="address3" size="80" maxlength="100" />        </td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="telephone1" maxlength="20" /> <font color="red">*</font> <input type="text" name="telephone2" maxlength="20"/> </td>
      	<td>Fax No</td>
      	<td colspan="3"><input type="text" name="fax" maxlength="20" /> </td>
        </tr>
		<tr>
		    <td>Agent</td>
			<td colspan="5"><input type="text" name="txtagname" size="80" readonly/>
			<input type="hidden" name="txtagid" readonly/>
			<input type="button" name="btnagn" onclick="getagent('N')" value="..."/>			</td>			
		</tr>
		<tr>
		    <td>Address 1</td>
			<td colspan="5"><input type="text" name="txtagadd1" size="80" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 2</td>
			<td colspan="5"><input type="text" name="txtagadd2" size="80" readonly/></td>			
		</tr>
		<tr>
		    <td>Address 3</td>
			<td colspan="5"><input type="text" name="txtagadd3" size="80" readonly/></td>			
		</tr>
	  <tr>
        <td id="t_cidbreg">CIDB Reg. No</td>
        <td><input type="text" name="cidbreg" /> <font color="red">*</font></td>
        <td id="t_cidbexpire">CIDB Exp. Date</td>
      	<td colspan="3"><input type="text" name="cidbexpire" id="cidbexpire" maxlength="20" READONLY/>
			<input id="button1" name="btnDate1" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('cidbexpire'), this)" /> <font color="red">*</font>      	</td>
      </tr>
      <tr>
      	<td>Email Address</td>
      	<td colspan="5"><input type="text" name="email" size="50" maxlength="50" /></td>
      </tr>
	  <tr>
        <td>Grade</td>
      ...
      <tr>
        ...
        <td colspan="5"><select name="category" id="selcategory" onchange='javascript:addtocategory();'>
                        ...
                        <input type="text" name="txtcategory" id="txtcategory" size="30" value="" READONLY/><input type="button" name="clear" value="Clear" class="smoothbtn1" onclick='javacript:clearcategory();'/>        </td>
      </tr>
      <tr>
        ...
        <td colspan="5"><select name="specialization" id="selspec" onchange='javascript:addtospec();'>
                        ...
                        <input type="text" name="txtspec" id="txtspec" size="30" value="" READONLY/><input type="button" name="clear2" class="smoothbtn1" value="Clear" onclick='javascript:clearspec();'/>        </td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="5">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>
      		...
      		<input type="radio" name="periodreg" value="3" onclick="fillDefaultPayment();"/>3 years      	</td>
      	<td>Amount (RM)</td>
      	<td><input type="text" name="amount" size="20" READONLY/></td>
      	<td colspan="2" ><font color="red">* Rekalibrasi Programme Free 1 Year</font></td>
   	  </tr>
      <tr>
      	<td>Payment Mode</td>
      	...
      	<td>Cheque No</td>
      	<td colspan="3"><input type="text" name="chequeno" size="20" /></td>
      </tr>
      <tr>
      	<td>Payment Date</td>
      	<td colspan="5">
      		<input type="text" name="paymentdate" id="paymentdate" READONLY/>
      		<input id="button2" name="btnDate2" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('paymentdate'), this)" />      	</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="5">&nbsp;</td>
      ...
      <tr>
      	<td>Attachments</td>
      	<td colspan="5"><input type="checkbox" name="form24" value="1" />Form24
...
<input type="checkbox" name="cidb_certcopy" value="1" />Copy of CIDB Certificate 
      	                <input type="checkbox" name="iccopy" value="1" />IC Copy      	</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td colspan="5"><input type="checkbox" name="others" value="1" />Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" /> &nbsp; &nbsp; &nbsp; <input type="button" name="btnAttach" value="Attach Doc"  onclick="attachdoc();" DISABLED/>      	</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      	<td colspan="5">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="3"><input type="text" name="directorMobile" id="directorMobile" size="35" maxlength="50"  onchange="javascript:addkod(1,this.value);" /></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="3"><input type="text" name="contactMobile" id="contactMobile" size="35" maxlength="50"  onchange='javascript:addkod(2,this.value);' /></td>
      </tr>
      <tr>
      	<td>Designation</td>
      	<td colspan="5"><input type="text" name="contactDesig" size="80" maxlength="250" /></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
        <td colspan="5">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Entered date</td>
      	<td colspan="3"><input type="text" name="entereddate" id="entereddate" value="<?php echo date('d-m-Y');?>" READONLY />
      ...
      <tr>
        <td colspan="6" align="center"><input type="submit" name="btnRegister" value="Register" onclick="return confirm('Are you sure you want to register this contractor?');"/>
...
<!--JAVASCRIPT FOR FORM VALIDATION-->
	...
	var a_fields = {
		...
		'comp_reg_type':{'l':'Registration Rype','r':true,'t':'t_comptype'}
