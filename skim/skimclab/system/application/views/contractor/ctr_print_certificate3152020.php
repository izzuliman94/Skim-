...
<div style="position:absolute;top:<?php echo (string)($y + 350)."px"; ?>;left:<?php echo (string)($x)."px"; ?>">
	<table width="790px" border="0">
		<tr>
...
<div style="position:absolute;top:<?php echo (string)($y + 970)."px"; ?>;left:<?php echo (string)($x)."px"; ?>">
	<table width="790px" border="0">
		<tr>
...
<div style="position:absolute;top:<?php echo (string)($y + 990)."px"; ?>;left:<?php echo (string)($x)."px"; ?>">
	<table width="790px" border="0">
		<tr>
