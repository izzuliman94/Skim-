  ...
  <tbody>
    ...
    <tr>
      <td colspan="2" rowspan="1">
        <br /></br /><br />
      	Ref: CLAB/CORR/CONST/OP/<?php echo date('y');?>/<?php echo substr($ctr->ctr_clab_no, -6);?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
	...
	<tr>
      <td colspan="4"><strong><u>AGREEMENT FOR TEMPORARY PLACEMENT OF FOREIGN CONSTRUCTION LABOUR </u></strong></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">We attach herewith a copy of the "Agreement For Temporary Placement Of Foreign Construction Labour" which has been duly stamped for your safe keeping.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
      <td colspan="4"><p align="justify">Kindly take note and update your record accordingly.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="4">MAI NURUN SUHAILA SHAMSOO ANWAR  <br />
					  Legal Executive 
	  </td>
    </tr>
       <tr>
