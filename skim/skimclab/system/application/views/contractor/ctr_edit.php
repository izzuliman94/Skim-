...
function printCert(){
	...
	function printCert2(){
	var clabno = document.editCtrForm.clabno.value;
	window.open('<?php echo site_url();?>/contContractor/printCert2/' + clabno);
}
...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
        <th colspan="6" align="RIGHT">
        	...
        	<input type="button" name="btnCert2" value="Print Cert" onclick="printCert2()"/>
      ...
      <tr>
      	<td colspan="6" align="RIGHT"><?php echo anchor_popup("contContractor/viewListOfLabours/" . $ctr->ctr_clab_no, "View List of Labours");?>      	</td>
      </tr>
      <tr>
        <td width="11%">CLAB No</td>
        <td width="38%"><input type="text" name="clabno" value="<?php echo $ctr->ctr_clab_no;?>" READONLY /></td>
        ...
        <td width="5%">Reg. Type</td>
        <td width="26%"><input name="comp_reg_type" type="text" value="<?php if($ctr->ctr_reg_type == '2') echo "Rekalibrasi";else echo "Normal";?>" maxlength="13" readonly="readonly"/></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      	<td>&nbsp;</td>
      	<td>Reg. Status</td>
      	<td colspan="3"><font color="#990000"><?php echo $ctr->appstatus_desc;?></font></td>
      </tr>
	  <tr>
        <td id="t_companyname">Company Name</td>
        <td colspan="5"><input type="text" name="companyname" size="100" maxlength="250" value="<?php echo $ctr->ctr_comp_name;?>"/><font color="red">*</font></td>
      </tr>
      <tr>
        ...
        <td>GST No</td>
        <td colspan="3"><input name="companygstno" type="text" value="<?php echo $ctr->ctr_gst_no;?>" maxlength="13"/></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>SOCSO ID</td>
        <td colspan="3"><input name="companysocsono" type="text" value="<?php echo $ctr->ctr_socso_no;?>" maxlength="13"/></td>
      </tr>
      <tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="telephone1" maxlength="20" value="<?php echo $ctr->ctr_telno;?>"/> <font color="red">*</font> <input type="text" name="telephone2" maxlength="20" value="<?php echo $ctr->ctr_telno1;?>"/> </td>
      	<td>Fax No</td>
      	<td colspan="3"><input type="text" name="fax" maxlength="20" value="<?php echo $ctr->ctr_fax;?>"/> </td>
        </tr>
		<tr>
		    <td>Agent</td>
			<td colspan="5"><input type="text" name="txtagname" value="<?php echo $ctr->agent_desc;?>" size="80" readonly/>
		...
		<tr>
			...
			<td colspan="2" rowspan="3"><label for="Remark"></label>
	  ...
	  <tr>
        ...
        <td id="t_cidbexpire">CIDB Exp. Date</td>
      	<td colspan="3"><input type="text" name="cidbexpire" id="cidbexpire" maxlength="20" value="<?php if($ctr->ctr_cidbexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_cidbexp_date));?>" READONLY/>
      ...
      <tr>
      	<td>Email Address</td>
      	<td colspan="5"><input type="text" name="email" size="50" maxlength="50" value="<?php echo $ctr->ctr_email;?>"/></td>
      </tr>
	  <tr>
        <td>Grade</td>
        <td colspan="5"><select name="grade">
      ...
      <tr>
        <td>Category</td>
        <td colspan="5"><select name="category" id="selcategory" onchange='javascript:addtocategory();'>
      ...
      <tr>
        ...
        <td colspan="5"><select name="specialization" id="selspec" onchange='javascript:addtospec();'>
        				<option value="" SELECTED></option>
      ...
      <tr>
        ...
        <td>CLAB Exp. Date</td>
        <td colspan="3"><input type="text" name="clab_expdate" value="<?php if($ctr->ctr_clabexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_clabexp_date));?>" readonly/>
      ...
      <tr>
      	<td>Attachments</td>
      	<td><input type="checkbox" name="form24" value="1" <?php if($ctr->ctr_attach_form24 == '1') echo "CHECKED";?> />Form24
      	                <input type="checkbox" name="form49" value="1" <?php if($ctr->ctr_attach_form49 == '1') echo "CHECKED";?>/>Form 49 
      	                <input type="checkbox" name="formD" value="1" />
      	                Form D
      ...
      <tr>
      	<td>&nbsp;</td>
      	<td><input type="checkbox" name="others" value="1" <?php if($ctr->ctr_attach_others == '1') echo "CHECKED";?>/>Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" value="<?php echo $ctr->ctr_attach_specify;?>" /> &nbsp; &nbsp; &nbsp;</td>
      	<td><input type="button" name="btnAttach" value="Attach Doc" class="smoothbtn1" onclick="attachdoc();" /></td>
      	<td><input type="checkbox" name="agreement" value="1" <?php if($ctr->ctr_attach_agg == '1') echo "CHECKED";?>/>
Supplier Agreement</td>
      	<td colspan="2">&nbsp;</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="3"><input type="text" name="directorMobile" id="directorMobile" size="35" maxlength="50" value="<?php echo $ctr->ctr_dir_mobileno;?>"  onchange="javascript:addkod(1,this.value);" onKeypress="if (event.keyCode < 44 || event.keyCode > 57 || event.keyCode==45 || event.keyCode==47) event.returnValue = false;"/></td>
      </tr>
      <tr>
      	...
      	<td>Mobile No.</td>
      	<td colspan="3"><input type="text" name="contactMobile" id="contactMobile" size="35" maxlength="50"  value="<?php echo $ctr->ctr_contact_mobileno;?>" onchange="javascript:addkod(2,this.value);" /></td>
      </tr>
      <tr>
      	<td>Designation</td>
      	<td colspan="5"><input type="text" name="contactDesig" size="80" maxlength="250"  value="<?php echo $ctr->ctr_contact_desg;?>"/></td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
        <td colspan="5">&nbsp;</td>
      ...
      <tr>
      	...
      	<td>Entered date</td>
      	<td colspan="3"><input type="text" name="entereddate" id="entereddate" value="<?php echo date('d-m-Y', strtotime($ctr->ctr_procdate))?>" READONLY/>
      ...
      <tr>
      	...
      	<td>Verified date</td>
      	<td colspan="3"><input type="text" name="verdate" id="verdate" value="<?php if($ctr->ctr_verifieddate != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_verifieddate))?>" READONLY/>
      ...
      <tr>
      	...
      	<td>Approved Date</td>
      	<td colspan="3"><input type="text" name="appdate" id="appdate" value="<?php if(strlen($ctr->ctr_app_date) > 0 && $ctr->ctr_app_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_app_date))?>" READONLY/>
      ...
      <tr>
      	...
      	<td>Rejected Date</td>
      	<td colspan="3"><input type="text" name="rejdate" id="rejdate" value="<?php if(strlen($ctr->ctr_rej_date) > 0 && $ctr->ctr_rej_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_rej_date))?>" READONLY/>
      ...
      <tr>
      	...
      	<td colspan="5"><input type="text" name="txtrejectreason" size="80" value="<?php echo $ctr->ctr_reject_reason;?>" /></td>
      </tr>
      <tr>
      	<td>Withdrawal by</td>
      	...
      	<td colspan="3"><input type="text" name="withddate" id="withddate" value="<?php if(strlen($ctr->ctr_withd_date) > 0 && $ctr->ctr_withd_date != '0000-00-00') echo date('d-m-Y', strtotime($ctr->ctr_withd_date))?>" READONLY/>
