 ...
 <tr>
  <td class="print" align="center">
	<table width="70%" border="0">
		...
		<tr>
			<td colspan="5" align="RIGHT" class="print">Date: <?php echo date('j F Y');?></td>
		</tr>
		<tr>
			<th width="5%">No.</th>
		...
		<tr>
			...
			<td><a href="<?php if(strlen($ctr->wkr_currentemp) == 0) echo ""; else echo site_url() . "/contContractor/viewExpiryLetter/$fieldName/$noOfMonths/$ctr->wkr_currentemp";?>"><u>View</u></a> | <a href="<?php if(strlen($ctr->wkr_currentemp) == 0) echo ""; else echo site_url() . "/contContractor/printExpiryLetter/$fieldName/$noOfMonths/$ctr->wkr_currentemp";?>"><u>Print Letter</u></a></td>
		</tr>
		<?php
				}	
			}
