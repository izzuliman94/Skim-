...
<form action="<?php echo site_url();?>/contContractor/editCtrSubmit" method="POST" name="editCtrForm" id="editCtrForm" onsubmit="return v.exec()">
    ...
    <tr>
      ...
      <tr>
      	<td colspan="4" align="RIGHT"><?php echo anchor_popup("contContractor/viewListOfLabours/" . $ctr->ctr_clab_no, "View List of Labours");?>      	</td>
      </tr>
      <tr>
      ...
      <tr>
      	...
      	<td><input type="text" name="clab_expdate2" value="<?php if($ctr->ctr_clabexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_clabexp_date));?>" readonly="readonly"/></td>
        <td>CLAB Exp. Date</td>
        <td><input type="text" name="clab_expdate" value="<?php if($ctr->ctr_clabexp_date != "0000-00-00") echo date('d-m-Y', strtotime($ctr->ctr_clabexp_date));?>" readonly/>
      ...
      <tr>
      	...
      	<td colspan="3"><input type="checkbox" name="others" value="1" <?php if($ctr->ctr_attach_others == '1') echo "CHECKED";?>/>Others &nbsp; &nbsp; &nbsp;
      					Please specify: <input type="text" name="attach_others" size="40" maxlength="200" value="<?php echo $ctr->ctr_attach_specify;?>" /> &nbsp; &nbsp; &nbsp <input type="button" name="btnAttach" value="Attach Doc" class="smoothbtn1" onclick="attachdoc();" />      	</td>
      </tr>
      <tr>
       	<td>&nbsp;</td>
      	<td colspan="3">&nbsp;</td>
