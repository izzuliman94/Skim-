...
<tr>
    <td colspan="2">
	    ...
	    <table width="100%">
	    	<tr>
			    <td width="26%" class="style1" >&nbsp;Tarikh / Masa&nbsp;</td>
			    <td width="30%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">:&nbsp;<?php echo date('d-m-Y G:i:s') ?></td>
			    <td width="13%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">Bil Pekerja </td>
			    <td width="31%" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;">: <?php echo $woRow->wo_fcl_total;?> </td>
			</tr>
			<tr>
