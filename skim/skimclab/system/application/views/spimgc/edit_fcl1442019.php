...
<tr>
  <td id="t_txtpermitno2">Green Card</td>
  <td colspan="3"><input type="checkbox" name="chkgc" value="1" <?php if($fcl->fcl_greencard == '1') echo "CHECKED" ; ?>/>
    <input type="text" id="dategc" name="dategc"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_gcdate)) ?>" maxlength="250" size="20" readonly="readonly"/>
    <input id="btngcdate" name="btngcdate" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dategc'), this)" /></td>
</tr>
<tr>
