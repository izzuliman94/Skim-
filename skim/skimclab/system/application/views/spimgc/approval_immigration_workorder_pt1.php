...
<h4><a href="dashboard.php">Immigration</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="approval.php">Approval Status</a> <img src="../images/right_arrow.gif" width="13" height="14" /> Immigration </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="../immigration/approval_immigration_workorder_pt2.php" method="get" name="TypicalForm" id="TypicalForm">
