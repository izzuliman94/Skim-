...
<body>
<h4><a href="dashboard.php">SPIM New Green Card Application</a>&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Update Workorder&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Register New FCL</h4>


<?php if(isset($successMsg)) echo "<font color=\"red\"><strong> $successMsg</strong></font>";?> <br />
<form action="<?php echo site_url();?>/contGC/AddNewFCL" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
...
<tr>
   ...
   <input type="hidden" name="txtgender" maxlength="30" size="20"  readonly="readonly"/>
...
<tr>
    ...
    <td width="15%"><input type="text" name="txtpermitno" maxlength="30" size="20" readonly/></td>
    <td width="11%">Permit Expiry</td>
    <td width="55%"><input type="text" name="txtpermitdate" maxlength="30" size="20" readonly="readonly"/></td>
</tr>
