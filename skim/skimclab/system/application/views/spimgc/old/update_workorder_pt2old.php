...
<br />
    ...
    <table width="100%" border="0">
    	...
    	<tr>
    		...
    		<td>
	    		<table width="100%">
	    			...
	    			<tr><td align="center"><input type="button" value="Insurance Purchase" onclick="Inspchs();"<?php if(strpos($accessibility, 'w') == true) echo "DISABLED";  ?> /></td></tr>
    	...
    	<tr>
    		...
    		<td><input type="checkbox" name="chkissubmit" value="1" onclick="checktrigger(this, txtsubmithr, dtsubmithr);"  <?php if($woRow->wo_issentto_hr == '1') echo "CHECKED DISABLED";?><?php echo $strprocess ?>/>
		...
		<tr>
    		...
    		<td><input type="checkbox" name="chkisreceivebyhr" value="1" onclick="checktrigger(this, txtreceivebyhr, dtreceivebyhr);"  <?php if($woRow->wo_isreceiveby_hr == '1') echo "CHECKED DISABLED";?> <?php echo $strprocess ?>/>
    	...
    	<tr>
    		...
    		<td><input type="checkbox" name="chkisjimack" value="1" onclick="checktrigger(this, txtjimack, dtjimack);" <?php if($woRow->wo_isjim_ack == '1') echo "CHECKED DISABLED";?> <?php echo $strprocess ?>/>
		...
		<tr>
			...
			<td><input type="checkbox" name="chkisrecit" value="1" onclick="checktrigger(this, txtitack, dtitack);" <?php if($woRow->wo_it_ack == '1') echo "CHECKED DISABLED";?> <?php echo $strprocess ?>/>
		...
		<tr>
		    <td>&nbsp;</td>
			<td colspan="4"><input name="button" type="button" onclick="handover('<?php echo $woRow->wo_clab_no;?>');"<?php if(strpos($accessibility, 'w') == true) echo "DISABLED";  ?> value="Handover Letter"/>
		    <input name="button2" type="button" onclick="pengesahan('<?php echo $woRow->wo_clab_no;?>');"<?php if(strpos($accessibility, 'w') == true) echo "DISABLED";  ?> value="Surat Pengesahan"/></td>
		</tr>
    	<tr>
    ...
    <table width="100%" border="0">
    	<tr>
    		<td align="center">
				...
				<input type="submit" name="btnupdate" value=" Update Workorder " onclick="return confirm('Are you sure you want to update?');" <?php if(strpos($accessibility, 'w') == false) echo "DISABLED";  ?><?php if($woRow->wo_latest_progress == "closed") echo "DISABLED";?> <?php echo $close ?>/>
