...
<script type="text/javascript">
		...
		function FCLdelete(id){
			 ...
			 var uri = "<?php echo site_url();?>/contgc/DeleteFCL/" + workorderid + "/" + companyname + "/" + id
		...
		var url = "<?php echo site_url('contgc/empfcl_list');?>/" + clabno
...
<body>
<h4><a href="dashboard.php">SPIM New Green Card Application</a>&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Update Workorder&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Edit FCL</h4>


<?php if(isset($successMsg)) echo "<font color=\"red\"><strong> $successMsg</strong></font>";?> <br />
<form action="<?php echo site_url();?>/contgc/SaveEditFCL" method="POST" name="AddNewFCL" id="AddNewFCL" onsubmit="return validate();">
...
<tr>
  <td id="t_txtpermitno3">Green Card In Process</td>
  <td colspan="3"><input type="checkbox" name="chkgcp" value="1" <?php if($fcl->fcl_gcp == '1') echo "CHECKED" ; ?>/>
    <input type="text" id="dategcp" name="dategcp"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_gcpdate)) ?>" maxlength="250" size="20" readonly="readonly"/>
    <input id="btngcdate2" name="btngcdate2" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dategcp'), this)" /></td>
</tr>
<tr>
  <td id="t_txtpermitno2">Green Card Received</td>
  <td colspan="3"><input type="checkbox" name="chkgcr" value="1" <?php if($fcl->fcl_gcr == '1') echo "CHECKED" ; ?>/>
    <input type="text" id="dategcr" name="dategcr"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_gcrdate)) ?>" maxlength="250" size="20" readonly="readonly"/>
    <input id="btngcdate" name="btngcdate" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dategcr'), this)" /></td>
</tr>
<tr>
  <td id="t_txtpermitno4">No Previous GC</td>
  <td colspan="3"><input type="checkbox" name="chkprgc" value="1" <?php if($fcl->fcl_prgc == '1') echo "CHECKED" ; ?>/>
    <!--input type="text" id="dateprgc" name="dateprgc"  value="<?php echo date('d-m-Y',strtotime($fcl->fcl_prgcdate)) ?>" maxlength="250" size="20" readonly="readonly"/>
    <input id="btngcdate3" name="btngcdate3" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dateprgc'), this)" /--></td>
</tr>
<tr>
...
<tr>
   <td id="t_txtnok"></td>
   <td colspan="3"><input type="hidden" name="txtyren" value="<?php echo $fcl->fcl_year_renewal;?>" maxlength="2" size="20"  /><input type="hidden" name="txtyrendate" maxlength="30" size="20" /><input type="hidden" name="txtcdate" value="<?php echo date("Y-m-j")?>" maxlength="30" size="20" /></td>
</tr>
<tr>
   <td id="t_txtnok"> </td>
   <td colspan="3"><input type="hidden" name="txtnok" value="<?php echo $fcl->fcl_next_of_kin;?>" maxlength="30" size="20"    /></td>
</tr>
<tr>
...
<tr>
    <td id="t_txtsalary"> <!--font color="red">*</font--></td>
    <td colspa="3"><input type="hidden" name="txtsalary" value="<?php echo $fcl->fcl_salary;?>" maxlength="30" size="20" /></td>
</tr>
<tr>
    <td id="t_txtsalary"> <!--font color="red">*</font--></td>
    <td colspa="3">
	...
	<input type="hidden" name="txtworktrade" size="40" value="<?php echo $fcl->fcl_wt ?>"  />
