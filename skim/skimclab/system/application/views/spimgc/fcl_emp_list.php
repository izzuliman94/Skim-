...
<script>
function senddata(passno,name,rdate,permitno,passexp,nok,relationship,salary,wt,nat,dob,gender,country,plksdate){
 ...
 opener.AddNewFCL.txtpermitdate.value = "";
...
opener.AddNewFCL.txtpermitdate.value = plksdate;
...
<body>
<form method="post" action="<?php echo site_url();?>/contgc/empfcl_list/<?php echo $clabno ?>">
<table width="70%">
<tr>
    <td>Passport No</td>
...
<tr align="center">
    <td><?php echo $i++; ?></td>
    <td><a href="#" onclick="senddata('<?php echo $labour->wkr_passno; ?>','<?php echo addslashes($labour->wkr_name); ?>','<?php echo $labour->wkr_entrydate?>','<?php echo $labour->wkr_passissue?>','<?php echo date("j M Y",strtotime($labour->wkr_passexp))?>','<?php echo $labour->wkr_next_of_kin ?>','<?php echo $labour->wkr_relationship ?>','<?php echo $labour->wkr_salary?>','<?php echo $labour->wkr_wtrade?>','<?php echo $labour->nat_desc?>','<?php echo $labour->wkr_dob?>','<?php echo $labour->wkr_gender?>','<?php echo $labour->wkr_country?>','<?php echo $labour->wkr_permitexp?>')"><?php echo $labour->wkr_passno; ?></a></td>
