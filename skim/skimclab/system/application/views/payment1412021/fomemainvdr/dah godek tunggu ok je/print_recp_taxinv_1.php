	...
	<table width="90%" align="center">			
		<tr>
		  <td height="15" colspan="5"><span class="style1">CONSTRUCTION LABOUR EXCHANGE CENTRE BERHAD (CLAB)</span> <span class="style7">(634396-W)</span><br />
			...
			Tel : 03-2095 9599     Fax : 03-2095 9566&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>No. Daftar CP</strong> : <strong>W10-1808-32001604</strong><br /></td>
		...
		<tr><td colspan="5" height=40px><div align="center"><span class="style8">OFFICIAL RECEIPT / INVOICE</span></div></td></tr>						
...
<tr>
	...
	<td >
		...
		if($payment->chk_fomema_female == '1') {$vdr4="FOMEMA ONLINE FEE, " ;  $unitV =$unitV + $payment->fomema_amountfee;}
...
<tr>
	...
	<td ><div align="center"><?php echo number_format($nofcl*$totfom,2) ?></div></td>
</tr>
<?php
}
...
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=2>Service Tax @ 6% &nbsp;&nbsp;&nbsp;(SR)</td>
...
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=3>Service Tax @ 0% &nbsp;&nbsp;&nbsp;(OS)</td>
...
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=3>Total Before Tax (RM)</td>
	<td align="center"><?php $tsr=$totgst-$unitINS; $tso=$totos+$unitINS; $totbefgst=$tsr+$tso; echo number_format($totbefgst,2); ?></td>
</tr>
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
