...
function clearfield(){
	...
	document.frmpayment.txtamtins.value = "0";
	document.frmpayment.txtamtinsg.value = "0";
	document.frmpayment.txtamtinso.value = "0";
	document.frmpayment.txtamtinsp.value = "0";
	document.frmpayment.txtamtig.value = "0";
	document.frmpayment.txtamtfwcs.value = "0";
	document.frmpayment.txtamtfwhs.value = "0";
	document.frmpayment.txtamtfom.value = "0";
	document.frmpayment.txtamtfomo.value = "0";
	document.frmpayment.txtamtfomg.value = "0";
	document.frmpayment.txtothremarks.value = "";
	document.frmpayment.txtamtothr.value = "0"; 
	//document.frmpayment.txtpolig.value = "";
	//document.frmpayment.txtpolfwcs.value = "";
	//document.frmpayment.txtpolfwhs.value = "";
}
...
function valid(tp){
	if(tp == 'F'){
		...
		//document.frmpayment.txtpolig.disabled = true;
		//document.frmpayment.txtpolfwcs.disabled = true;
		//document.frmpayment.txtpolfwhs.disabled = true;
		...
		//document.frmpayment.txtpolig.disabled = false;
		//document.frmpayment.txtpolfwcs.disabled = false;
		//document.frmpayment.txtpolfwhs.disabled = false;
	}
}
...
function getfomema(){
	...
	if(document.frmpayment.txtmale.checked == true){
		...
		document.frmpayment.txtfomfee.value = 0;
		document.frmpayment.txtamtfom.value = 0;
		document.frmpayment.txtamtfomg.value = 0;
		document.frmpayment.txtamtfomo.value = 0;
	}
...
<tr>
  ...
  <td colspan=6>
	<table width="100%" border="1" style="border-collapse: collapse;" cellpadding=1 bordercolor="#F0F3F4">
		...
		<tr>
			<td ><strong>OTHERS REMARK</strong></td>
			<td colspan=3 align=center><textarea  name="txtothremarks" style='width:95%;height:40px;'><?php echo $invoice->remarks_others?></textarea></td></td>
