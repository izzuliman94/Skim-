	...
	<td colspan="6">
		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
			...
			<tr>
			  ...
			  <td><input type="checkbox" name="txtlocald" value="1" <?php if($payment->chk_local_dis == '1') echo "Checked"?> onclick="getlocaldis()" <?php echo $strfomemaM ?>/>
			    DISBURSEMENT
                  <input type="checkbox" name="txtlocalr" value="1" <?php if($payment->chk_local_reim == '1') echo "Checked"?> onclick="getlocalreim()" <?php echo $strfomemaM ?>/>
              &nbsp; REIMBURSEMENT</td>
			  <td align="center"><input type="text" name="txtamtclab2" value="<?php echo $payment->local_amount?>" size="20" /></td>
		  </tr>
			<tr>
...
<tr>
   <td colspan="6" align="center"><input type="text" name="txtmodifieddate" value="<?php echo date("d-M-Y") ?>" size="20" />
   <input type="submit" value="Update" <?php if($payment->pmt_withdraw == '1') echo "DISABLED";?><?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/><input type="button" value="Print Receipt" onclick="printForm()"  />
