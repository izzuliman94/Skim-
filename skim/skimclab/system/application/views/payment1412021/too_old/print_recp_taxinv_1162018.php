...
<tr>
	...
	<table width="90%" align="center">			
		...
		<tr><td colspan="5" height=40px><div align="center"><span class="style8">OFFICIAL RECEIPT / TAX INVOICE</span></div></td></tr>						
...
<tr>
	...
	<td align=center><?php echo number_format($unitV,2) ?></td>
	<td ><div align="center"><?php echo number_format($nofcl*$unitV,2) ?></div></td>
</tr>
<?php
}
...
<tr>
	...
	<td >
		...
		$totgst=$totgst+($nofcl*$payment->clab_contreg_fee);
		?>
	</td>
	<td align=center><?php echo $nofcl ?></td>
	<td align=center><?php echo number_format($payment->clab_contreg_fee,2) ?></td>
	<td ><div align="center"><?php echo number_format($nofcl*$payment->clab_contreg_fee,2) ?></div></td>
</tr>
<?php
}
...
<tr>
	...
	<td >
		...
		$totgst=$totgst+($nofcl*$payment->clab_contren_fee);
		?>
	</td>
	<td align=center><?php echo $nofcl ?></td>
	<td align=center><?php echo number_format($payment->clab_contren_fee,2) ?></td>
	<td ><div align="center"><?php echo number_format($nofcl*$payment->clab_contren_fee,2) ?></div></td>
</tr>
<?php
}
...
<tr>
	...
	<td>
		...
		if($payment->chk_jim_cp == '1') {$jim6="CANCEL PERMIT, "; $unitJIM = $unitJIM  + 1500;}
...
<tr>
	...
	<td><div align="center"><?php  echo number_format($payment->ins_amounto,2)  ?></div></td>
</tr>
<?php
}
...
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=3>GST @ 0% &nbsp;&nbsp;&nbsp;(OS)</td>
	<td align="center"><?php $tso=$totos+$unitINS; echo number_format($tso,2)?></td>
</tr>
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=3>Total Before GST (RM)</td>
	<td align="center"><?php $totbefgst=$tsr+$tso; echo number_format($totbefgst,2); ?></td>
</tr>
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
	<td colspan=3>Add GST @ 0%</td>
...
<tr>
	...
	<td align="center"><div align="center"><?php $tamt=$totbefgst+$addgst; echo number_format($tamt,2); ?></div></td>
</tr>
<tr>
...
<table width="90%" height="70" align="center" bordercolor="#FFFFFF" style="border-collapse: collapse;">
	<tr>
		<td height="30" colspan="3">Recruitment will only be processed upon full payment and documentation.</td>
		<!--td width="23%" rowspan="4"><div align="right">.........................................................................<br />Authorised Signature</div></td-->
		<td width="23%"><div align="right">Prepared By</div></td>
	</tr>
	<tr>
		<td colspan=4><div align="right"><b><?php echo $this->session->userdata('username');?></b></div></td>
	</tr>	
	<tr>
