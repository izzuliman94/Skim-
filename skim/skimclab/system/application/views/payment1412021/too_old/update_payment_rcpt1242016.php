...
<tr>
   <td colspan="6" align="center"><input type="submit" value="Update" <?php if($payment->pmt_withdraw == '1') echo "DISABLED";?><?php if(strpos($accessibility, 'u') == false) echo "DISABLED";  ?>/><input type="button" value="Print Receipt" onclick="printForm()"  />
