	...
	<tr>
		<td>
			<table align="center" width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
				<tr>
					<td width="85%" align="left" style="height: 82px" >
						<table width="100%">
							...
							<tr><td align="center" height="20px"><b>OFFICIAL RECEIPT</b></td></tr>
						</table>
					</td>
				...
				<tr>
					<td height="10px">&nbsp;</td>
					<td align="center">OR No. :&nbsp;<b><?php echo $payment->pmt_receipt_no; ?></b></td>
				</tr>
			</table>
			...
			<table align="center" width="100%" border="1" style="border-collapse: collapse;" bordercolor="#cccccc">
				...
				<tr>
                  ...
                  <input type="checkbox" <?php if($payment->chk_jim_cp == '1'){ echo "checked" ;} ?> disabled/>CP&nbsp;
                  <input type="checkbox" <?php if($payment->chk_jim_compound == '1'){ echo "checked" ;} ?> disabled/>Compound
				  <div align="center"></div></td>
...
<table width="91%" align="center" border="0" style="border-collapse: collapse;">
<tr>
