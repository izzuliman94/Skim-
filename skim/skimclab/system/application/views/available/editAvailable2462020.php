...
<table width="100%" border="0">
		...
		<tr>
      	...
      	<tr>
			...
			<td colspan="3"><input type="text" name="payrefno" value="" size="60" readonly="readonly"/>
		...
		<tr>
		  ...
		  <td ><input type="checkbox" name="isclosed" onclick="checktrigger(this, txtclosedby, closeddate);"/>
	      <input type="text" name="txtclosedby" value="" readonly="readonly"/></td>
		  <td >Closed Date</td>
		  <td ><input type="text" name="closeddate" id="closeddate" value="" readonly="readonly"/>
	...
	<table width="100%" border="0">
		...
		<tr align="RIGHT">
			<td colspan="6"><input type="button" name="Checklist" value="Print Checklist"   onclick="window.open('<?php echo site_url();?>/contAvailable/printCheckLits/<?php echo $avlabDetails->avlab_ref_no ."/". $ctrData1->ctr_clab_no;?>', 'PrintChecklist', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist2" value="Surat Pengesahan Local Transfer"   onclick="window.open('<?php echo site_url();?>/contAvailable/printTransferValidate/<?php echo $ctrData1->ctr_clab_no;?>/<?php echo $refno;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input name="btnRegisNewLabour" type="button" onclick="registerNewLabor();" value="Register New Labour" <?php echo $btnRegisNewLabour ?>/>
