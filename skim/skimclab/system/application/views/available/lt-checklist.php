 ...
 <tr>
  <td align="CENTER" class="print">
	<table width="100%" border="0">
		<tr>	
			<td class="print" colspan="4" align="CENTER"><h2>CHECKLIST LOCAL TRANSFER</h2></td>
		</tr>
		<tr>	
	...
	<table width="100%" border="1">
		<tr>
			...
			<td width="33%" class="print"><strong>Verified by</strong></td>
		...
		<tr>
		  ...
		  <td class="print">Mohd Redzuan Syah Bin Kamaruddin</td>
