...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    ...
    <tr>
      <td height="34" colspan="2" rowspan="1">Ref: CLAB/LTV/<?php echo date('y');?>/<?php echo substr($avlabRow->clab_to_no, -6);?></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="4"><table width="90% border="0">
          ...
          <tr>
            ...
            <td><?php echo date('d-m-Y', strtotime($avlabwkr->avlabwkr_createddate));?></td>
          </tr>
      </table></td>
    </tr>
    <tr>
