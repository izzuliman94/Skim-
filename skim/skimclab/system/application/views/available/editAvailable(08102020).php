	...
	<table width="100%" border="0">
		...
		<tr align="RIGHT">
			<td colspan="6"><input type="button" name="Checklist" value="Print Checklist"   onclick="window.open('<?php echo site_url();?>/contAvailable/printCheckLits/<?php echo $avlabDetails->avlab_ref_no ."/". $ctrData1->ctr_clab_no;?>', 'PrintChecklist', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist4" value="Surat Pengesahan LT (New Contractor)"   onclick="window.open('<?php echo site_url();?>/contAvailable/printTransferValidate/<?php echo $ctrData1->ctr_clab_no;?>/<?php echo $refno;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
			  <input type="button" name="Checklist3" value="Handover Letter &amp; Passport (New Contractor)"   onclick="window.open('<?php echo site_url();?>/contAvailable/printTransferValidate/<?php echo $ctrData1->ctr_clab_no;?>/<?php echo $refno;?>', 'Local Transfer Pengesahan', 'height=480, width=420, toolbar=no, directories=no, status=no, location=no, menubar=no, scrollbars=yes')" />
