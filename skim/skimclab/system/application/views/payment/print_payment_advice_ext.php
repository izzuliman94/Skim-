...
$jim='';$jim1='';$jim2='';$jim3='';$jim4='';$jim5='';$jim6='';$jim7='';$jim8='';$jim9='';$jim10='';$unitJIM1=0;$unitJIM2=0;$unitJIM3=0;$unitJIM4=0;$unitJIM10=0;
...
if($payment->chk_jim_levi4 == '1') {$jim10="LEVY (YEAR 11 & Above) "; $unitJIM10 = $unitJIM10  + 6000;}
...
$totjim10=$nofcl*$unitJIM10;
//$totos=$totos+$totjim;
$sduty= 10.00;
$sduty1= 0.00;
	
$gtotlevy=$totjim4 + $totjim10 + $ttax + $sduty1 ;
...
<tr>
  <td align=center>&nbsp;</td>
  <td height="20" align=left>&nbsp;</td>
  <td ><?php echo $jim4 , $jim10 ?></td>
  <td align=right><?php echo number_format($unitJIM4 + $unitJIM10,2)?></td>
  <td align=right><?php echo $nofcl;?></td>
  <td align=right><?php echo $tbtax = number_format($totjim4 + $totjim10,2) ?> </td>
  <td align=right><?php echo $ttax = number_format(($totjim4 + $totjim10)*0.00,2) ?></td>
...
if($payment->chk_clab_fees_ext11 == '1') {$vdr1="ADMIN FEE (Year 11 & Above), ";	$unitV1 = $unitV1 + $payment->clab_ren_fee;}
...
<table width="90%" height="70" align="center" bordercolor="#FFFFFF" style="border-collapse: collapse;">
	<tr>
		...
		<td width="23%">Prepared By <b>:<?php echo $payment->pmt_datecreatedby//$this->session->userdata('username');?></b></td>
	</tr>
