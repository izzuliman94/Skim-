...
function clearfield(){
	...
	document.frmpayment.txtothremarkso.value = "";
	document.frmpayment.txtothremarks3rd.value = "";
...
if(tp == 'V'){ //VDR	 
	...
	document.frmpayment.txtadmfeesext1.checked = true;
	document.frmpayment.txtadmfeesext2.checked = true;
	...
	document.frmpayment.txtjimlevi2.disabled = true;
	document.frmpayment.txtjimlevi3.disabled = true;
	document.frmpayment.txtjimlevi4.disabled = false;
...
function getclabval_adminfeesrenewal(x){
	...
	if(fcl == "" || fcl == 0){ alert('Please Insert No Of FCL'); document.frmpayment.txtadmfeesext1.checked = false ; document.frmpayment.txtadmfeesext2.checked = false; return false;}
...
if(x == '1'){
	...
	if(document.frmpayment.txtadmfeesext2.checked == true){
		...
		document.frmpayment.txtclabrenfee.value = 0;
		document.frmpayment.txtadmfeesext1.value = eval(document.frmpayment.txtadmfeesext2.value) - eval(amt);
		document.frmpayment.txtamtclabren_t.value = eval(document.frmpayment.txtamtclabren_t.value) - eval(amttax);
		document.frmpayment.txtamtclabren_o.value = eval(document.frmpayment.txtamtclabren_o.value) - eval(amtonly) 
		document.frmpayment.txtamtclabren.value = eval(document.frmpayment.txtamtclabren.value) - eval(amt);	
	}
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
						  <td><input type="checkbox" name="txtadmfeesext1" value="1" onclick="getclabval_adminfeesrenewal(1)" disabled/>&nbsp;ADMIN FEE EXT</td>
						  <td>&nbsp;</td>
					  </tr>
						<tr>
							<td width=50%><input type="checkbox" name="txtadmfeesext2" value="1" onclick="getclabval_adminfeesrenewal(2)" disabled/>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td rowspan="4"><input type="checkbox" name="txtjimvisa" value="1" onchange="getjimval_visa()" disabled/>&nbsp;VISA</td>
...
&nbsp;LEVY (6 Month) - G1G3</td>
						...
						<tr>
						  <td><input name="txtjimlevi4" type="checkbox" id="txtjimlevi4" value="1" onclick="getjimval_levi(4)" disabled="disabled"/>					      
			...
			<tr>
				<td height="30" align="center" valign=top><input type="text" name="txtchqothro" value="" size="20" /></td>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td colspan=2><textarea cols="30" rows="5" name="txtothremarkso"></textarea></td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
            ...
            <tr>
				<td height="30" align="center" valign=top><input type="text" name="txtchqothr3rd" value="" size="20" /></td>
				<td align="center" valign=top>OTHERS</td>
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
						...
						<tr>
							<td colspan=2><textarea cols="30" rows="5" name="txtothremarks3rd"></textarea></td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
					<input type="text" name="txtamtothr_3rd" value="0" onchange="get_others3rd(this.value)" style='width:80px;text-align:center;' />
				</td>
				<td align="center" valign=top>
					<input type="text" name="txtamtothr_t" value="0" style='width:80px;text-align:center;' readonly />
					<input type="hidden" name="txtothfees" value="0" size="20" />
