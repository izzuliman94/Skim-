...
<tr>
	...
	<table width="90%" align="center">			
		...
		<tr><td colspan="4" height=40px><div align="center"><span class="style8">PAYMENT ADVICE FOR CONTRACTOR-LOCAL TRANSFER</span></div></td>
		  <td height=40px>&nbsp;</td>
		</tr>						
...
<tr>
  ...
  <td height="20" align=left><strong>Local Transfer</strong></td>
  <td >&nbsp;</td>
  <td >&nbsp;</td>
  <td >&nbsp;</td>
  <td align=center>&nbsp;</td>
...
<table width="90%" height="220" align="center" bordercolor="#FFFFFF" style="border-collapse: collapse;">
	...
	<tr>
	  <td align="right" colspan=4><b><?php echo $payment->pmt_datecreatedby//$this->session->userdata('username');?></b></td>
	  </tr>
	<tr>
