...
<tr>
	...
	<td colspan="3"><div align="center">Bank Draft to : Ketua Pengarah Imigresen Malaysia</div></td>
...
<tr>
  ...
  <td colspan="3"><div align="center">Insurance Guarantee </div></td>
...
<tr>
  ...
  <td colspan="3"><div align="center">2</div></td>
  <td colspan="3"><div align="center">
    <div align="center">3</div>
  </div></td>
  <td colspan="3"><div align="center">4</div></td>
  <td colspan="3"><div align="center">5</div></td>
...
<tr>
  ...
  <td><div align="center">*6% GST</div></td>
...
<tr>
  ...
  ?></td>
  <td ALIGN='CENTER'><?php echo $sum23 = $sum7 * 0.06?></td>
  <td ALIGN='CENTER'><?php echo $sum24 = "10.00" ?></td>
  ...
  <td ALIGN='CENTER'><?php echo $sum21 = $sum10 * 0.06?></td>
  ...
  <td ALIGN='CENTER'><?php echo $sum17 = $fcl->pmt_fcl_no * $fcl->pmt_fomema?></td>
  <td ALIGN='CENTER'><?php echo $sum22 = $sum17 * 0.06 ?></td>
</tr>
<tr>
  <td ALIGN='CENTER'>&nbsp;</td>
  <td ALIGN='CENTER'>&nbsp;</td>
...
<tr>
  ...
  <td ALIGN='CENTER'><?php echo number_format($sum20,2)?></td>
  <td ALIGN='CENTER'><?php echo $sum9?></td>
  <td ALIGN='CENTER'><?php echo $sum10?></td>
  <td ALIGN='CENTER'><?php echo $sum21?></td>
  ...
  <td ALIGN='CENTER'><?php echo $sum22 ?></td>
</tr>
<tr>
  <td ALIGN='CENTER'>&nbsp;</td>
  ...
  <td ALIGN='CENTER'>&nbsp;</td>
  <td ALIGN='CENTER'>&nbsp;</td>
  <td colspan="5"><div align="right"><?php $sumA = $sum3 + $sum4 + $sum5 + $sum6; echo number_format($sumA,2) ?></div></td>
  <td colspan="3" ALIGN='CENTER'><div align="right"><?php echo number_format($sumB = $sum7 + $sum23 + $sum24,2)?></div></td>
  <td colspan="3" ALIGN='CENTER'><div align="right"><?php echo number_format($sumC = $sum8 + $sum20 + $sum9,2)?></div></td>
  <td colspan="3" ALIGN='CENTER'><div align="right"><?php echo number_format($sumD = $sum10 + $sum21 + $sum11,2)?></div></td>
  <td colspan="3" ALIGN='CENTER'><div align="right"><?php echo number_format($sumE = $sum12 + $sum13 + $sum14,2)?></div></td>
  <td colspan="2"><div align="right"><?php echo number_format($sumF = $sum17 + $sum22,2)?></div></td>
</tr>
<?php }
  	 	 }
  	 	 ?>
...
<table width="100%">
<tr>
   <td colspan="3" align="right"><b><font size="1">TOTAL : RM<?php echo number_format($sumA + $sumB + $sumC + $sumD + $sumE + $sumF,2) ?>&nbsp;</font></b></td>
</tr>
<tr>
   <td colspan="3">&nbsp;</td>
</tr>
