...
<body>
<h4><a href="dashboard.php">SPIM</a>&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Payment Advise&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Edit  EXT FCL</h4>
<?php if(isset($successMsg)) echo "<font color=\"red\"><strong> $successMsg</strong></font>";?> <br />
<form method="post" name="addfcl" action="<?php echo site_url();?>/contPayment/Updatefclext" onsubmit="return v.exec();">
...
<tr>
  ...
  <td><input type="text" name="txtcompoundcomp" value="<?php echo $dataFCL->pmt_compound ?>" size="20" /></td>
  <td>Special Pass</td>
  <td><input type="text" name="txtspecpass" value="<?php echo $dataFCL->pmt_sp ?>" size="20" /></td>
</tr>
<tr>
...
<tr>
  <td align="center"><div align="left">Insurance Guarantee</div></td>
  <td align="center"><div align="left">
    <input type="text" name="txtig" value="<?php echo $dataFCL->pmt_ig ?>" size="20"/>
  </div></td>
  <td align="center"><div align="left">FWCS</div></td>
  <td align="center"><div align="left">
    <input type="text" name="txtfwcs" value="<?php echo $dataFCL->pmt_fwcs ?>" size="20"/>
  </div></td>
</tr>
<tr>
  <td align="center">&nbsp;</td>
  <td align="center">&nbsp;</td>
  <td align="center"><div align="left">FWHS</div></td>
  <td align="center"><div align="left">
    <input type="text" name="txtfwhs" value="<?php echo $dataFCL->pmt_fwhs ?>" size="20"/>
  </div></td>
</tr>
<tr>
  <td align="center"><div align="left">Clab Admin Fees</div></td>
  <td align="center"><div align="left">
    <input type="text" name="txtadmin" value="<?php echo $dataFCL->pmt_admin ?>" size="20"/>
  </div></td>
  <td align="center"><div align="left">Fomema</div></td>
  <td align="center"><div align="left">
    <input type="text" name="txtfomema" value="<?php echo $dataFCL->pmt_fomema ?>" size="20"/>
  </div></td>
</tr>
<tr>
    <td>&nbsp;</td>
