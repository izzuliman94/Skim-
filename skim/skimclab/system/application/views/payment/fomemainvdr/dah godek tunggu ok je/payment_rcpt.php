		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF" cellpadding=3>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtcontreg1" value="1" onclick="getcont_reg(1)" disabled/>&nbsp;REGISTRATION YEAR 1</td>
							<td></td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td><input type="checkbox" name="txtjimvisa" value="1" onchange="getjimval_visa()" disabled/>&nbsp;VISA</td>
							<td><input name="txtjimlevi" type="checkbox" id="txtjimlevi" value="1" onclick="getjimval_levi()" disabled/>&nbsp;LEVY</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtmale" value="1" onclick="getfomemamedical()" disabled/>&nbsp;MEDICAL</td>
							<td><input type="checkbox" name="txtfemale" value="1" onclick="getfomemaonline()" disabled/>&nbsp;ONLINE FEES</td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
					<input type="text" name="txtamtfomema_o" value="0" style='width:80px;text-align:center;' readonly />
					<input type="text" name="txtfomema_medical" value="0" size=5 />
					<input type="text" name="txtfomema_ofees" value="0" size=5 />
				</td>
				<td align="center" valign=top>
			...
			<tr>
				...
				<td align="center" >
					...
					<input type="text" name="txtclabtransfee" value="0" size=5 />
					<input type="text" name="txtclabtransgcfee" value="0" size=5 />
				</td>
				<td align="center" >
