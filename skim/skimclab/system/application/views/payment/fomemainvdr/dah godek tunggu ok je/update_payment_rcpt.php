...
function getclabval_greencard(){
	...
	if(pmttype == 'V' || pmttype == 'R' || pmttype == 'T'){
		if(pmttype == 'R' ){fee=50;} else {fee=125;}
		amtonly = fee * fcl;
		amttax = amtonly * 0.06;
		amt = amtonly + amttax; 	
	} 
...
function getfomemamedical(){
	...
	if(document.frmpayment.txtmale.checked == true){
	   document.frmpayment.txtfomema_medical.value = fee;
	   document.frmpayment.txtamtfomema.value = eval(document.frmpayment.txtamtfomema.value) + eval(amt);
	   document.frmpayment.txtamtfomema_o.value = eval(document.frmpayment.txtamtfomema_o.value) + eval(amtonly);
	   document.frmpayment.txtamtfomema_t.value = eval(document.frmpayment.txtamtfomema_t.value) + eval(gst);
	}else{
	   document.frmpayment.txtfomema_medical.value = 0;
	   document.frmpayment.txtamtfomema.value = eval(document.frmpayment.txtamtfomema.value) - eval(amt);
	   document.frmpayment.txtamtfomema_o.value = eval(document.frmpayment.txtamtfomema_o.value) - eval(amtonly);
	   document.frmpayment.txtamtfomema_t.value = eval(document.frmpayment.txtamtfomema_t.value) - eval(gst);
	}
...
function getfomemaonline(){
	...
	if(document.frmpayment.txtfemale.checked == true){
	   document.frmpayment.txtfomema_ofees.value = fee;
	   document.frmpayment.txtamtfomema.value = eval(document.frmpayment.txtamtfomema.value) + eval(amt);
	   document.frmpayment.txtamtfomema_o.value = eval(document.frmpayment.txtamtfomema_o.value) + eval(amtonly);
	   document.frmpayment.txtamtfomema_t.value = eval(document.frmpayment.txtamtfomema_t.value) + eval(gst);
	}else{
	   document.frmpayment.txtfomema_ofees.value = 0;
	   document.frmpayment.txtamtfomema.value = eval(document.frmpayment.txtamtfomema.value) - eval(amt);
	   document.frmpayment.txtamtfomema_o.value = eval(document.frmpayment.txtamtfomema_o.value) - eval(amtonly);
	   document.frmpayment.txtamtfomema_t.value = eval(document.frmpayment.txtamtfomema_t.value) - eval(gst);
	}
	...
	<td colspan="6">
		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
			<tr>
				...
				<td width="10%" align="center">TAX (6%)</td>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtadmfeesext" value="1" <?php if($payment->chk_clab_fees_ext == '1') echo "Checked"?> onclick="getclabval_adminfeesrenewal()" <?php echo $strclabfeeext ?> />&nbsp;ADMIN FEE EXT</td>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td><input type="checkbox" name="txtjimvisa" value="1" <?php if($payment->chk_jim_visa == '1') echo "Checked"?> onchange="getjimval_visa()" <?php echo $strjimvisa ?> />&nbsp;VISA</td>
							<td><input name="txtjimlevi" type="checkbox" id="txtjimlevi" value="1" <?php if($payment->chk_jim_levi == '1') echo "Checked"?> onclick="getjimval_levi()" <?php echo $strjimlevi ?> />&nbsp;LEVY</td>
						</tr>
						<tr>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtmale" value="1" <?php if($payment->chk_fomema_male == '1') echo "Checked"?> onclick="getfomemamedical()" <?php echo $strfomemaM ?> />&nbsp;MEDICAL</td>
							<td><input type="checkbox" name="txtfemale" value="1" <?php if($payment->chk_fomema_female == '1') echo "Checked"?> onclick="getfomemaonline()" <?php echo $strfomemaF ?> />&nbsp;ONLINE FEES</td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
			...
			<tr>
				<td height="30" align="center" valign=top><input type="text" name="txtchqothr" value="<?php echo $payment->others_chq_no?>" size="20" /></td>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						...
						<tr>
							<td colspan=2><textarea cols="30" rows="5" name="txtothremarks"><?php echo $payment->remarks_others?></textarea></td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
...
<tr>
   ...
   <input type="button" value="Print Receipt" onclick="printForm()"  />
	 ...
	 <input type="button" value="Print Receipt/Tax Invoice" onclick="printForm4()" /></td>
</tr>
</table>
</form>
</body>
