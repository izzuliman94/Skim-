	...
	function generateReport(type)
      {
	    ...
	    var url = "<?php echo site_url('contPayment/xlssumext')?>/" + datefrom + "/" + dateto;
        window.open(url);
     ...
     function generateReportview(type)
      {
	    ...
	    var datefrom = document.sumvdr.datefrom.value;
		var dateto = document.sumvdr.dateto.value;
	    var url = "<?php echo site_url('contPayment/xlssumextview')?>/" + datefrom + "/" + dateto;
        window.open(url);
...
<body>
<h4><a href="dashboard.php">Payment Summary (EXT) </a></h4>
...
<form method="POST" action="" name="sumvdr">
  <table width="80%" border="0">
		...
		<tr>
			<td colspan="2" align="CENTER"><input type="button" name="btnExport2" value="View" onclick="generateReportview('excel');" />
