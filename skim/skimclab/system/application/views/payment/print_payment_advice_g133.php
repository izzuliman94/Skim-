...
<tr>
	...
	<table width="90%" align="center">			
		...
		<tr><td colspan="4" height=40px><div align="center"><span class="style8">PAYMENT ADVICE FOR CONTRACTOR-G1G3 PROGRAMME</span></div></td>
		  <td height=40px>&nbsp;</td>
		</tr>						
...
<tr>
  ...
  <td height="20" align=left><strong>G1G3 Programme</strong></td>
  <td >&nbsp;</td>
  <td >&nbsp;</td>
  <td >&nbsp;</td>
  <td align=center>&nbsp;</td>
...
<?php
if($payment->payment_type=='G13' && $payment->chk_jim_levi2 == '1'){ 

$jim='';$jim1='';$jim2='';$jim3='';$jim4='';$jim5='';$jim6='';$jim7='';$unitJIM1=0;$unitJIM2=0;$unitJIM3=0;$unitJIM4=0;
...
<tr>
  ...
  <td height="20" align=left>&nbsp;</td>
  <td ><?php echo $jim5 ?></td>
  <td align=right><?php echo number_format($unitJIM5,2)?></td>
  <td align=right><?php echo $nofcl;?></td>
  <td align=right><?php echo number_format($totjim5,2) ?> </td>
  <td align=right><?php echo number_format($totjim5*0.00,2) ?></td>
...
<tr bgcolor="#F3F3F3">
  ...
  <td align=center>&nbsp;</td>
  <td>&nbsp;</td>
  <td align=right ><strong><?php echo number_format($gtotlevy + $gtotplks + $gtotfees + $gtotvisa,2) ?></strong></td>
</tr>
<tr>
...
$ins1='';$ins2='';$ins3='';$insu=0;$unitINS1=0;$unitINS3=0;$unitINS2=0;$unitV1=0;$unitV2=0;$unitV3=0;$unitV4=0;$unitV5=0;
	$unitFOM=0;$vdr1=0;$vdr2='';$vdr3='';$vdr4='';$vdr5='';$fom1='';
	
if($payment->chk_clab_fees == '1') {$vdr1="ADMIN/AGENCY FEE, ";	$unitV1 = $unitV1 + $payment->clab_adm_fee;}
if($payment->chk_clab_grncad == '1') {$vdr2="GREEN CARD, " ; $unitV2 = $unitV2 + $payment->clab_gc_fee;}	
if($payment->chk_clab_tsitcent == '1') {$vdr3="TRANSIT CENTRE, " ; $unitV3 = $unitV3 + $payment->clab_tc_fee;}
...
<tr bgcolor=#F3F3F3>
  ...
  <td>&nbsp;</td>
  <td>&nbsp;</td>
  <td align=right><strong><?php echo number_format($gtotadmin + $gtotgc + $gtottc + $gtotdf + $gtotfom + $gtotig + $gtotfwhs + $gtotlevy + $gtotplks + $gtotfees + $gtotvisa,2) ?></strong></td>
</tr>
</table>
<table width="90%" height="220" align="center" bordercolor="#FFFFFF" style="border-collapse: collapse;">
	<tr>
	...
	<tr>
	<td height="25" colspan="3" rowspan="4"><table width="400" style="border-collapse: collapse;" border="1" bordercolor="#cccccc">
	  <tr>
	...
	<tr>
	  <td align="right" colspan=4>Prepared By :</td>
	  </tr>
	<tr>
	  <td align="right" colspan=4><b><?php echo $payment->pmt_datecreatedby//$this->session->userdata('username');?></b>
	  </tr>
	<tr>
	  <td colspan=4><p>Remark Other Fees :
	  <textarea cols="35" rows="3" name="txtothremarkso" style='width:90%;height:30px;font-family:"Century Gothic";font-size: 9px;color: #333333'><?php echo $payment->remarks_otherso?></textarea>
	</p>
	  <p>Remark Other 3rd Party Charges : 
	    <textarea cols="35" rows="3" name="txtothremarks3rd" style='width:90%;height:30px;font-family:"Century Gothic";font-size: 9px;color: #333333'><?php echo $payment->remarks_others3rd?></textarea>
      </p></td>
	  </tr>	
	<tr>
		<td height="50" colspan="4">This is a Computer Generated Receipt, No Signature Required</td>
	</tr>
	<tr>
