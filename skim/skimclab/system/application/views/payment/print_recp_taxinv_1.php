...
<tr>
	...
	<td >
		...
		if($payment->chk_clab_fees_ext11 == '1') {$ren1="ADMIN FEE (Year 11 & Above), "; $unitR = $unitR + $payment->clab_ren_fee;}
...
<tr>
	...
	<td>
		...
		if($payment->chk_jim_levi4 == '1') {$jim4="LEVY ( Year 11 & Above), "; $unitJIM = $unitJIM  + 6000;}
...
if($payment->chk_others_fees == '1' || $payment->chk_others_fees2 == '1' || $payment->remarks_otherso <> ''){ 
?>
<tr>	
	<td height="15" align=center valign=top><?php echo wordwrap($payment->others_chq_noo,25,"<br>\n",true); ?></td>
	<td valign=top align="center" >OTHERS ( SST )</td>
	<td>
		<?php
		$oth1='';$oth2='';
		...
		$oth = $oth1.$oth2;		
		echo rtrim($oth,", ");
		if($payment->remarks_otherso <> ''){
			echo "<br><br><u>Remarks:</u><br>"; ?>
			<textarea cols="30" rows="3" name="txtothremarkso" style='width:90%;height:30px;font-family:"Century Gothic";font-size: 9px;color: #333333;border:0'><?php echo $payment->remarks_otherso?></textarea>
		<?php
		}
		?>
	</td>
...
<?php } ?>
<tr>
  <td height="15" align=center valign=top><?php echo wordwrap($payment->others_chq_no3rd,25,"<br>\n",true); ?></td>
  <td valign=top align="center" >OTHERS (NO SST )</td>
  <td>
		<?php
		$oth1='';$oth2='';
		//if($payment->chk_others_fees == '1') {$oth1="FEES, "; $totgst=$totgst+$payment->others_amount_o;}
		if($payment->chk_others_fees2 == '1') {$oth2="3rd PARTY CHARGES, " ;$totos=$totos+$payment->others_amount_3rd;}	
				
		$oth = $oth1.$oth2;		
		echo rtrim($oth,", ");
		if($payment->remarks_others3rd <> ''){
			echo "<br><br><u>Remarks:</u><br>"; ?>
			<textarea cols="30" rows="3" name="txtothremarks3rd" style='width:90%;height:30px;font-family:"Century Gothic";font-size: 9px;color: #333333;border:0'><?php echo $payment->remarks_others3rd?></textarea>
		<?php
		}
		?>
	</td>
  <td align="center">&nbsp;</td>
  <td align="center">&nbsp;</td>
  <td align="center"  valign=top><?php echo $payment->others_amount_3rd; ?></td>
</tr>
<tr>
	<td height="20"></td>
	<td>&nbsp;</td>
