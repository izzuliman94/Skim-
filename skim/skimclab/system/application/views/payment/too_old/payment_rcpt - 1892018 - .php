		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF" cellpadding=3>
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" style="border-collapse: collapse;" cellpadding=2>
						<tr>
							<td width=50%><input type="checkbox" name="txtmale" value="1" onclick="getfomema(1)" disabled/>&nbsp;VDR</td>
							<td><input type="checkbox" name="txtfemale" value="1" onclick="getfomema(2)" disabled/>&nbsp;RENEW</td>
						</tr>
					</table>
				</td>
				<td align="center" valign=top>
