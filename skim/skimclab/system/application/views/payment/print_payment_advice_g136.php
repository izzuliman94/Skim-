...
<?php
if($payment->payment_type=='G13' && $payment->chk_jim_levi3 == '1'){ 
...
<tr>
  ...
  <td height="20" align=left>&nbsp;</td>
  <td ><?php echo $jim6 ?></td>
  <td align=right><?php echo number_format($unitJIM6,2)?></td>
  <td align=right><?php echo $nofcl;?></td>
  <td align=right><?php echo number_format($totjim6,2) ?> </td>
  <td align=right><?php echo number_format($totjim6*0.00,2) ?></td>
...
if($payment->chk_clab_fees == '1') {
	$vdr1="ADMIN/AGENCY FEE ";	
	$unitV1 = $unitV1 + $payment->clab_adm_fee;
}
