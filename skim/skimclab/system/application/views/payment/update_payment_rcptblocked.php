...
<tr>
    ...
    <td><span class="style1">
      <input name="chkcancel" type="checkbox" id="chkcancel" onclick="cancelreceipt();" value="1" <?php if($payment->pmt_withdraw == '1') echo "checked" ;?><?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?> />
      Cancel Receipt&nbsp; &nbsp;&nbsp;
...
<tr>
    <td>No Of FCL:</td>
	<td colspan="5"><input type="text" name="txtfcl" value="<?php echo $payment->no_of_fcl ?>"  size="10" <?php echo $strfcl ?>/></td>
</tr>
<tr>
    <td>Country:</td>
...
<tr>
	<td colspan="6">
		...
		<table width="100%" border="1" style="border-collapse: collapse;" bordercolor="#FFFFFF">
			...
			<tr>
				<td height="30" align="center"><input type="text" name="txtchqclab" value="<?php echo $payment->pmt_chq_clab?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
				...
				<td>
					...
					&nbsp;AGENCY FEE<br />
					 ...
					 <option value="0"></option>
					 <option value="21.2" <?php if($payment->clab_reg_amount == '21.2') echo "selected"?>>1 Year</option>
					 <option value="42.4" <?php if($payment->clab_reg_amount == '42.4') echo "selected"?>>2 Year</option>
					 <option value="53" <?php if($payment->clab_reg_amount == '53') echo "selected"?>>3 Year</option>
					 </select>			  </td>
				<td align="center">
				<input type="text" name="txtamtclab" value="<?php echo $payment->clab_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/>
				<input type="hidden" name="txtamtclab_only" value="<?php echo $payment->clab_amount_only?>" size="20" />
				<input type="hidden" name="txtamtclab_tax" value="<?php echo $payment->clab_amount_tax?>" size="20" />				</td>
			</tr>
			<tr>
				<td height="30" align="center"><input type="text" name="txtchqjim" value="<?php echo $payment->pmt_chq_jim?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
...
onclick="getcancelpermit()" <?php echo $strjimcp ?>/>&nbsp;CP
				...
				<td align="center">
				<input type="text" name="txtamtjim" value="<?php echo $payment->jim_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/>
				...
				<input type="hidden" name="txtamtjim_compound" value="<?php echo $payment->jim_amount_compound?>" size="20" />				</td>
			</tr>
			<tr>
				<td height="30" align="center">&nbsp;<input type="text" name="txtchqfomema" value="<?php echo $payment->pmt_chq_fomema ?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
				...
				<td align="center"><input type="text" name="txtamtfomema" value="<?php echo $payment->fomema_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
			</tr>
			<tr>
				<td height="30" align="center">&nbsp;<input type="text" name="txtchqins" value="<?php echo $payment->ins_chq_no?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
...
onclick="getins_ig()"<?php echo $strinsig ?>/>&nbsp;IG
				...
				<td align="center">
				<input type="text" name="txtamtins" value="<?php echo $payment->ins_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/>
				...
				<input type="hidden" name="txtamtins_fwhs" value="<?php echo $payment->ins_amount_fwhs?>" size="20" />				</td>
			</tr>
			<tr>
				<td height="30" align="center"><input type="text" name="txtchqagency" value="<?php echo $payment->agency_chq_no?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
				...
				<td>
					...
					<input type="checkbox" name="txttcost" onclick="gettransitcost()" value="1" <?php if($payment->chk_transit_cost == '1') echo "Checked"?> <?php echo $strtranscost ?>/>&nbsp;COST					</td>
				<td align="center"><input type="text" name="txtamtagency" value="<?php echo $payment->agency_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/>
				<input type="hidden" name="txttc_fees" value="<?php echo $payment->transit_fees?>" size="20" />
					<input type="hidden" name="txttc_cost" value="<?php echo $payment->transit_cost?>" size="20" />				</td>
			</tr>
			<tr>
				<td height="30" align="center"><input type="text" name="txtchqothr" value="<?php echo $payment->others_chq_no?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
				...
				<td>
					...
					<input type="checkbox" name="txtothersfees2" value="1" <?php if($payment->chk_clab_mship == '1') echo "Checked"?> <?php echo $strothfees2 ?>/>
&nbsp;MEMBERSHIP FEES <br />
					Remarks&nbsp;<br /><textarea cols="30" rows="5" name="txtothremarks"><?php echo $payment->remarks_others?></textarea>					</td>
				<td align="center"><input type="text" name="txtamtothr" value="<?php echo $payment->others_amount?>" size="20" <?php if(strpos($accessibility, 'a') == false) echo "DISABLED";  ?>/></td>
			</tr>
		</table>	</td>
</tr>
...
<tr>
   <td colspan="6" align="center"><input type="submit" value="Update" <?php if($payment->pmt_withdraw == '1') echo "DISABLED";?>/><input type="button" value="Print Receipt" onclick="printForm()"  />
