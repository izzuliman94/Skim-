    ...
    <table width="100%" border="0">
		<tr>
		  ...
		  <td width="14%"><input type="text" name="workorderno" value="<?php echo "&lt;auto generate&gt;";?>" READONLY /></td>
			<td width="17%">Acknowledgement Type</td>
...
<br />
    ...
    <tr>
		...
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkimigration" value="1"/> 
		   Jabatan Imigresen - Ketua Pengarah Imigresen Malaysia <i>(Processing Fees/Visa/Levi)
		   <input type="text" name="txtImipay" size="40"/>
		   </i></td>
		</tr>
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkclab" value="1"/> CLAB - Construction Labour Exchange Centre Berhad <i>(Admin Fees/*6% Service Tax)
		     <input type="text" name="txtclabpay" size="40"/>
		   </i></td>
		</tr>
		<tr>
		   <td colspan="6"><input type="checkbox" name="chkins_guarante" value="1"/> Insurance - Lonpac Insurance Berhad <i>(Insurance Guarantee / FWCS / Stamp Duty/*6% Service Tax)
		     <input type="text" name="txtfwcspay" size="40"/>
		   </i></td>
		</tr>
		<tr>
		  <td colspan="6"><input type="checkbox" name="chkins_hospital" value="1"/>
...
<input type="text" name="txtfwhspay" size="40"/>
		...
		<tr>
		  <td colspan="6"><input type="checkbox" name="chkotherspay" value="1"/> 
		    Other Payment
<i> 
