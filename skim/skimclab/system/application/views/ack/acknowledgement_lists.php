...
<h4><a href="dashboard.php">Acknowledgement</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Dashboard <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />  Lists</h4>
...
<h3 id="switchsection1-title" class="handcursor">List of All Acknowledgement<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
<form method="POST" action="<?php echo site_url();?>/contAck/searchAcknowledgement" name="frmSearch" value="frmSearch">
	<table width="100%" border="0">
		<tr>
			<td>Search by:</td>
			<td>
				<input type="radio" name="rdsearchby" value="wo_num" CHECKED/>Acknowledgement No
		...
		<tr>
			<td colspan="2" align="center"><input type="submit" name="btnSearch" value=" Search " />
				<input type="button" name="btnReset" value="Reset" onclick="location.href='<?php echo site_url();?>/contAck/listAllWorkorders'" />
			</td>
		</tr>
	</table>
</form>
...
<table width="100%" border="0">
	<tr>
		<th align="LEFT">Acknowledgement LISTS</th>
	</tr>
</table>
