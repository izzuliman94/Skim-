  ...
  <form action="<?php echo site_url();?>/contAck/updateAcknowledgementPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <table width="100%" border="0">
    	<tr>
    		...
    		<th align='RIGHT'><input type="button" name="btnack" value="Acknowledgement" onclick="openack('<?php echo $woRow->wo_id;?>')" /></th>
    	</tr>
		<tr>
...
<br />
       <table width="100%" border="0">
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkimigration" value="1" <?php if($woRow->pay_imigration == '1') echo "checked";?>/> Jabatan Immigresen - Ketua Pengarah Imigresen Malaysia <i>(Processing Fees/Visa/Levi)
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkclab" value="1" <?php if($woRow->pay_clab == '1') echo "checked";?>/> CLAB - Construction Labour Exchange Centre Berhad <i>(Admin Fees/*6% Service Tax)
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkins_guarante" value="1" <?php if($woRow->pay_ins_guarante == '1') echo "checked";?>/> Insurance - Lonpac Insurance Berhad <i>(Insurance Guarantee / FWCS / Stamp Duty/*6% Service Tax)
		...
		<tr>
		  <td colspan="5"><input type="checkbox" name="chkins_hospital" value="1" <?php if($woRow->pay_ins_hospital == '1') echo "checked";?>/>
Insurance - Lonpac Insurance Berhad <i>(Foreign Worker Hospitalisation and Surgical Insurance Scheme / Stamp duty)
		...
		<tr>
		   <td colspan="5"><input type="checkbox" name="chkpayothers" value="1" <?php if($woRow->pay_others == '1') echo "checked";?>/> 
	      Other Payment          </td>
		   <td><input type="text" name="txtotherdetail" value="<?php echo $woRow->pay_others_detail;?>" size="40"/></td>
		</tr>
    </table>
    <br />
    <table width="100%" border="0">
