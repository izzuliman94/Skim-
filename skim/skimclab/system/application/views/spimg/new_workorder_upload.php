...
<body>
<h4><a href="dashboard.php">SPIM (G1G3)</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> New Workorder <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Attach Files </h4>
...
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="<?php echo site_url();?>/contSpimg/uploadDoc" method="POST" name="uploadForm" id="uploadForm" enctype="multipart/form-data">
