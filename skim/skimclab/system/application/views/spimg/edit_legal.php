...
<body>
<h4><a href="dashboard.php">SPIM (G1G2)</a>&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Update Workorder&nbsp;<img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" />&nbsp;Edit Legal</h4>
...
<tr>
    <td width=150px>Aggrement No</td>
    <td ><input type="text" name="txtaggno" maxlength="250" style="width:95%" value="<?php echo $legal->wo_agg_no; ?>" readonly /></td>
</tr>
<tr> 	
    <td id="t_txtpassno">Reference No. <font color="red">*</font></td>
 	<td ><input type="text" name="txtrefno" value="<?php echo $legal->wo_agg_ref_no; ?>" maxlength="30" size="20" /></td>
</tr>
<tr>
...
<tr>
 	...
 	<td ><textarea name="txtremarks"  style="width:95%;height:30px"><?php echo $legal->wo_agg_remarks; ?></textarea></td>
</tr>
