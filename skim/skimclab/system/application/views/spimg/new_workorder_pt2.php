...
<script type="text/javascript">
	...
	function selectall(){
		...
		document.newWorkorderForm.chkcimsdoc.checked = true;
		...
		document.newWorkorderForm.dtcimsdoc.value = '<?php echo date('d-m-Y')?>';
...
<h3 id="switchsection1-title" class="handcursor">New Work Order <img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
  <form action="<?php echo site_url();?>/contSpimG/newWorkOrderPt2Submit" method="POST" name="newWorkorderForm" id="newWorkorderForm"  onsubmit="return v.exec();">
	...
	<table width="100%" border="0" cellpadding=3 style='border-style:none'>
    	...
    	<tr>
    		<td><input type="checkbox" name="chkinsurance" value="1" />Insurance \ SOCSO </td>
    	...
    	<tr>
    	  <td><input type="checkbox" name="chkcimsdoc" value="1" />CIMS Document</td>
    	  <td><input type="text" name="dtcimsdoc" id="dtcimsdoc" size="8" value="" /></td>
    	  <td><input id="button" name="button" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtcimsdoc'), this)" /></td>
    	  <td colspan="7">&nbsp;</td>
  	  </tr>
    	<tr>
    ...
    <table width="100%" border="0" cellpadding=3 style='border-style:none'>
		...
		<tr>
		  <td>DEPOSIT</td>
		  <td><select name="seldeposit">
				<option value="NO">NO</option>
				<option value="YES">YES</option>
				</select></td>
		  <td>Compound</td>
		  <td><select name="selcomp">
				<option value="NO">NO</option>
				<option value="YES">YES</option>
				</select></td>
		  <td>Admin Fee</td>
		  <td><SELECT name="seladminfee">
					<option value="NO">NO</option>
					<option value="YES">YES</option>
				</SELECT>  </td>
	  </tr>
		...
		<tr>
		  <td>Agency Fee</td>
		  <td><SELECT name="selagencyfee">
					<option value="NO">NO</option>
					<option value="YES">YES</option>
		  </SELECT> </td>
		  <td>FOMEMA</td>
		  <td><SELECT name="selfomema">
					<option value="NO">NO</option>
					<option value="YES">YES</option>
		  </SELECT>  </td>
		  <td>VISA</td>
		  <td><SELECT name="selvisa">
					<option value="NO">NO</option>
					<option value="YES">YES</option>
				</SELECT> </td>
	  </tr>
