...
<table width="100%" border="0">
	...
	?>
	<tr>
		<!--td><a href="<?php echo site_url();?>/contSpimg/updateWorkOrderPt2/<?php echo $wo->wkr_id;?>"><?php echo $wo->wo_id;?></a></td-->
		<td><?php echo $wo->fcl_name;?></td>
		<td><?php echo $wo->fcl_passno;?></td>
		<td><?php echo date('d-m-Y', strtotime($wo->fcl_dob));?></td>
		<td><?php echo $wo->cty_desc;?></td>
		<td><?php echo $wo->fcl_wt;?></td>
		<td><?php echo date('d-m-Y', strtotime($wo->fcl_passexp));?></td>
		<!--td><?php echo date('d-m-Y', strtotime($wo->fcl_permitexp));?></td-->
	</tr>
	<?php }
	}
	?>
