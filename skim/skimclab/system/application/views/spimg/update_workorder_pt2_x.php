...
//echo $woRow->doc_rqform;
	...
	/*if(isset($woRow->wo_isreplacement) == '1'){
	    ...
	    if($woRow->doc_rqform == '1' && $woRow->doc_company == '1' && $woRow->doc_awardletter == '1' && $woRow->doc_nric == '1'
		   ...
		   && $woRow->doc_photo == '1' && $woRow->doc_datecomplete != '0000-00-00')
		{
			$doc = "hide";
			$doctext = "readonly";
			$doc1 = "disabled=disabled";
  ...
  <form action="<?php echo site_url();?>/contSpimG/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    <table width="100%" border="0" cellpadding=3 style='border-style:none'>
		...
		<tr>
		  ...
		  <td id="t_contdur" >Contract Duration</td>
		  <td>
			<SELECT name="contdur">
				<option value=''></option>
    ...
    <table width="100%" border="0" cellpadding=3 style='border-style:none'>
    	...
    	<tr>
    		<td><input type="hidden" name="chkinsurance1" value=<?php echo $woRow->doc_insurance ?> ><input type="checkbox" name="chkinsurance" value="1" <?php if($woRow->doc_insurance == '1') echo "CHECKED ";?> <?php echo $doc ?> <?php echo $isrepdis ?>/>Insurance</td>
   ...
   <br />
    <table width="100%" border="0" cellpadding=3 style='border-style:none'>
    	...
    	<tr>
    		<td colspan="6" id="t_payref">OFFICIAL RECEIPT NO<font color="red">*</font>.: 
   		  <input type="text" name="payrefno" size="50" value="<?php echo $woRow->pay_refno;?>"  /><input type="button" value="..." onclick="paymentlist('<?php echo $woRow->ctr_clab_no;?>')" <?php echo $jkklulus1; ?> /></td>
    	</tr>
    	<tr>
    		<td>Admin Fee</td>
    		<td>
    		...
    		<td>LEVY</td>
    		<td>
    			<SELECT name="sellevy" <?php echo $jkklulus2; ?> />
    		...
    		<td>PLKS</td>
    		<td>
    			<SELECT name="selplks" <?php echo $jkklulus2; ?> />
    		...
    		<td>Agency Fee</td>
    		<td>
    			<SELECT name="selagencyfee" <?php echo $jkklulus2; ?> />
    		...
    		<td>FOMEMA</td>
    		<td>
    			<SELECT name="selfomema" <?php echo $jkklulus2; ?> />
    		...
    		<td>VISA</td>
    		<td>
    			<SELECT name="selvisa" <?php echo $jkklulus2; ?> />
    	...
    	<tr>
    		<td>IG</td>
    		<td>
    			<SELECT name="selig" <?php echo $jkklulus2; ?> />
    		...
    		<td>FWHS</td>
    		<td>
				<select name="selfwhs" <?php echo $jkklulus2; ?> />
			...
			<td>DEPOSIT</td>
    		<td>
    			<SELECT name="seldeposit" <?php echo $jkklulus2; ?> />
		...
		<tr>
    		<td>GREEN CARD</td>
    		<td>
    			<SELECT name="selgreen" <?php echo $jkklulus2; ?> />
    		...
    		<td>
				<select name="seltransit" <?php echo $jkklulus2; ?> />
    ...
    <table width="100%" border="0" cellpadding=3 style='border-style:none'>
		...
		<tr>
			<th align="left" width="350">PROGRESS</th>
		...
		<tr>
			...
			<td>
				...
				<input name="chkisprocess" type="checkbox" id="chkisprocess" onclick="checktrigger(this, txtprocessby, dtprocess);" value="1" <?php if($woRow->wo_isprocess == '1') echo "CHECKED DISABLED";?>/>
			...
			<td><input id="button12" name="button5" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtprocess'), this)" /> </td>
		...
		<tr>
			...
			<td><input id="button13" name="btnDate13" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtreceive'), this)" /></td>
			<td><input type="text" name="txtreceivecomment" value="<?php echo $woRow->wo_receive_comment;?>" style='width:95%'/></td>
		</tr>
		<tr>
			<td>Naziran (Cetak Borang Naziran)</td>
			<td>
				<input type="checkbox" name="chknaziran" value="1" onclick="checktrigger(this, txtnaziranby, dtnaziran);" <?php if($woRow->wo_isnaziran == '1') echo "CHECKED DISABLED";?>/>
			...
			<td><input id="button14" name="btnDate14" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtnaziran'), this)" /></td>
			<td><input type="text" name="txtnazirancomment" value="<?php echo $woRow->wo_nazirancomment;?>" style='width:95%'/></td>
		</tr>
		<tr>
			<td>Temuduga</td>
			<td>
				<input type="checkbox" name="chkinterview" value="1" onclick="checktrigger(this, txtinterviewby, dtinterview);" <?php if($woRow->wo_isinterview == '1') echo "CHECKED DISABLED";?>/>
			...
			<td><input id="button15" name="btnDate15" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtinterview'), this)" /></td>
		...
		<tr>
			...
			<td valign=top>
				<input type="checkbox" name="chklulus" value="1" onclick="checktrigger(this, txtlulusby, dtlulus);" <?php if($woRow->wo_islulus == '1') echo "CHECKED DISABLED";?>/>
			...
			<td valign=top><input id="button16" name="btnDate16" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtlulus'), this)" /></td>
			<td valign=top>
		...
		<tr>
			...
			<td valign=top>
				<input type="checkbox" name="chkransit" value="1" onclick="checktrigger(this, txtransitby, dtransit);" <?php if($woRow->wo_isransit == '1') echo "CHECKED DISABLED";?>/>
			...
			<td valign=top><input id="button17" name="btnDate17" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtransit'), this)" /></td>
			<td valign=top>
		...
		<tr>
			...
			<td valign=top>
				<input type="checkbox" name="chkhover" value="1" onclick="checktrigger(this, txthoverby, dthover);" <?php if($woRow->wo_ishover == '1') echo "CHECKED DISABLED";?>/>
			...
			<td valign=top><input id="button18" name="btnDate18" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dthover'), this)" /></td>
			<td valign=top>
		...
		<tr>
			...
			<td><input type="checkbox" name="iswithd" value="1" onclick="checktrigger(this, 'Close', dtwithd);"<?php if($woRow->wo_iswithdrawal == '1') echo "CHECKED";?> <?php echo $strprocess ?>/></td>
			...
			<td><input id="button3" name="btnDate3" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('dtwithd'), this)" <?php echo $strprocess ?>/></td>
