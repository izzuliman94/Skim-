...
<table width="100%" border="0">
	<tr>
		<th align=left>Workorder ID</th>
		<th align=left>Workorder Num</th>
	...
	?>
	<tr>
		<td colspan="6" align=center>There is no data to display.</td>
	</tr>
	<?php
	}
	else{
	...
	?>
	<tr>
		<td><a href="<?php echo site_url();?>/contSpimg/updateWorkOrderPt2/<?php echo $wo->wo_id;?>"><?php echo $wo->wo_id;?></a></td>
