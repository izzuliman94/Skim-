<?php
	class contPayment extends Controller {
		...
		function xlssumvdr(){
		     $type = 'V';
		     $data['summary'] = $this->ModelPayment->getsumpaymentvdr($type);
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt 
					...
					'$jimamount','$fomemachqno',
					'$chkfomemamale','$chkfomemafemale','$fomemapa','$fomemaamount','$inschqno','$chkinsig','$chkinsfwcs','$chkinsfwhs','$inspa','$insamount',
