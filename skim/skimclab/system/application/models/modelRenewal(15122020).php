<?php
	...
	/*	function getAllFCLFiles($workorderid){
		...
		$sql = "select workers.wkr_nationality,wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,wo_fcl_renew.fcl_year_renewal,
