	...
	/*	function getAllFCLFiles($workorderid){
		...
		function getAllLegalList($workorderid){
			...
			$sqlQuery = "SELECT wo_fcl_renew.fcl_id,wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_newpassno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,
           			     wo_fcl_renew.fcl_passissue,fcl_passexp,fcl_salary,wo_fcl_renew.fcl_next_of_kin,wo_fcl_renew.fcl_relationship,
						 wo_fcl_renew.fcl_salary,mst_worktrade.trade_desc,wo_fcl_renew.fcl_wt,mst_wo_type.mst_wo_type_desc,wo_fcl_renew.fcl_nationality
						 FROM wo_fcl_renew 
						 left join workers on workers.wkr_passno = wo_fcl_renew.fcl_passno
						 Left join mst_nationality on mst_nationality.nat_id = workers.wkr_nationality
						 left join mst_worktrade on mst_worktrade.trade_id = wo_fcl_renew.fcl_wt 
		...
		$sql = "select wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,wo_fcl_renew.fcl_year_renewal,
		        wo_fcl_renew.fcl_passissue,wo_fcl_renew.fcl_next_of_kin, wo_fcl_renew.fcl_relationship,fcl_passexp,mst_worktrade.trade_desc,mst_countries.cty_period,mst_countries.cty_levi,wo_fcl_renew.fcl_pass,
