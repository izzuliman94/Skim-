<?php
	...
	/*	function getAllFCLFiles($workorderid){
		...
		$sql = "select wo_fcl_renew.fcl_passno,workers.wkr_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,wo_fcl_renew.fcl_year_renewal,
		        wo_fcl_renew.fcl_passissue,wo_fcl_renew.fcl_next_of_kin, wo_fcl_renew.fcl_relationship,fcl_passexp,mst_worktrade.trade_desc,mst_countries.cty_period,mst_countries.cty_levi,
