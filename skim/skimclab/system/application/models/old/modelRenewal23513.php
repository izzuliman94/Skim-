<?php
	...
	/*	function getAllFCLFiles($workorderid){
		...
		$sql = "select wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,wo_fcl_renew.fcl_year_renewal,
				...
				wo_fcl_renew.fcl_wo_type,				mst_countries.cty_plks,mst_countries.cty_visa,workers.wkr_gender,workers.wkr_dob,mst_countries.cty_process,wo.wo_personincharge,wkr_permitexp
		        from wo_fcl_renew
