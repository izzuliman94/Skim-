	...
	class ModelRenewal extends Model{
		...
		function getApprovalList(){
		  ...
		  $sql = "select workorders.*,contractors.ctr_comp_name from workorders 
				  ...
				  where wo_spim_status = 'R' and (chk_app_ceo <> '1' or chk_ver_corp <> '1' or chk_ver_fin <> '1')";
		  return $this->db->query($sql);       
	...
	/*	function getAllFCLFiles($workorderid){
		...
		function getAllLegalList($workorderid){
			...
			$sqlQuery = "SELECT wo_fcl_renew.fcl_id,wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_newpassno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,
           			     wo_fcl_renew.fcl_permitno, wo_fcl_renew.fcl_nationality,fcl_passexp,fcl_salary,wo_fcl_renew.fcl_next_of_kin,wo_fcl_renew.fcl_relationship,
		...
		$sql = "select wo_fcl_renew.fcl_passno,wo_fcl_renew.fcl_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,wo_fcl_renew.fcl_year_renewal,
		        wo_fcl_renew.fcl_permitno,wo_fcl_renew.fcl_next_of_kin,wo_fcl_renew.fcl_nationality, wo_fcl_renew.fcl_relationship,fcl_passexp,mst_worktrade.trade_desc,mst_countries.cty_period,mst_countries.cty_levi,wo_fcl_renew.fcl_pass,
				wo_fcl_renew.fcl_dob,wo_fcl_renew.fcl_gender,wo_fcl_renew.fcl_newpassno,wo_fcl_renew.fcl_wo_type,wo_fcl_renew.fcl_wo_type,wo_fcl_renew.fcl_plksdate1,wo_fcl_renew.fcl_plksdate2,			mst_countries.cty_plks,mst_countries.cty_visa,workers.wkr_gender,workers.wkr_dob,mst_countries.cty_process,wo.wo_personincharge,wkr_permitexp
		        from wo_fcl_renew
