<?php
	class ModelRenewal extends Model{
		...
		function getAllLabor($searchdata){
		    ...
		    $sqlquery = "SELECT wkr_passno,wkr_name FROM workers where wkr_passno like '%$strpassno%' order by wkr_name";
	...
	/*	function getAllFCLFiles($workorderid){
		...
		function getAllLegalList($workorderid){
			...
			$sqlQuery = "SELECT wo_fcl_renew.fcl_id,wo_fcl_renew.fcl_passno,workers.wkr_name,mst_nationality.nat_desc,
						 ...
						 wo_fcl_renew.fcl_salary,mst_worktrade.trade_desc
						 FROM wo_fcl_renew 
		...
		$sql = "select wo_fcl_renew.fcl_passno,workers.wkr_name,mst_nationality.nat_desc,wo_fcl_renew.fcl_salary,
		        wo_fcl_renew.fcl_passissue,fcl_passexp,mst_worktrade.trade_desc,mst_countries.cty_period,mst_countries.cty_levi,
