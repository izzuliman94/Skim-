    	...
    	<tr>
    		...
    		<td colspan="2">
    			<table width = "90%" align="center" border="1">
    				...
    				<tr>
    					<td><input type="checkbox" name="accessibility" value="7" onclick="checkMe(this)"/></td>
    					<td>Verification</td>
    				</tr>
    				<tr>
    					<td><input type="checkbox" name="accessibility" value="8" onclick="checkMe(this)"/></td>
    					<td>Approve/Reject</td>
    				</tr>
    				<tr>
    					<td><input type="checkbox" name="accessibility" value="9" onclick="checkMe(this)"/></td>
    					<td>Delete</td>
    				</tr>
    				<tr>
    					<td><input type="checkbox" name="accessibility" value="p" onclick="checkMe(this)"/></td>
    					<td>Special Permit Renewal rights</td>
    				</tr>
    				<tr>
    				  <td><input type="checkbox" name="accessibility2" value="s" onclick="checkMe(this)"/></td>
