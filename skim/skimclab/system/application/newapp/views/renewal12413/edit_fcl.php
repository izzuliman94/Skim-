...
<tr>
    ...
    <td colspan="3"><input type="text" name="txtpassissue" value="<?php echo $fcl->fcl_passno;?>" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
    <td id="t_txtpassexp">Passport Expired <font color="red">*</font></td>
    <td colspan="3">
    <input type="text" id="txtpassexp" name="txtpassexp" value="<?php echo date('d-m-Y', strtotime($fcl->fcl_passexp));?>" maxlength="30" size="20" readonly/>
...
<tr>
   ...
   <td colspan="3"><input type="text" name="txtyren" value="<?php echo $fcl->fcl_year_renewal;?>" maxlength="1" size="20" readonly/><input type="hidden" name="txtyrendate" maxlength="30" size="20" /><input type="hidden" name="txtcdate" value="<?php echo date("Y-m-j")?>" maxlength="30" size="20" /></td>
</tr>
<tr>
   <td id="t_txtnok">Next Of Kin </td>
   <td colspan="3"><input type="text" name="txtnok" value="<?php echo $fcl->fcl_next_of_kin;?>" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
   <td id="t_txtnok">Relationship</td>
   <td colspan="3"><input type="text" name="txtrelationship" value="<?php echo $fcl->fcl_relationship;?>" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
    <td id="t_txtsalary">Salary <font color="red">*</font></td>
    <td colspa="3"><input type="text" name="txtsalary" value="<?php echo $fcl->fcl_salary;?>" maxlength="30" size="20" readonly/></td>
</tr>
<tr>
	...
	<input type="text" name="txtworktrade" size="40" value="<?php echo $fcl->fcl_wt ?>" READONLY />
