...
<tr>
    ...
    <input id="btndob" name="btndob" type="button" class="scwdatepicker" onclick="scwShow(document.getElementById('txtdob'), this)" />
    </td>
</tr>
<tr>
...
<tr>
	...
	<input type="button" value="..." onclick="getcountry()"/>
    </td>
</tr>
<tr>
	...
	<input type="hidden" name="selnationality" value="<?php echo $fcl->nat_id;?>"/> 
    </td>
</tr>
<tr>
