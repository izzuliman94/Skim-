...
<h4><a href="dashboard.php">Contractor</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> <a href="registration_pt1.php">Company Registration</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Assign Labour</h4>
...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contContractor/assignLabourCompSearchResult" method="POST" name="TypicalForm" id="TypicalForm">
...
?>
	<table width="100%" border="0">
		...
		<tr>
			...
			<td><a href="<?php echo site_url();?>/contContractor/assignLabourPt2/<?php echo $ctr->ctr_clab_no;?>">Assign Labour</a></td>
		</tr>
	<?php
			}//end foreach
		}//end else
