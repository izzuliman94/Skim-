...
<head>
  ...
  <title>SKIM - CLAB Registration Reject Letter</title>
<style type="text/css">
th {
...
<table style="text-align: left; width: 616px;" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody>
	...
	<tr>
      <td colspan="4"><strong><u>CLAB REGISTRATION</u></strong></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><p align="justify">We are regret to inform you that your registration with Construction Labour Exchange Centre Berhad (CLAB) has been rejected due to <?php echo $ctr->ctr_reject_reason;?>. However, we welcome you to resubmit your application</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td colspan="4"><p align="justify">If you have questions, please do not hesitate to contact us. As you needs change, we will be happy to help you evaluate those needs and offer you the services that will help you achieve your new goals. We are looking forward to provide you with our services and we would like to extend our appreciation for your participation.</p></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
