...
<h4><a href="dashboard.php">Local Transfer</a> <img src="<?php echo base_url();?>/images/right_arrow.gif" width="13" height="14" /> Labour Details </h4>

<h3 id="switchsection1-title" class="handcursor">Local Transfer Labour Details<img src="<?php echo base_url();?>/images/down_arrow_org.gif" width="13" height="14" /></h3>
...
<table width="100%" border="0">
 		<tr>
 			<th colspan="5" align="RIGHT">
 				...
 				<!--<input type="button" name="btnRemove" value="Remove this labour" onclick="location.href='<?php echo site_url();?>/contAvailable/removeLabour/<?php //echo $labor->wkr_id;?>/<?php //echo $avlab_ref_no;?>'"/>-->
 		...
 		<tr>
 			...
 			<td rowspan="2" colspan="2"><textarea name="txtcuraddr" cols="50" rows="2"><?php echo $labor->wkr_address;?></textarea></td>
 			<td>Postcode</td>
