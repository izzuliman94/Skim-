...
<div id="switchsection1" class="switchgroup1"> 
  <form action="<?php echo site_url();?>/contAvailable/availableFormWithCompDetails" method="POST" name="newLocalTransfer" id="newLocalTransfer" onsubmit="return v.exec()">
		...
		<tr>
      	...
      	<tr>
			<td colspan="4" align="center">
			    ...
			    <input type="button" name="Back" value=" Cancel " onclick="location.href='<?php echo site_url();?>/contAvailable/availableDashbrd'"/>
			</td>
		</tr>
    </table>
  </form>
