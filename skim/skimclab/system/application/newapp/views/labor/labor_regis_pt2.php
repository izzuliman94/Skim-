 ...
 <form action="<?php echo site_url();?>/contLabour/newLabourDetailsSubmit" method="POST" name="laborRegForm" id="laborRegForm" onsubmit="return v.exec();">
 	<table width="100%" border="0">
 		...
 		<tr>
 			...
 			<td colspan="3"><select name="selday">
              <option value=""></option>
              <?php for($i=1;$i<=31;$i++){?>
 		...
 		<tr>
		    ...
		    <font color="red">*</font></td>
 			<td width="18%" id="t_selEmp">Passport Issue </td>
 			<td><input type="text" name="txtpassissue" /></td>
 		</tr>
 		<tr>
 			<td>Home Address</td>
 			<td colspan="3"><textarea name="txthomeaddr" cols="50" rows="2"></textarea></td>
 		</tr>
		<tr>
		    <td>Next Of Kin</td>
			<td><input type="text" name="txtnok"  size="50"/></td>
			<td>Relationship</td>
			<td><input type="text" name="txtrelationship"  /></td>
		</tr>
 		<tr>
 			<td>Salary</td>
 			<td><input type="text" name="txtsalary" value="0.00"/> </td>
 			<td>JTK Submission</td>
 			<td><input type="checkbox" name="chkjtk" value="1"/>
Rerefence No.
  <input type="text" name="txtrefjtk" width="200" value=""/></td>
 		</tr><tr>
 			<td>&nbsp;</td>
 			<td id="t_dob">&nbsp; &nbsp;</td>
 			<td id="t_selgender">&nbsp;</td>
 			<td>&nbsp;</td>
 		</tr>
 		<tr>
			...
			<td><input type="text" value="" name="selcountrydesc" /><input type="hidden" value="" name="selcountry" /><input type="button" onclick="getcountry()" value="..."/></td>
 			<td >Nationality </td>
 			<td ><input type="text" value="" name="selnationalitydesc" /><input type="hidden" value="" name="selnationality" /></td>
	  </tr>
 		<tr>
 			<td>Gender <font color="red">*</font></td>
 			<td colspan="3"><select name="selgender">
              <option value=""></option>
 		...
 		<tr>
 			...
 			<td id="t_txtpcode">Person in Charge: <font color="red">*</font></td>
 		...
 		<tr>
 			...
 			<td colspan="3"><input type="text" name="dtPermitExp" id="dtPermitExp" readonly/>
		...
		<tr>
 		...
 		<tr>
 		  ...
 		  <td colspan="3"><select name="selCurrentCompany" id="selCurrentCompany" onchange='javascript:addtoAddress();'>
            <option value=""></option>
...
<input type="text" name="txtcuraddr3" size="50" maxlength="100" /></td>
	  ...
	  <tr>
 		  <td colspan="4" align="LEFT"><strong><u>Work History Description (OPTIONAL)</u></strong></td>
	  </tr>
 		<tr>
