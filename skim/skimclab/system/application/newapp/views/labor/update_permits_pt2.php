...
<?php if(isset($successMsg)) echo $successMsg;?><br />
  ...
  <table width="100%" border="0">
      ...
      <tr>
        ...
        <td><input type="text" name="dtOPR" size="10" id="dtOPR" value="<?php if($insertupdateflag == 'update'){ if($currentRenewal->permit_opr_date != '0000-00-00') echo date('d-m-Y', strtotime($currentRenewal->permit_opr_date));}?>" READONLY/>
      ...
      <tr>
        ...
        <td><input type="text" name="dtAdmin" size="11" id="dtAdmin" value="<?php if($insertupdateflag == 'update'){ if($currentRenewal->permit_admin_date != '0000-00-00') echo date('d-m-Y', strtotime($currentRenewal->permit_admin_date));}?>" READONLY/>
      ...
      <tr>
        ...
        <td><input type="text" name="dtFromJIM" size="11" id="dtFromJIM" value="<?php if($insertupdateflag == 'update'){ if($currentRenewal->permit_fromjim_date != '0000-00-00') echo date('d-m-Y', strtotime($currentRenewal->permit_fromjim_date));}?>" READONLY/>
      ...
      <tr>
        ...
        <td><input type="text" name="dtOPRBck" size="11" id="dtOPRBck" value="<?php if($insertupdateflag == 'update'){ if($currentRenewal->permit_backopr_date != '0000-00-00') echo date('d-m-Y', strtotime($currentRenewal->permit_backopr_date));}?>" READONLY/>
