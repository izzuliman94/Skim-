...
<h4><a href="dashboard.php">Labor</a> <img src="../images/right_arrow.gif" width="13" height="14" /> <a href="search_pt1.php">Reports</a></h4>
...
<h3 id="switchsection1-title" class="handcursor">Labor - Reports <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 


  <form action="../labor/reports_pt2.php" method="get" name="TypicalForm" id="TypicalForm">
    <table width="100%" border="0">
      ...
      <tr>
        ...
        <td><select name="select">
          <option value="1">Master list of labours</option>
          <option value="2">List of labours by company</option>
          <option value="3">List of local transfer </option>
          <option value="4">List of PLKS registration expiry</option>
          <option value="5">List of Passport expiring in one month</option>
          <option value="6">List of labours by FWCS status</option>
		  <option value="7">List of labours by I-Kad status</option>
                </select></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
