...
<tr align="center">
    ...
    <td><?php echo date('d M Y',strtotime($lampfcl->wkr_permitexp)); ?></td>
...
<table width="95%">
  <tr>
    <td height="131" align="left">&nbsp;</td>
    <td align="right"><h5>Company Name :<?php echo $woRow->ctr_comp_name;?><br /></h5>
      <h5>Date Receive :
        <?php if(strlen($woRow->wo_receivedate) > 0 && $woRow->wo_receivedate != '0000-00-00') echo date('d-m-Y', strtotime($woRow->wo_receivedate));?><br />
      </h5>
      <h5>Clab No :<?php echo $woRow->wo_clab_no;?>/EXT/PIC Name :<?php echo $woRow->emp_name?><br /></h5>
      <h5>OR :<?php echo $woRow->pay_refno;?>        <br />
      </h5></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="76%" height="21" align="left"><p>&nbsp;</p></td>
    <td width="20%" align="right"><h5>&nbsp;</h5></td>
