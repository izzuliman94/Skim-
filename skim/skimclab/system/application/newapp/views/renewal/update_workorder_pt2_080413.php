  ...
  <form action="<?php echo site_url();?>/contRenewal/updateWorkOrderPt2Submit" method="POST" name="updateWorkorderForm" id="updateWorkorderForm"  onsubmit="return v.exec();">
    ...
    <br />
       <table width="100%" border="0">
		...
		<tr>
    		<td colspan="6">OFFICIAL RECEIPT NO<font color="red">*</font>.: <input type="text" name="payrefno" value="<?php echo $woRow->pay_refno;?>" size="30" /><input type="button" value="..." onclick="paymentlist('<?php echo $woRow->wo_clab_no;?>')"/></td>
    	</tr>
		<tr>
