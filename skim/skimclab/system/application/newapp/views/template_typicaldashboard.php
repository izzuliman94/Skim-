...
<h4>ParentPage <img src="../images/right_arrow.gif" width="13" height="14" /> ChildPage </h4>
...
<h3 id="switchsection1-title" class="handcursor">Statistics   <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection1" class="switchgroup1"> 
  ...
  <form action="" method="get" name="typicalform1" id="typicalform1">
    <table width="100%" border="0">
      ...
      <tr>
        <th width="50%"><div align="left">Typical Field </div></th>
        <th width="25%"><div align="center">&lt;typical data&gt; </div></th>
        <th width="25%">&lt;typical data&gt; </th>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="submit" name="btnTypicalButton1" value="Typical Button 1" /></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
...
<p>
<h3 id="switchsection2-title" class="handcursor">Status   <img src="../images/down_arrow_org.gif" width="13" height="14" /></h3>
<div id="switchsection2" class="switchgroup1"> 
  ...
  <form action="" method="get" name="typicalform2" id="typicalform2">
    <table width="100%" border="0">
      ...
      <tr>
        <th><div align="left">Typical Field </div></th>
        <th><div align="center">&lt;typical data&gt; </div></th>
        <th>&lt;typical data&gt; </th>
      </tr>
      <tr>
        <td width="50%">&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="submit" name="TypicalButton2" value="Typical Button 2" /></td>
      </tr>
    </table>
  </form>
  <p align="center">&nbsp;</p>
