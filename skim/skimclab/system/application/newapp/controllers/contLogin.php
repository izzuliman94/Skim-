			...
			*/
			...
			if(strpos($accessibility, 'B') !== false){
				$sitemapFinance .= "['Finance', '',
									...
									['Payment Summary (VDR)', '/skimclab/index.php/contPayment/xlssumvdr'],
									['Payment Summary (EXT)', '/skimclab/index.php/contPayment/xlssumext'],
			...
			if(strpos($accessibility, 'C') !== false){
				$sitePrintid .= "['SKIM ID Card', '',
									['Search & Print', '/skimclab/index.php/contidcard/newid'],									
								],";
			}	
			
			$data['sitemapMenu'] = $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpim . $sitemapRenewal . $sitemapFinance. $sitePrintid. $sitemapAdmin . $sitemapReports ;
