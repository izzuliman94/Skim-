<?php
	class ContSpim extends Controller{
		...
		function openreceipt(){
		   ...
		   $frm = $this->uri->segment(3);
		   $data['receiptlist'] = $this->ModelSpim->getAllReceipt();
		   $data['form'] = $frm;
		...
		$sql_workers = "insert into workers
		               (wkr_id,wkr_passno,wkr_name,wkr_dob,wkr_homeaddr,wkr_country,wkr_passexp,wkr_status,wkr_wtrade,wkr_plksno)
					   values
					   ('$workerid','$passno','$name','$dob','$birthplace','$country','$passexp','1','$wt','$plksno')";
