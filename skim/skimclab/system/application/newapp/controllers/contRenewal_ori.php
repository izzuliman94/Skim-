<?php
	class ContRenewal extends Controller{
		...
		$this->load->view('renewal/im12.pdf');		
		}
		...
		function acknowledge(){
		   $wono = $this->uri->segment(3);
		   $data['allAcknowledge'] = ""; //$this->ModelRenewal->getAcknowledgeID($wono);	
	...
	/*	function form_new_labour(){
      ...
      $grid->column("Workorder Number","wo_num");
		...
		function printCheckLits(){
			...
			$this->load->view('renewal/renewal_printchecklist.php', $data);
		}
