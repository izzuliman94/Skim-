		...
		function leftFrame(){
			...
			*/
			...
			if(strpos($accessibility, 'W') !== false){
				$sitemapSpimlw .= "['SPIM (1MMN)', '/skimclab/index.php/contSpimlw/spimDashbrd',
									['New Work Order', '/skimclab/index.php/contSpimlw/newWorkOrder'],
									['Update Work  Order', '/skimclab/index.php/contSpimlw/updateWorkOrder'],
									['Workorder Lists', '/skimclab/index.php/contSpimlw/listAllWorkorders'],
									['Approval', '/skimclab/index.php/contSpimlw/listAllApproval'],
								],";
			}
			...
			if(strpos($accessibility, 'P') !== false){
				$sitePassportMgt .= "['ICT Passport Management', '',
			...
			$data['sitemapMenu'] = $sitemapAck . $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapLocalTransferpm . $sitemapSpimtc . $sitemapSpim . $sitemapRenewalFirst . $sitemapRenewal . $sitemapSpimgc . $sitemapSpimlw . $sitemapFinance . $sitemapInvoice . $sitemapLegal . $sitemapLocal . $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring . $sitePassportMgt;
