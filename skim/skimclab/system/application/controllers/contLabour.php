<?php
	class ContLabour extends Controller {
		...
		function labourDashbrd(){
			...
			$data['totalRejected'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 3, 'total');
			$data['totalRehiring'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 21, 'total');
			$data['totalAccepted'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 2, 'total');
			$data['totalMip'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 5, 'total');
			$data['totalPtm'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 20, 'total');
			$data['totalPassExp'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 13, 'total');
			$data['totalCancelPermit6P'] = $this->ModelLabour->getTotalLaboursByStatus('wkr_transtatus', 19, 'total');
		...
		function newLabourDetailsSubmit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$insertQuery = "INSERT INTO workers (wkr_id, wkr_name, wkr_passno, wkr_oldpassno, wkr_dob, wkr_gender, wkr_homeaddr, wkr_zipcode, 
								...
								wkr_passissue,wkr_salary,wkr_skkdate,wkr_skkref) 
		...
		function updateGreenCard(){
			...
			if(strlen($currentuserid) > 0){
				...
				$updateQuery = "UPDATE workers SET  							    
					...
					{
					    $this->db->trans_commit();
					    redirect('contLabour/GCDetails/' . $wkr_id . '/update');
					}*/
		    //Bio Card
			if(strlen($currentuserid) > 0){
				$wkr_id = $_POST['wkr_id'];
	...
	function updateSKKStatus(){
			...
			if(strlen($currentuserid) > 0){
				...
				$updateQuery = "UPDATE workers SET  							    
					...
					{
					    $this->db->trans_commit();
					    redirect('contLabour/SKKDetails/' . $wkr_id . '/update');
					}
			}
			else
			{
		...
		function updatesocsoStatus(){
			...
			if(strlen($currentuserid) > 0){
				...
				$updateQuery = "UPDATE workers SET  							    
					...
					{
					    $this->db->trans_commit();
					    redirect('contLabour/socsoDetails/' . $wkr_id . '/update');
					}
			}
			else
			{
		...
		function updatebankStatus(){
			...
			if(strlen($currentuserid) > 0){
				...
				$updateQuery = "UPDATE workers SET  
					...
					{
					    $this->db->trans_commit();
					    redirect('contLabour/bankDetails/' . $wkr_id . '/update');
					}
			}
			else
			{
		...
		function GCDetails(){
			...
			if(strlen($currentuserid) > 0){			
				...
				$this->load->view('labor/change_gc', $data);
			}
			else{
				$this->load->view('session_expired.php');	
			}
		...
		function SKKDetails(){
			...
			if(strlen($currentuserid) > 0){			
				...
				$this->load->view('labor/change_skk', $data);
			}
			else{
				$this->load->view('session_expired.php');	
			}
		...
		function socsoDetails(){
			...
			if(strlen($currentuserid) > 0){			
				...
				$this->load->view('labor/change_socso', $data);
			}
			else{
				$this->load->view('session_expired.php');	
			}
		...
		function bankDetails(){
			...
			if(strlen($currentuserid) > 0){			
				...
				$this->load->view('labor/change_bank', $data);
			}
			else{
				$this->load->view('session_expired.php');	
			}
		...
		function labourDetailsDroid(){
			...
			//if(strlen($currentuserid) > 0){			
				...
				$this->load->view('labor/labor_view', $data);
			//}
			//else{
			//	$this->load->view('session_expired.php');	
			//}
