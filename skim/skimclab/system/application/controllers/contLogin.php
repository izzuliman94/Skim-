	...
	class contLogin extends Controller{
		...
		function login(){
			...
			if($userRecord->num_rows() > 0)
			{
				...
				$this->session->set_userdata('empname', $user_row->emp_name);
		...
		function leftFrame(){
			...
			*/
			...
			if(strpos($accessibility, '0') !== false){
				$sitemapAck .= "['Acknowledgement', '/skimclab/index.php/contAck/spimDashbrd',
									['New Acknowledgement', '/skimclab/index.php/contAck/newAck'],
									['Update Acknowledgement', '/skimclab/index.php/contAck/updateAcknowledgement'],
									['Acknowledgement Lists', '/skimclab/index.php/contAck/listAllAcknowledgement'],
									['Approval', '/skimclab/index.php/contAck/listAllApproval'],
								],";
			}
			...
			if(strpos($accessibility, '1') !== false){
				$sitemapCtr .= "['Contractor', '/skimclab/index.php/contContractor/ctrDashboard',
									...
									['Print Letter History', '/skimclab/index.php/contContractor/ctrPrintHistoryList'],
								],";
			}
			...
			if(strpos($accessibility, '3') !== false){
				$sitemapLocalTransferpm .= "['Pertukaran Majikan', '/skimclab/index.php/contAvailablepm/availableDashbrd',
											 ['New Pertukaran Majikan', '/skimclab/index.php/contAvailablepm/availableForm'],
										],";
			}
			...
			if(strpos($accessibility, 'G') !== false){
				$sitemapSpimtc .= "['SPIM (G1G3)', '/skimclab/index.php/contSpimG/spimDashbrd',
									['New Work Order', '/skimclab/index.php/contSpimG/newWorkOrder'],
									['Update Work  Order', '/skimclab/index.php/contSpimG/updateWorkOrder'],
									['Workorder Lists', '/skimclab/index.php/contSpimG/listAllWorkorders'],
								],";
			}
			
			if(strpos($accessibility, 'W') !== false){
				$sitemapSpimlw .= "['Rekalibrasi', '/skimclab/index.php/contrekabContractor/ctrDashboard',
										['Registration Contractor', '/skimclab/index.php/contrekabContractor/registrationForm'],
										['Contractors List', '/skimclab/index.php/contrekabContractor/ctrList'], 
										['Registration Labour', '/skimclab/index.php/contrekabLabour/newLabour'],
										['Rekalibrasi List', '/skimclab/index.php/contrekabLabour/listLabour'],
										
									],";
			}
			
			if(strpos($accessibility, 'P') !== false){
				$sitePassportMgt .= "['Passport Management', '/skimclab/index.php/contpptmgt/pptDashbrd',
									['New Passport  ', '/skimclab/index.php/contPassport/newppt'],		['Passport List  ', '/skimclab/index.php/contPassport/updateppt'],
									['Approval', '/skimclab/index.php/contPassport/listAllApproval'],
								],";
			}
			...
			if(strpos($accessibility, 'A') !== false){
				$sitemapCom .= "['SPIM (COM)', '/skimclab/index.php/contspimcom/spimDashbrd',
									['New COM', '/skimclab/index.php/contspimcom/newWorkOrder'],
									['Update COM', '/skimclab/index.php/contspimcom/updateWorkOrder'],
									['COM Lists', '/skimclab/index.php/contspimcom/listAllWorkorders'],
									['Approval', '/skimclab/index.php/contspimcom/listAllApproval'],
								],";
			}
			...
			if(strpos($accessibility, 'J') !== false){
				$sitemapSpimgc .= "['SPIM (Green Card)', '',
									['[New] Green Card Application ', '/skimclab/index.php/contgc/newWorkOrdernew'],
									['[New] Green Card Lists', '/skimclab/index.php/contgc/listAllWorkorders'],
																		
								],";
			}
			if(strpos($accessibility, 'B') !== false){
				$sitemapFinance .= "['Finance Old Record < 18 July 2017', '',
				                    ['Payment Advice (VDR) List', '/skimclab/index.php/contPaymentold/ListallpaymentVDR'],
									['Payment Advice (EXT) List', '/skimclab/index.php/contPaymentold/ListallpaymentEXT'],
									['Payment Receipt List', '/skimclab/index.php/contPaymentold/receiptlist'],	
									['Payment Summary', '/skimclab/index.php/contPaymentold/summarylist'],									
				                ],";
			...
			if(strpos($accessibility, 'B') !== false){
				$sitemapFinance .= "['Finance', '',
									...
									['Payment Summary', '/skimclab/index.php/contPayment/summarylist'],									
				                ],";
				
			}
			
			if(strpos($accessibility, 'I') !== false){
				$sitemapInvoice .= "['Invoice', '',
									['Tax Invoice', '/skimclab/index.php/contPayment/taxinvoice'],
									['Tax Invoice List', '/skimclab/index.php/contPayment/taxinvlist'],
									
				                ],";
			}
			if(strpos($accessibility, 'L') !== false){
				$sitemapLegal .= "['Legal', '',
				                    ['Agent Registration', '/skimclab/index.php/contLegal/registrationForm'],
									['Agent Change Status', '/skimclab/index.php/contLegal/changeCtrStatus'],
									['Agent List', '/skimclab/index.php/contLegal/ctrList'], 
									['Approval', '/skimclab/index.php/contLegal/listContractorByStatus/approval/0'],
									
				                ],";
			}
			
			if(strpos($accessibility, 'H') !== false){
				$sitemapLocal .= "['Local Labour', '/skimclab/index.php/contLabour/labourDashbrd',
										['Registration', '/skimclab/index.php/contLabour/newLabour'],
										['Assign Company', '/skimclab/index.php/contLabour/assignCompany'],
										['Change Status', '/skimclab/index.php/contLabour/changeLaborStatus'],
										['Local Labour List', '/skimclab/index.php/contLabour/listLabour'],
									],";
			}
			...
			if(strpos($accessibility, '5') !== false){
				$sitemapReports .= "['Reports', '/skimclab/index.php/contReports/reportsDashbrd',
										...
										['Rekalibrasi', '/skimclab/index.php/contReports/viewrekabReports'],
			...
			if(strpos($accessibility, '6') !== false){
				$sitemapAdmin .= "['System Administration', '/skimclab/index.php/contAdmin/dashbrd',
									...
									['System Override', '/skimclab/index.php/contAdmin/loadMasters/mst_nationality'],
								],";
			}
			...
			$data['sitemapMenu'] = $sitemapAck . $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapLocalTransferpm . $sitemapSpimtc . $sitePassportMgt . $sitemapSpim . $sitemapRenewalFirst . $sitemapRenewal . $sitemapCom . $sitemapSpimgc . $sitemapSpimlw . $sitemapFinance . $sitemapInvoice . $sitemapLegal . $sitemapLocal . $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring ;
