<?php
	class contPayment extends Controller {
		...
		function searchReceiptList(){
			...
			$link_print = anchor_popup("$baseuri/printinvoice4/<#pmt_receipt_no#>","Print");
		...
		function savepaymentrcpt(){
			...
			if(isset($_POST["txtadmfeesext1"]) == '1'){ $chkclabfeesext1 = '1';} else{ $chkclabfeesext1 = '0';}
			if(isset($_POST["txtadmfeesext2"]) == '1'){ $chkclabfeesext2 = '1';} else{ $chkclabfeesext2 = '0';}
			...
			if(isset($_POST["txtjimlevi4"]) == '1'){ $chkjimlevi4 = '1';} else{ $chkjimlevi4  = '0';}
			...
			$otherschqnoo = $_POST["txtchqothro"];
			$otherschqno3rd = $_POST["txtchqothr3rd"];
			...
			$othersamount_3rd = $_POST["txtamtothr_3rd"];
			$othersamount_t = $_POST["txtamtothr_t"];
			$paymenttype= $_POST["optpmttype"];
			$remarksotherso = $_POST["txtothremarkso"];
			$remarksothers3rd = $_POST["txtothremarks3rd"];
			...
			$sql = "insert into pmt_receipt_new 
					...
					clab_gc_fee,pmt_chq_jim,chk_jim_plks,chk_jim_fees,chk_jim_visa,chk_jim_levi,chk_jim_levi2,chk_jim_levi3,chk_jim_levi4,chk_jim_sp,chk_jim_cp,chk_jim_compound,jim_amount,
					...
					clab_transgc_fee,transit_fees,others_chq_noo,others_chq_no3rd,chk_others_fees,chk_others_fees2,chk_others_fees3,others_amount,others_amount_o,others_amount_3rd,others_amount_t,payment_type,
					clab_no,remarks_otherso,remarks_others3rd,visa_ref,fine_ref,regional_id,trans_fees_ref,trans_cost_ref,pmt_chq_clab_ren,chk_clab_fees_ext,chk_clab_fees_ext11,chk_clab_fees_extgc,
					...
					'$clabgcfee','$jimchqno','$chkjimplks','$chkjimfees','$chkjimvisa','$chkjimlevi','$chkjimlevi2','$chkjimlevi3','$chkjimlevi4','$chkjimsp','$chkjimcp','$chkjimcompound','$jimamount',
					...
					'$clabtransgcfee','$transfees','$otherschqnoo','$otherschqno3rd','$chkothersfees','$chkothersfees2','$chkothersfees3','$othersamount','$othersamount_o','$othersamount_3rd','$othersamount_t','$paymenttype',
					'$clabno','$remarksotherso','$remarksothers3rd','$visaref','$fineref','$regionalid','$transfeesref','$transcostref','$clabchqren','$chkclabfeesext1','$chkclabfeesext2','$chkclabfeesextgc',
	 ...
	 function updatepaymentrcpt(){
		...
		/*-----------------------------------------------*/
			...
			$sql = "update pmt_receipt_new set 
					...
					chk_clab_fees_ext='$chkclabfeesext1',
					chk_clab_fees_ext11='$chkclabfeesext2',
					...
					others_chq_noo='$otherschqnoo',
					others_chq_no3rd='$otherschqno3rd',
					chk_others_fees='$chkothersfees',
					...
					others_amount_o='$othersamount_o',
					others_amount_3rd='$othersamount_3rd',
					others_amount_t='$othersamount_t',
					payment_type='$paymenttype',
					remarks_otherso = '$remarksotherso',
					remarks_others3rd = '$remarksothers3rd',
