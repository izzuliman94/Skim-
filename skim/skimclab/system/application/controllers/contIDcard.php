<?php
	class contIDcard extends Controller {
		...
		//view in skim by passport input date
		...
		//export to excel by passport input date
		...
		$sql = "insert into card_fcl
		        (fcl_dateout,fcl_time,fcl_wkrid,fcl_passno,fcl_name,fcl_country,fcl_permitexp,fcl_photo,fcl_comp , fcl_printby)
                values
                ('$dateout','$timeout','$wkrid','$passno',".$this->db->escape($name).",'$country','$permitxpdate','$photo',".$this->db->escape($comp)." , '$currentuser')"; 
        $this->db->trans_begin();
		$this->db->query($sql);	
		...
		$sql = "insert into card_fcl
                ...
                values
                (NOW(),'$wkrid','$passno',".$this->db->escape($name).",'$country','$permitxpdate','$photo','$comp')"; 
        $this->db->trans_begin();
		$this->db->query($sql);	
        $this->db->trans_commit();
