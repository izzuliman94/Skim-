	...
	class contPayment extends Controller {
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt_new 
					...
					clab_no,remarks_otherso,remarks_others3rd,visa_ref,fine_ref,regional_id,trans_fees_ref,trans_cost_ref,pmt_chq_clab_ren,chk_clab_fees_ext,chk_clab_fees_extgc,
					...
					'$clabno','$remarksotherso','$remarksothers3rd','$visaref','$fineref','$regionalid','$transfeesref','$transcostref','$clabchqren','$chkclabfeesext','$chkclabfeesextgc',
