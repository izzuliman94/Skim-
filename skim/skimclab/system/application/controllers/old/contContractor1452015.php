<?php
	class ContContractor extends Controller {
		...
		function ctrDashboard(){
			...
			$data['plksexp2'] = $this->ModelLabour->getLaborByPermitPassExpiry4('wkr_permitexp', -2, 'total', 'allcountry');
		...
		function printCert(){
			...
			$sqlQuery = "UPDATE ctr_payment SET pay_cert_date = NOW() WHERE pay_ctr_id = '$clabno'";
			$this->db->query($sqlQuery);
