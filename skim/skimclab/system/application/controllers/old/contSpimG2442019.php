		...
		function newWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$docQuery = "INSERT INTO wo_doc (doc_woid, doc_rqform, doc_company, doc_awardletter, doc_nric, doc_finance, doc_bankstmt,doc_insurance, doc_cert, doc_photo, doc_datecomplete, 
							doc_rqformdate, doc_company_date, doc_awardletterdate, doc_nric_date, doc_finance_date, doc_bankstmt_date,doc_insurance_date,doc_cert_date,doc_photo_date)
							 ...
							 '$doc_rqformdate', '$doc_companydate', '$doc_awardletterdate', '$doc_nricdate', '$doc_financedate', '$doc_bankstmtdate', '$doc_insurancedate', '$doc_certdate', '$doc_photodate')";
							 
	            $paymentQuery = "INSERT INTO wo_payment (pay_woid, pay_refno, pay_adminfee, pay_levy, pay_plks, pay_agencyfee, pay_fomema, pay_visa, pay_ig, pay_fwhs, pay_deposit, pay_green, pay_transit) 
	            			     VALUES ($wo_id, '$wo_pay_refno', '$wo_pay_adminfee', '$wo_pay_levy', '$wo_pay_plks', '$wo_pay_agencyfee', '$wo_pay_fomema', '$wo_pay_visa', '$wo_pay_ig', '$wo_pay_fwhs', '$wo_pay_deposit', '$wo_pay_green', '$wo_pay_transit')";
		...
		function updateWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$woQuery = "UPDATE workorders SET wo_fcl_total = $wo_fcl_total, wo_fcl_country = '$wo_fcl_country', wo_isreplacement = '$wo_isreplacement', wo_replace_date = '$wo_replace_date', wo_replace_reason = '$wo_replace_reason', 
							...
							wo_attn_officer = '$wo_attn_off', wo_contdur = '$wo_contdur', wo_fcl_total_apv = '$wo_fclapv'
							WHERE wo_id = $wo_id";
		    	...
		    	$docQuery = "UPDATE wo_doc SET doc_rqform = '$wo_doc_rqform', doc_company = '$wo_doc_company', doc_awardletter = '$wo_doc_awardletter', doc_nric = '$wo_doc_nric', doc_finance = '$wo_doc_finance', 
		    	             doc_bankstmt = '$wo_doc_bankstmt',doc_insurance = '$wo_doc_insurance',doc_cert = '$wo_doc_cert',doc_photo = '$wo_doc_photo', 
							 ...
							 doc_insurance_date = '$doc_insurance_date', doc_cert_date = '$doc_cert_date', doc_photo_date= '$doc_photo_date'
	            ...
	            $paymentQuery = "UPDATE wo_payment SET pay_refno = '$wo_pay_refno', pay_adminfee = '$wo_pay_adminfee', pay_levy = '$wo_pay_levy', pay_plks = '$wo_pay_plks', 
								 ...
								 pay_deposit = '$wo_pay_deposit',pay_green = '$wo_pay_green',pay_transit = '$wo_pay_transit'
