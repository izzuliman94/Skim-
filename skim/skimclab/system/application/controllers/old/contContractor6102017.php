	...
	if($periodreg == "9") $txtAmount = "<u>One Hundred Fifty Nine Only</u>(<u>RM 159.00</u>) for <u>nine(9)</u> years.";
		...
		function paymentSubmit(){
			...
			if(strlen($currentuserid) > 0){
				...
				else if($periodreg == '4') $clabExpDate = date('Y-m-d', strtotime('+4 year', strtotime($paymentdate)));
				else if($periodreg == '5') $clabExpDate = date('Y-m-d', strtotime('+5 year', strtotime($paymentdate)));
				else if($periodreg == '6') $clabExpDate = date('Y-m-d', strtotime('+6 year', strtotime($paymentdate)));
				else if($periodreg == '7') $clabExpDate = date('Y-m-d', strtotime('+7 year', strtotime($paymentdate)));
				else if($periodreg == '8') $clabExpDate = date('Y-m-d', strtotime('+8 year', strtotime($paymentdate)));
				else if($periodreg == '9') $clabExpDate = date('Y-m-d', strtotime('+9 year', strtotime($paymentdate)));
				else{	
				}
