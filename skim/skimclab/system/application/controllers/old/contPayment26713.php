	...
	class contPayment extends Controller {
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt 
					...
					clab_pa_no,clab_amount,clab_amount_only,clab_amount_tax,pmt_chq_jim,chk_jim_plks,chk_jim_fees,chk_jim_visa,chk_jim_levi,chk_jim_sp,jim_pa_no,
					...
					values
					('$pmtno','$datecreated','$receivefrom','$addr','$clabchqno','$chkclabfees','$chkclabadm','$chkclabfeesext','$clabpa','$clabamount',
		...
		$pmquery = "insert into pmt_advise (pmt_no,pmt_dateissue,contractor_id,pmt_attn,pmt_type,pmt_compname,
		  		    pmt_address1,pmt_address2,pmt_address3,pmt_tel,pmt_fax,pmt_state,pmt_postcode)
				    values
				   ('$pmno','$datecreated','$contractorid','$attn','R','$contractorname','$addr1','$addr2',
				    '$addr3','$tel','$fax','$state','$postcode')";	
	 ...
	 function savefclvdr(){
			...
			$pmtquery = "insert into pmt_fcl 
			             (pmt_no,pmt_cty_id,pmt_cty_desc,pmt_fcl_no,pmt_levi,pmt_plks,pmt_visa,pmt_fees,pmt_period,pmt_jim,pmt_wages,pmt_trans_fees,pmt_trans_cost)
						 values
						 ('$pmno','$cityid','$citydesc','$nooffcl','$pmtlevi','$pmtplks',
						 '$pmtvisa','$pmtfees','$pmtperiod','$pmtjim','$pmtwages','$transfees','$transcost')";
	 ...
	 function savefclext(){
			...
			$pmtquery = "insert into pmt_fcl 
						 ...
						 values
						 ('$pmno','$cityid','$citydesc','$nooffcl','$pmtlevi','$pmtplks',
						 '$pmtvisa','$pmtfees','$pmtperiod','$pmtjim','$pmtwages','$pmtcomp','$pmtsp')";
