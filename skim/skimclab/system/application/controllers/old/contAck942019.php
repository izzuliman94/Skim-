	...
	/*	function form_new_labour(){
		...
		function newWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$paymentQuery = "INSERT INTO ack_payment (pay_woid, pay_refno,pay_imigration,pay_clab,
								 pay_ins_guarante,pay_ins_hospital,pay_others,pay_others_detail) 
	            			     VALUES ($wo_id, '$wo_pay_refno','$wo_pay_imi','$wo_pay_clb','$wo_pay_insg','$wo_pay_insh','$wo_pay_others','$wo_pay_othersdetail')";	        
		...
		function updateAcknowledgementPt2Submit(){
	        ...
	        /*    $paymentQuery = "UPDATE wo_payment SET pay_refno = '$wo_pay_refno', pay_adminfee = '$wo_pay_adminfee', pay_levy = '$wo_pay_levy', pay_plks = '$wo_pay_plks', 
				...
				$paymentQuery = "UPDATE ack_payment set pay_refno = '$wo_pay_refno',pay_imigration = '$wo_pay_imi',pay_clab = '$wo_pay_clb',
				                 pay_others_detail = '$pay_others_detail' , pay_ins_guarante = '$wo_pay_insg',pay_ins_hospital = '$wo_pay_insh', pay_others = '$wo_pay_others' where pay_woid = '$wo_id'";
