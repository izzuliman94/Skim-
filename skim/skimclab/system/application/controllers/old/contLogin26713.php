	...
	class contLogin extends Controller{
		...
		function leftFrame(){
			...
			*/
			...
			$data['sitemapMenu'] = $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpimtc . $sitemapSpim . $sitemapRenewal . $sitemapFinance. $sitePrintid. $sitemapAdmin . $sitemapReports ;
