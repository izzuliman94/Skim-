<?php
	class ContRenewal extends Controller{
		...
		function Insurance_purchase(){
			...
			//$this->email->cc('info@clab.com.my');
            $this->email->bcc('clabict@clab.com.my');
		...
		*/
		...
		$sql = "insert into wo_fcl_renew
		        (fcl_woid,fcl_passno,fcl_permitno,fcl_passexp,fcl_salary,fcl_wt,fcl_next_of_kin,
				fcl_relationship,fcl_year_renewal,fcl_wo_type,fcl_pass,fcl_name,fcl_nationality,fcl_newpassno)
                values
                ('$workorderid','$passno','$permitno','$passexp','$salary','$wt','$nok','$relationship','$yearrenew',
