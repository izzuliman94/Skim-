	...
	class contPayment extends Controller {
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt_new 
					...
					pmt_chq_clab,clab_amount,clab_amount_only,clab_amount_tax,clab_adm_fee,clab_tc_fee,clab_gc_fee,	
					
					pmt_chq_jim,chk_jim_plks,chk_jim_fees,chk_jim_visa,chk_jim_levi,chk_jim_sp,chk_jim_cp,chk_jim_compound,					
					jim_amount,jim_amount_visa,jim_amount_sp,jim_amount_cp,jim_amount_compound,jim_amount_plks,jim_amount_fees,jim_amount_levi,
					
					pmt_chq_fomema,chk_fomema_male,chk_fomema_female,fomema_amount,fomema_amounto,fomema_amountt,
					
					ins_chq_no,chk_ins_ig,chk_ins_fwcs,chk_ins_fwhs,ins_amount,ins_amounto,ins_amountt,
					ins_amount_ig,ins_amount_fwcs,ins_amount_fwhs,
					
					agency_chq_no,chk_agency_fees,chk_agency_feesgc,agency_amount,agency_amounto,agency_amountt,clab_trans_fee,clab_transgc_fee,transit_fees,
					
					others_chq_no,chk_others_fees,chk_others_fees2,others_amount,others_amount_o,others_amount_t,payment_type,clab_no,remarks_others,
					
					visa_ref,fine_ref,regional_id,trans_fees_ref,trans_cost_ref,
										
					pmt_chq_clab_ren,chk_clab_fees_ext,chk_clab_fees_extgc,amt_clabren,amt_clabreno,amt_clabrent,clab_ren_fee,clab_rengc_fee,  
					chqno_contreg,chk_contreg1,chk_contreg2,chk_contreg3,amt_contreg,amt_contrego,amt_contregt,clab_contreg_fee,
					chqno_contren,chk_contren1,chk_contren2,chk_contren3,amt_contren,amt_contreno,amt_contrent,clab_contren_fee,
					chqno_rehire,chk_rehire1,chk_rehire2,amt_rehireo,amt_rehiret,amt_rehire,clab_reh_fee,
					pmt_chq_local,chk_local_dis,chk_local_reim,local_amounto,local_amountt,local_amount,clab_lw_fee,
					pmt_chk_green,chk_green_new,chk_green_ren,amt_greencard,amt_greencardo,amt_greencardt,clab_green_fee,
					chqno_clabfee,chk_member,chk_intro,amt_clabfee,amt_clabfeeo,amt_clabfeet,clab_fee
					) 
					values
					('$pmtno','$datecreated','$currentuser',".$this->db->escape($receivefrom).",'$addr',
					'$fcl','$country','$clabpa','$disc','$rmkdisc',
					'$chkclabfees','$chkothersfees2','$chkclabtsitcent','$chkclabgrncad',
					'$clabchqno','$clabamount','$clabamountonly','$clabamounttax','$clabadmfee','$clabtcfee','$clabgcfee',
					
					'$jimchqno','$chkjimplks','$chkjimfees','$chkjimvisa','$chkjimlevi','$chkjimsp','$chkjimcp','$chkjimcompound',					
					'$jimamount','$jimamountvisa','$jimamountsp','$jimamountcp','$jimamountcompound','$jimamountplks','$jimamountfees','$jimamountlevi',
					
				    '$fomemachqno','$chkfomemamale','$chkfomemafemale','$fomemaamount','$fomemaamounto','$fomemaamountt',
					
					'$inschqno','$chkinsig','$chkinsfwcs','$chkinsfwhs','$insamount','$insamounto','$insamountt',
					'$insamountig','$insamountfwcs','$insamountfwhs',
					
					'$agencychqno','$chkagencyfees','$chkagencyfeesgc','$agencyamount','$agencyamounto','$agencyamountt','$clabtransfee','$clabtransgcfee','$transfees',
					
					'$otherschqno','$chkothersfees','$chkothersfees2','$othersamount','$othersamount_o','$othersamount_t','$paymenttype','$clabno','$remarksothers',
					
					'$visaref','$fineref','$regionalid','$transfeesref','$transcostref',	
									
					'$clabchqren','$chkclabfeesext','$chkclabfeesextgc','$amtclabren','$amtclabreno','$amtclabrent','$clabrenfee','$clabrengcfee',
					'$chqcontreg','$chkcontreg1','$chkcontreg2','$chkcontreg3','$amtcontreg','$amtcontrego','$amtcontregt','$contregfee',
					'$chqcontren','$chkcontren1','$chkcontren2','$chkcontren3','$amtcontren','$amtcontreno','$amtcontrent','$contrenfee',
					'$chqrehire','$chkrehire1','$chkrehire2','$amtrehireo','$amtrehiret','$amtrehire','$clabrehfee',
					'$localchqno','$chklocaldis','$chklocalreim','$localamounto','$localamountt','$localamount','$clablwfee',
					'$chqgreen','$chkgreenw','$chkgreenr','$amtgreen','$amtgreeno','$amtgreent','$clabgreenfee',
					'$chqclabfee','$chkmember','$chkintro','$amtclabfee','$amtclabfeeo','$amtclabfeet','$clabfee'
					)";
	...
	function updatetaxinvoice(){
	 ...
	 function savefclvdr(){
			...
			$pmtquery = "insert into pmt_fcl 
						 ...
						 pmt_ig,pmt_fwcs,pmt_fwhs,pmt_admin,pmt_fomema,pmt_green,pmt_transit)
						 values
						 ('$pmno','$cityid','$citydesc','$nooffcl','$pmtlevi','$pmtplks','$pmtvisa','$pmtfees','$pmtperiod','$pmtjim','$pmtwages',
						 '$pmtig','$pmtfwcs','$pmtfwhs','$pmtadmin','$pmtfomema','$pmtgreen','$pmttransit')";
	 ...
	 function savefclext(){
			...
			$pmtquery = "insert into pmt_fcl 
			             (pmt_no,pmt_cty_id,pmt_cty_desc,pmt_fcl_no,pmt_levi,pmt_plks,pmt_visa,pmt_fees,pmt_period,pmt_jim,pmt_wages,
						  pmt_ig,pmt_fwcs,pmt_fwhs,pmt_admin,pmt_fomema,pmt_green,pmt_transit,pmt_compound,pmt_sp)
						 values
						 ('$pmno','$cityid','$citydesc','$nooffcl','$pmtlevi','$pmtplks','$pmtvisa','$pmtfees','$pmtperiod','$pmtjim',$pmtwages,
						 '$pmtig','$pmtfwcs','$pmtfwhs','$pmtadmin','$pmtfomema','$pmtgreen','$pmttransit','$pmtcomp','$pmtsp')";
