<?php
	class contPayment extends Controller {
		...
		//	$grid->column("ISSUED BY","emp_username");
           // $grid->column("RECEIPT STATUS","pmt_status");
			$grid->column("ACTION","$link_print");
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt 
					...
					values
					('$pmtno','$datecreated',".$this->db->escape($receivefrom).",'$addr','$clabchqno','$chkclabfees','$chkclabadm','$chkclabfeesext','$clabpa','$clabamount',
