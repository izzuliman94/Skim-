	...
	class contPayment extends Controller {
		...
		function savepaymentrcpt(){
			...
			$sql = "insert into pmt_receipt 
			        (pmt_receipt_no,pmt_datecreated,pmt_datecreatedby,pmt_receive_from,pmt_addr,pmt_chq_clab,chk_clab_fees,chk_clab_adm,chk_clab_fees_ext,					 
					chk_clab_mship,chk_local_reim,chk_local_dis,pmt_chq_local,local_amount,clab_pa_no,clab_amount,clab_amount_only,clab_amount_tax,pmt_chq_jim,chk_jim_plks,chk_jim_fees,chk_jim_visa,chk_jim_levi,chk_jim_sp,jim_pa_no,
					...
					values
					('$pmtno','$datecreated','$currentuser',".$this->db->escape($receivefrom).",'$addr','$clabchqno','$chkclabfees','$chkclabadm','$chkclabfeesext','$chkothersfees2','$chklocalreim','$chklocaldis','$localchqno','$localamount','$clabpa','$clabamount',
