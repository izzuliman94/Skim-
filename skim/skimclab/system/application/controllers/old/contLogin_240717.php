			...
			*/
			...
			if(strpos($accessibility, 'B') !== false){
				$sitemapFinance .= "['Finance', '',
									...
									['Payment Advice (Local)', '/skimclab/index.php/contPayment/openlocal'],
									['Payment Advice (Local) List', '/skimclab/index.php/contPayment/Listallpaymentlocal'],
									...
									['Payment Summary (Cancelled Receipt)', '/skimclab/index.php/contPayment/xlssumcancellist'],	
