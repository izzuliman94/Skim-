<?php
	class ContSpim extends Controller{
		...
		function Insurance_purchase(){
			...
			//echo ($mailRow,1);
		 	$this->load->library('email');
			$this->email->from($mailRow->emails, 'CLAB');
            $this->email->to('lonpac@clab.com.my , fadil@clab.com.my');
			$this->email->cc('faiz@clab.com.my , hayati@clab.com.my , skim@clab.com.my' );
			$this->email->bcc($mailRow->emails);
	...
	/*			$statusQuery = "INSERT INTO wo_status (status_woid, wo_isreceive, wo_receiveby, wo_receivedate, wo_receive_comment, wo_isprocess, wo_processby, 
		...
		function searchWorkorders(){
		    ...
		    if($searchby == "ctr_comp_name" || $searchby == "ctr_clab_no" || $searchby == "fcl_passno"  || $searchby == "pay_refno")
