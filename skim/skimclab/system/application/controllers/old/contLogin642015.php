		...
		function leftFrame(){
			...
			*/
			...
			if(strpos($accessibility, 'M') !== false){
				$siteMonitoring .= "['Monitoring', '',
									['VDR Monitoring', '/skimclab/index.php/contSpim/ListWO'],									
								],";
			}	
			
			$data['sitemapMenu'] = $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpimtc . $sitemapSpim . $sitemapRenewal . $sitemapFinance. $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring ;
