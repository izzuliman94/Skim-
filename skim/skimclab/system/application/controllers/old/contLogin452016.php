	...
	class contLogin extends Controller{
		...
		function leftFrame(){
			...
			*/
			...
			$data['sitemapMenu'] = $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpimtc . $sitemapSpim . $sitemapRenewalFirst . $sitemapRenewal . $sitemapFinance . $sitemapInvoice . $sitemapLegal . $sitemapLocal . $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring . $sitePassportMgt;
