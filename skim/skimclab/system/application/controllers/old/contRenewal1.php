<?php
	class ContRenewal extends Controller{
		...
		function Insurance_purchase(){
			...
			foreach( $data['allFCLlampiran']->result() as $fcl){
			$i = 1;
			$data = "<tr>";
      	 	$data.= "<td>echo $i++;</td>";
			$data.= "<td>echo $i++;</td>";
            ...
            $this->email->from('skim@clab.com.my', 'Mohd Fadzly');
            $this->email->to('mfadzly@gmail.com');
         //   $this->email->cc('mfadzly@gmail.com');
		...
		*/
		...
		$sql = "insert into wo_fcl_renew
				...
				fcl_relationship,fcl_year_renewal,fcl_wo_type,fcl_pass,fcl_name)
                values
	...
	/*	function form_new_labour(){
      ...
      $grid->column("Workorder Number","wo_num");
		...
		function updateRejectHistory(){
			$currentuserid = $this->session->userdata('e