<?php
	class ContContractor extends Controller {
		...
		function registrationFormSubmit(){
			...
			$insertQuery = "INSERT INTO contractors (ctr_clab_no,ctr_gst_no, ctr_datereg, ctr_comp_name, ctr_comp_regno, ctr_addr1, ctr_addr2, ctr_addr3, ctr_pcode, ctr_state, ctr_telno, 
							...
							VALUES ('$clabno','$companygstno', NOW(), " . $this->db->escape($companyname) .",'$companyregno', ". $this->db->escape($address1) .", ". $this->db->escape($address2).", 
