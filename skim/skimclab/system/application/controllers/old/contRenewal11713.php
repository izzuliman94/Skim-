<?php
	class ContRenewal extends Controller{
		...
		function Insurance_purchase(){
            ...
            $this->email->to('lonpac@clab.com.my , info@clab.com.my');
			$this->email->cc('info@clab.com.my , maliah@clab.com.my , nieza@clab.com.my , hayati@clab.com.my ');
		...
		*/
		...
		$sql = "insert into wo_fcl_renew
                ...
                ('$workorderid','$passno','$permitno','$passexp','$salary','$wt','$nok','$relationship','$yearrenew',
				 '$wotype','$chkpass','$name','$nationality','$newpassno','$dob','$gender','$country')"; 
        $this->db->trans_begin();
		$this->db->query($sql);	
        $this->db->trans_commit();
