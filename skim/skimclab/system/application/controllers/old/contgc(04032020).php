		...
		function updateWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$docQuery = "update wo_doc set doc_ori_passport = '$wo_doc_oripass', doc_fomema = '$wo_doc_fomema', 
							 ...
							 '$wo_doc_oripass_date', 
				           doc_details_date = '$wo_doc_details_date'
