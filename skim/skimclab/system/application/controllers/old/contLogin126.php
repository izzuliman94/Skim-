			...
			*/
			...
			if(strpos($accessibility, 'L') !== false){
				$sitemapLegal .= "['Legal', '',
									...
									['Agent Change Status', '/skimclab/index.php/contContractor/changeCtrStatus'],
									['Agent List', '/skimclab/index.php/contContractor/ctrList'], 
									['Approval', '/skimclab/index.php/contContractor/listContractorByStatus/approval/0'],
			...
			$data['sitemapMenu'] = $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpimtc . $sitemapSpim . $sitemapRenewalFirst . $sitemapRenewal . $sitemapFinance . $sitemapLegal . $sitemapLocal . $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring . $sitePassportMgt;
