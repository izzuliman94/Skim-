	...
	/*	function form_new_labour(){
		...
		function newWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				$woQuery = "INSERT INTO workorders (wo_id, wo_num, wo_date, wo_clab_no, wo_fcl_total, wo_fcl_country, wo_agency,wo_appid, wo_isreplacement, wo_replace_date, wo_replace_reason, 
		    				...
		    				$wo_fcl_total, '$wo_fcl_country', '$wo_agency','$wo_app','$wo_isreplacement', '$wo_replace_date', '$wo_replace_reason', 
	...
	/*			$statusQuery = "INSERT INTO wo_status (status_woid, wo_isreceive, wo_receiveby, wo_receivedate, wo_receive_comment, wo_isprocess, wo_processby, 
		...
		function updateWorkOrderPt2Submit(){
			...
			if(strlen($currentuserid) > 0){
				...
				//$this->db->query($sqlQuery);
				$woQuery = "UPDATE workorders SET wo_fcl_total = $wo_fcl_total, wo_fcl_country = '$wo_fcl_country', wo_agency = $wo_agency, wo_appid = $wo_app,wo_isreplacement = '$wo_isreplacement', wo_replace_date = '$wo_replace_date', wo_replace_reason = '$wo_replace_reason', 
	            ...
	            $paymentQuery = "UPDATE wo_payment SET pay_refno = '$wo_pay_refno', pay_adminfee = '$wo_pay_adminfee', pay_levy = '$wo_pay_levy', pay_plks = '$wo_pay_plks', 
	            				 pay_agencyfee = '$wo_pay_agencyfee', pay_fomema = '$wo_pay_fomema', pay_visa = '$wo_pay_visa', pay_ig = '$wo_pay_ig', pay_igno = '$wo_pay_igno', pay_fwcs = '$wo_pay_fwcs', pay_fwcsno = '$wo_pay_fwcsno', pay_fwhs = '$wo_pay_fwhs' , pay_fwhsno = '$wo_pay_fwhsno' 
		...
		function searchWorkorders(){
		    ...
		    if($searchby == "ctr_comp_name" || $searchby == "ctr_clab_no" || $searchby == "fcl_passno"  || $searchby == "pay_refno" || $searchby == "wo_jimack_refno")
