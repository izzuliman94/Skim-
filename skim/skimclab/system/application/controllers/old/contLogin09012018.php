	...
	class contLogin extends Controller{
		...
		function leftFrame(){
			...
			*/
			...
			$data['sitemapMenu'] = $sitemapAck . $sitemapCtr . $sitemapLabour . $sitemapLocalTransfer . $sitemapSpimtc . $sitemapSpim . $sitemapRenewalFirst . $sitemapRenewal . $sitemapSpimlw . $sitemapFinance . $sitemapInvoice . $sitemapLegal . $sitemapLocal . $sitePrintid. $sitemapAdmin . $sitemapReports . $siteMonitoring . $sitePassportMgt;
