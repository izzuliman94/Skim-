<?php
	class ContContractor extends Controller {
		...
		function registrationFormSubmit(){
			...
			$insertQuery = "INSERT INTO contractors (ctr_clab_no,ctr_gst_no, ctr_datereg, ctr_validdate, ctr_comp_name, ctr_comp_regno, ctr_addr1, ctr_addr2, ctr_addr3, ctr_pcode, ctr_state, ctr_telno, 
							...
							VALUES ('$clabno','$companygstno', NOW(), NOW(), " . $this->db->escape($companyname) .",'$companyregno', ". $this->db->escape($address1) .", ". $this->db->escape($address2).", 
		...
		function printApproveRejLetter(){
			...
			if($ctr->ctr_approve == "1"){
				...
				if($periodreg == "3") $txtAmount = "<u>Fifty Three Only</u>(<u>RM 53.00</u>) for <u>three(3)</u> years.";
				else if($periodreg == "2") $txtAmount = "<u>Forty Two And Forty Cents Only</u>(<u>RM 42.40</u>) for <u>two(2)</u> years.";
				else $txtAmount = "<u>Twenty One And Twenty Cents Only</u>(<u>RM 21.20</u>) for <u>one(1)</u> years.";
		...
		function printRenewal(){
			...
			$periodreg = $ctr->ctr_periodreg;
	if($periodreg == "9") $txtAmount = "<u>One Hundred Fifty Nine Only</u>(<u>RM 159.00</u>) for <u>nine(9)</u> years.";
	else if($periodreg == "8") $txtAmount = "<u>One Hundred Fourty Eight And Foutry Cents Only</u>(<u>RM 148.40</u>) for <u>eight(8)</u> years.";
	else if($periodreg == "7") $txtAmount = "<u>One Hundred Twenty Seven And Twenty Cents Only</u>(<u>RM 127.20</u>) for <u>seven(7)</u> years.";
	else if($periodreg == "6") $txtAmount = "<u>One Hundred Six Only</u>(<u>RM 106.00</u>) for <u>six(6)</u> years.";
	else if($periodreg == "5") $txtAmount = "<u>Ninety Five And Fourty Cents Only</u>(<u>RM 95.40</u>) for <u>five(5)</u> years.";
	else if($periodreg == "4") $txtAmount = "<u>Seventy Four And Twenty Cents Only</u>(<u>RM 74.20</u>) for <u>four(4)</u> years.";
	else if($periodreg == "3") $txtAmount = "<u>Fifty Three Only</u>(<u>RM 53.00</u>) for <u>three(3)</u> years.";
	else if($periodreg == "2") $txtAmount = "<u>Forty Two And Forty Cents Only</u>(<u>RM 42.40</u>) for <u>two(2)</u> years.";
	else $txtAmount = "<u>Twenty One And Twenty Cents Only</u>(<u>RM 21.20</u>) for <u>one(1)</u> years.";
