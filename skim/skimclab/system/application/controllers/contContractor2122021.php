<?php
	class ContContractor extends Controller {
		...
		function registrationFormSubmit(){
			...
			$insertQuery = "INSERT INTO contractors (ctr_clab_no,ctr_gst_no,ctr_socso_no, ctr_datereg, ctr_validdate, ctr_comp_name, ctr_comp_regno, ctr_addr1, ctr_addr2, ctr_addr3, ctr_pcode, ctr_state, ctr_telno, 
		...
		function uploadDocSubmit(){
			...
			if(strlen($currentuserid) > 0){
				...
				else if($filetype == 'akurjanji') $fileTypeName = "Akur Janji";
