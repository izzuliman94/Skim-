<table style="margin:0;width:100%;border-collapse:collapse;padding:0;">
  <tr>
    <td>
      <table style="margin:0;width:100%;border-collapse:collapse;padding:0;">
        <tr>
          <td class="mainheader" valign="top"><?php echo $title?></td>
          <td class="mainheader" align="right" valign="top"><?php echo $container_tr;?></td>
        </tr>
      </table>
...
<?php if (in_array($column["type"], array("orderby","detail"))):?>
          <td class="tableheader">
            <table style="width:100%; border-collapse:collapse;">
              <tr>
                <td class="tableheader_clean" valign="top"><?php echo $column["label"]?></td>
                <td class="tableheader_clean" style="width:28px" valign="top">
...
<?php elseif ($column["type"] == "clean"):?>
          <td valign="top" <?php echo $column["attributes"]?>><?php echo $column["label"]?></td>
<?php elseif (in_array($column["type"], array("normal"))):?>
          <td valign="top" class="tableheader" <?php echo $column["attributes"]?>><?php echo $column["label"]?></td>
<?php endif;?>
...
<?php if ($cell["type"] == "detail"):?>
          <td valign="top" <?php echo $cell["attributes"]?> class="littletablerow" ><a href="<?php echo $cell["link"]?>"><?php echo $cell["field"]?><img src="<?php echo $this->rapyd->get_elements_path('elenco.gif')?>" width="16" height="16" border="0" align="absmiddle" /></a></td>
<?php elseif ($cell["type"] == "clean"):?>
          <td valign="top" <?php echo $cell["attributes"]?>><?php echo $cell["field"]?></td>
<?php else:?>
          <td valign="top" <?php echo $cell["attributes"]?> class="littletablerow"><?php echo $cell["field"]?>&nbsp;</td>
<?php endif;?>
<?php endforeach;?>
        </tr>
<?php endforeach;?>
