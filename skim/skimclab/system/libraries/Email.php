...
class CI_Email {
	...
	var	$smtp_host		= "mail.clab.com.my";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "skim@clab.com.my";		// SMTP Username
	var	$smtp_pass		= "clabskim123";		// SMTP Password
